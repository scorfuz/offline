...
export interface Statement<A>
  extends Fragment, Effect<ReadonlyArray<A>, SqlError>, Pipeable {
...
export const currentTransformer: FiberRef.FiberRef<
  Option.Option<Statement.Transformer>
...
export const withTransformerDisabled: <A, E, R>(
  effect: Effect<A, E, R>
) => Effect<A, E, R> = internal.withTransformerDisabled
...
export const makeCompiler: <
  C extends Custom<any, any, any, any> = any
>(options: {
  readonly dialect: Dialect
...
) => Compiler = internal.makeCompilerSqlite
