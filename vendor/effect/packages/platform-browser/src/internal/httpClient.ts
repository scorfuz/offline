...
export const withXHRArrayBuffer = <A, E, R>(
  ...
  Effect.locally(effect, currentXHRResponseType, "arraybuffer")
...
/** @internal */
export abstract class IncomingMessageImpl<E>
...
class ClientResponseImpl
  extends IncomingMessageImpl<Error.ResponseError>
...
/** @internal */
export const layerXMLHttpRequest = Client.layerMergedContext(
