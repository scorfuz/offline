 ...
 * @since 1.0.0
 */
export const ClickhouseClient = Context.GenericTag<ClickhouseClient>(
  "@effect/sql-clickhouse/ClickhouseClient"
)
    ...
    class ConnectionImpl implements Connection {
      ...
      private runRaw(
        ...
        >((fiber) => {
          ...
          >((resume) => {
            const queryId =
              fiber.getFiberRef(currentQueryId) ?? Crypto.randomUUID()
    ...
    return Object.assign(
      ...
      }),
      {
        ...
        insertQuery<T = unknown>(options: {
          ...
          return Effect.withFiberRuntime<Clickhouse.InsertResult, SqlError>(
            (fiber) =>
              Effect.async((resume) => {
                const queryId =
                  fiber.getFiberRef(currentQueryId) ?? Crypto.randomUUID()
 ...
 * @since 1.0.0
 */
export const currentClientMethod: FiberRef.FiberRef<
 ...
 * @since 1.0.0
 */
export const currentQueryId: FiberRef.FiberRef<string | undefined> =
  globalValue("@effect/sql-clickhouse/ClickhouseClient/currentQueryId", () =>
