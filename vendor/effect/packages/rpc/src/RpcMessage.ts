 ...
 * @category request
 */
export const RequestIdTypeId: unique symbol = Symbol.for(
  "@effect/rpc/RpcServer/RequestId"
)
 ...
 * @category response
 */
export const ResponseIdTypeId: unique symbol = Symbol.for(
  "@effect/rpc/RpcServer/ResponseId"
)
