...
export declare namespace Workflow {
   ...
   */
  export type Payload<W extends Workflow<any, any, any, any>> =
    W extends Workflow<any, infer Payload, any, any> ? Payload["Type"] : never
   ...
   * @category Type-level Utils
   */
  export type Success<W extends Workflow<any, any, any, any>> =
    W extends Workflow<any, any, infer Success, any> ? Success["Type"] : never
   ...
   * @category Type-level Utils
   */
  export type Error<W extends Workflow<any, any, any, any>> =
    W extends Workflow<any, any, any, infer Error> ? Error["Type"] : never
}
 ...
 * @category Models
 */
export type Requirements<Workflows extends Any> =
...
const InstanceTag = Context.GenericTag<
  WorkflowInstance,
 ...
 * @category Result
 */
export const ResultTypeId: unique symbol = Symbol.for(
  "@effect/workflow/Workflow/Result"
)
...
export class Complete<A, E> extends Data.TaggedClass("Complete")<{
  ...
  >(_options: {
    ...
    return Schema.declare(
      (u): u is Complete<Success["Type"], Error["Type"]> =>
        isResult(u) && u._tag === "Complete",
      {
...
export class Suspended extends Schema.TaggedClass<Suspended>(
  ...
  cause: Schema.optional(
    Schema.Cause({ error: Schema.Never, defect: Schema.Defect })
  )
}) {
  /**
   * @since 1.0.0
    ...
    return Effect.onExit(effect, (exit) => {
      ...
      if (
        ...
        instance.cause = instance.cause
          ? Cause.sequential(instance.cause, exit.value.cause)
          : exit.value.cause
      }
 ...
 */
export class CaptureDefects extends Context.Reference<CaptureDefects>()(
 ...
 * @category Annotations
 */
export class SuspendOnFailure extends Context.Reference<SuspendOnFailure>()(
