...
export const mutation: {
  ...
  <A, E, R>(
    ...
    Effect.flatMap(Reactivity, (r) => r.mutation(keys, effect))
)
...
export const invalidate = (
  ...
  Effect.flatMap(Reactivity, (r) => r.invalidate(keys))
