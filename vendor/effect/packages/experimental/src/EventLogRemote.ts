 ...
 * @category protocol
 */
export class Hello extends Schema.TaggedClass<Hello>(
  "@effect/experimental/EventLogRemote/Hello"
)("Hello", {
  remoteId: RemoteId
}) {}
 ...
 * @category protocol
 */
export class WriteEntries extends Schema.TaggedClass<WriteEntries>(
  "@effect/experimental/EventLogRemote/WriteEntries"
)("WriteEntries", {
 ...
 * @category protocol
 */
export class Ack extends Schema.TaggedClass<Ack>(
  "@effect/experimental/EventLogRemote/Ack"
)("Ack", {
  id: Schema.Number,
 ...
 * @category protocol
 */
export class Changes extends Schema.TaggedClass<Changes>(
  "@effect/experimental/EventLogRemote/Changes"
)("Changes", {
  publicKey: Schema.String,
 ...
 * @category protocol
 */
export class StopChanges extends Schema.TaggedClass<StopChanges>(
  "@effect/experimental/EventLogRemote/StopChanges"
)("StopChanges", {
  publicKey: Schema.String
}) {}
 ...
 * @category protocol
 */
export class Ping extends Schema.TaggedClass<Ping>(
  "@effect/experimental/EventLogRemote/Ping"
)("Ping", {
  id: Schema.Number
}) {}
 ...
 * @category protocol
 */
export class Pong extends Schema.TaggedClass<Pong>(
  "@effect/experimental/EventLogRemote/Pong"
)("Pong", {
  id: Schema.Number
}) {}
...
> =>
  Effect.gen(function* () {
    ...
    const write = (request: typeof ProtocolRequest.Type) =>
      Effect.gen(() => writeGen(request))
...
export const fromWebSocket = (
  ...
  void,
  never,
  Scope.Scope | EventLogEncryption | EventLog | Socket.WebSocketConstructor
> =>
  Effect.gen(function* () {
...
export const layerWebSocket = (
  ...
  never,
  never,
  Socket.WebSocketConstructor | EventLog | EventLogEncryption
