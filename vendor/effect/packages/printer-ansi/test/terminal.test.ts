  ...
  Doc.align(
    Doc.vsep([
      Doc.hsep([
        ...
        Doc.annotate(Ansi.combine(Ansi.color(Color.blue), Ansi.underlined))
      ),
      Doc.text("red")
    ])
  )
...
describe("Terminal", () => {
  ...
  describe("Commands", () => {
    ...
    it("should move the cursor to the specified row and column relative to the current cursor position", () => {
      expect(render(Doc.cursorMove(1))).toBe("\u001b[0m\u001b[1C\u001b[0m")
    ...
    it("should restore the current cursor position", () => {
      expect(render(Doc.cursorRestorePosition)).toBe(
        "\u001b[0m\u001b[u\u001b[0m"
      )
    })
  ...
  describe("Annotations", () => {
    ...
    it("should alter existing annotations", () => {
      const doc = Doc.alterAnnotations(complex, () => [
        Ansi.bold,
        Ansi.color(Color.green)
      ])
      expect(render(doc)).toBe(
        String.stripMargin(
