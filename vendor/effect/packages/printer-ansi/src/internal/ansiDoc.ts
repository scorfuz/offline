...
/** @internal */
export const cursorLeft: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.cursorLeft
)
...
/** @internal */
export const cursorHide: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.cursorHide
)

/** @internal */
export const cursorShow: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.cursorShow
)
...
/** @internal */
export const eraseEndLine: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.eraseEndLine
)

/** @internal */
export const eraseStartLine: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.eraseStartLine
)

/** @internal */
export const eraseLine: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.eraseLine
)

/** @internal */
export const eraseDown: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.eraseDown
)

/** @internal */
export const eraseUp: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.eraseUp
)

/** @internal */
export const eraseScreen: AnsiDoc.AnsiDoc = Doc.annotate(
  Doc.empty,
  InternalAnsi.eraseScreen
)
