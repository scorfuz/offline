...
/** @internal */
export abstract class HttpIncomingMessageImpl<E>
  ...
  implements IncomingMessage.HttpIncomingMessage<E>
{
  ...
  get remoteAddress() {
    return Option.fromNullable(
      this.remoteAddressOverride ?? this.source.socket.remoteAddress
    )
  }
  ...
  get arrayBuffer(): Effect.Effect<ArrayBuffer, E> {
    return Effect.flatMap(IncomingMessage.MaxBodySize, (maxBodySize) =>
