...
describe("Protobuf encoding", () => {
  ...
  describe("OTLP types", () => {
    ...
    it("encodeStatus", () => {
      const okStatus = OtlpProtobuf.encodeStatus({
        code: OtlpProtobuf.StatusCode.Ok
      })
                ...
                metrics: [
                  {
                    ...
                    sum: {
                      ...
                      aggregationTemporality:
                        OtlpProtobuf.AggregationTemporality.Cumulative,
                      isMonotonic: true
                    }
                  }
                ]
  ...
  describe("OtlpSerialization", () => {
    ...
    it.effect(
      "protobuf serializer returns HttpBody with protobuf content type",
      () =>
        Effect.gen(function* () {
          const serialization = yield* OtlpSerialization.OtlpSerialization
          const body = serialization.traces(sampleTracesData)
