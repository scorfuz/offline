...
/** @internal */
export const isAvailablePerLine = (
  self: PageWidth.PageWidth
): self is PageWidth.AvailablePerLine => self._tag === "AvailablePerLine"

/** @internal */
export const isUnbounded = (
  self: PageWidth.PageWidth
): self is PageWidth.Unbounded => self._tag === "AvailablePerLine"
