...
describe.concurrent("Render", () => {
  it("pretty", () => {
    expect(
      Doc.render(doc, { style: "pretty", options: { lineWidth: 14 } })
    ).toBe(
      String.stripMargin(
        `||------------------------|
         |fun(fun(fun(
  ...
  it("pretty - unbounded", () => {
    expect(
      Doc.render(doc, { style: "pretty", options: PageWidth.unbounded })
    ).toBe(
      String.stripMargin(
        `||------------------------|
         |fun(fun(fun(fun(fun([abcdef, ghijklm])))))
  ...
  it("smart", () => {
    expect(Doc.render(doc, { style: "smart" })).toBe(
      String.stripMargin(
        `||------------------------|
       |fun(fun(fun(fun(fun([abcdef, ghijklm])))))
       ||------------------------|`
  ...
  it("smart - limited line width", () => {
    expect(
      Doc.render(doc, { style: "smart", options: { lineWidth: 14 } })
    ).toBe(
      String.stripMargin(
        `||------------------------|
         |fun(
  ...
  it("smart - unbounded", () => {
    expect(
      Doc.render(doc, { style: "smart", options: PageWidth.unbounded })
    ).toBe(
      String.stripMargin(
        `||------------------------|
         |fun(fun(fun(fun(fun([abcdef, ghijklm])))))
  ...
  it("compact", () => {
    expect(Doc.render(doc, { style: "compact" })).toBe(
      String.stripMargin(
        `||------------------------|
       |fun(
       |fun(
