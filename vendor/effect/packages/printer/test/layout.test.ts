...
describe.concurrent("Layout", () => {
  it("unbounded", () => {
    expect(Doc.renderStream(Layout.unbounded(doc))).toBe(
      String.stripMargin(
        `||------------------------|
  ...
  it("pretty", () => {
    expect(Doc.renderStream(Layout.pretty(doc, layoutOptions))).toBe(
      String.stripMargin(
        `||------------------------|
       |fun(fun(fun(fun(fun(
       |                  [ abcdef
  ...
  it("smart", () => {
    expect(Doc.renderStream(Layout.smart(doc, layoutOptions))).toBe(
      String.stripMargin(
        `||------------------------|
       |fun(
       |  fun(
  ...
  it("compact", () => {
    expect(Doc.renderStream(Layout.compact(doc))).toBe(
      String.stripMargin(
        `||------------------------|
       |fun(
       |fun(
