...
export const bimapComposition =
  ...
  <FR, FO, FE, GR, GO, E1, A, E2, B>(
    ...
    CovariantF.map(self, BicovariantG.bimap(f, g))
...
export const mapLeft = <F extends TypeLambda>(
  ...
  <E, G>(
    f: (e: E) => G
  ): <R, O, A>(self: Kind<F, R, O, E, A>) => Kind<F, R, O, G, A>
  <R, O, E, A, G>(
    self: Kind<F, R, O, E, A>,
    f: (e: E) => G
  ): Kind<F, R, O, G, A>
  ...
  dual(
    ...
    <R, O, E, A, G>(
      self: Kind<F, R, O, E, A>,
      f: (e: E) => G
    ): Kind<F, R, O, G, A> => F.bimap(self, f, identity)
  )
...
export const map = <F extends TypeLambda>(
  ...
  dual(
    ...
    <R, O, E, A, B>(
      self: Kind<F, R, O, E, A>,
      f: (a: A) => B
    ): Kind<F, R, O, E, B> => F.bimap(self, identity, f)
  )
