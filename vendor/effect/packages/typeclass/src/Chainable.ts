 ...
 * @since 0.24.0
 */
export interface Chainable<F extends TypeLambda>
 ...
 * @since 0.24.0
 */
export const tap = <F extends TypeLambda>(
  F: Chainable<F>
): {
  <A, R2, O2, E2, _>(
...
export const bind = <F extends TypeLambda>(
  ...
  dual(
    ...
    > =>
      F.flatMap(self, (a) =>
        F.map(f(a), (b) => Object.assign({}, a, { [name]: b }) as any)
      )
  )
