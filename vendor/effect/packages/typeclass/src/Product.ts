...
export const tuple =
  ...
  <T extends ReadonlyArray<Kind<F, any, any, any, any>>>(
    ...
    T[number] extends never
      ? never
      : [T[number]] extends [Kind<F, any, infer O, any, any>]
        ? O
        : never,
    T[number] extends never
      ? never
      : [T[number]] extends [Kind<F, any, any, infer E, any>]
        ? E
        : never,
    {
...
export const struct =
  ...
  <R extends { readonly [x: string]: Kind<F, any, any, any, any> }>(
    ...
    R[keyof R] extends never
      ? never
      : [R[keyof R]] extends [Kind<F, any, infer O, any, any>]
        ? O
        : never,
    R[keyof R] extends never
      ? never
      : [R[keyof R]] extends [Kind<F, any, any, infer E, any>]
        ? E
        : never,
    {
