 ...
 * @category tags
 */
export class IncomingMessage extends Context.Tag(
...
export const make = Effect.fnUntraced(function* (
  ...
  server.on("error", (cause) =>
    Deferred.unsafeDone(errorDeferred, Exit.fail(cause))
  )
...
export const layer = (
  ...
  Layer.scoped(SocketServer.SocketServer, make(options))
...
export const makeWebSocket: (
  ...
  Scope.Scope
> = Effect.fnUntraced(function* (options: WS.ServerOptions) {
...
export const layerWebSocket = (
  ...
  Layer.scoped(SocketServer.SocketServer, makeWebSocket(options))
