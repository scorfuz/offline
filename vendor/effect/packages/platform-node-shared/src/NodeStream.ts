...
) => Effect<Readable, never, R> = internal.toReadable
...
) => Readable = internal.toReadableNever
 ...
 * @category stdio
 */
export const stdin: Stream.Stream<Uint8Array> = internal
  .fromReadable(
    () => process.stdin,
    (err) => err,
    {
 ...
 * @category stdio
 */
export const stdout: Stream.Stream<Uint8Array> = internal
  .fromReadable(
    () => process.stdout,
    (err) => err,
    {
 ...
 * @category stdio
 */
export const stderr: Stream.Stream<Uint8Array> = internal
  .fromReadable(
    () => process.stderr,
    (err) => err,
    {
