...
export const fromWritableChannel: <IE, OE, A>(
  ...
  internal.fromWritableChannel

/**
 * @category stdio
 * @since 1.0.0
 */
export const stdout: Sink.Sink<
  void,
  string | Uint8Array,
  never,
  PlatformError
 ...
 * @since 1.0.0
 */
export const stdin: Sink.Sink<void, string | Uint8Array, never, PlatformError> =
  fromWritable(
    () => process.stdin,
    (cause) =>
      new SystemError({
