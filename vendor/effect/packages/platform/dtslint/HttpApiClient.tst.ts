...
declare const ApiError: Schema.Schema<
  "ApiError",
  "ApiErrorEncoded",
  "ApiErrorR"
>

declare const Group1Error: Schema.Schema<
  "Group1Error",
  "Group1ErrorEncoded",
  "Group1ErrorR"
>
declare const EndpointAError: Schema.Schema<
  "EndpointAError",
  "EndpointAErrorEncoded",
  "EndpointAErrorR"
>
declare const EndpointASuccess: Schema.Schema<
  "EndpointASuccess",
  "EndpointASuccessEncoded",
  "EndpointASuccessR"
>
declare const EndpointBError: Schema.Schema<
  "EndpointBError",
  "EndpointBErrorEncoded",
  "EndpointBErrorR"
>
declare const EndpointBSuccess: Schema.Schema<
  "EndpointBSuccess",
  "EndpointBSuccessEncoded",
  "EndpointBSuccessR"
>
...
>
class EndpointASecurity extends HttpApiMiddleware.Tag<EndpointASecurity>()(
  "EndpointASecurity",
  {
...
>
class EndpointBSecurity extends HttpApiMiddleware.Tag<EndpointBSecurity>()(
  "EndpointBSecurity",
  {
...
>
class Group1Security extends HttpApiMiddleware.Tag<Group1Security>()(
  "Group1Security",
  {
...
declare const Group2Error: Schema.Schema<
  "Group2Error",
  "Group2ErrorEncoded",
  "Group2ErrorR"
>
declare const EndpointCError: Schema.Schema<
  "EndpointCError",
  "EndpointCErrorEncoded",
  "EndpointCErrorR"
>
declare const EndpointCSuccess: Schema.Schema<
  "EndpointCSuccess",
  "EndpointCSuccessEncoded",
  "EndpointCSuccessR"
>
...
const Group2 = HttpApiGroup.make("Group2").addError(Group2Error).add(EndpointC)
...
describe("HttpApiClient", () => {
  it("endpoint", () => {
    Effect.gen(function* () {
      ...
      expect<
        Effect.Effect.Error<typeof clientEndpointEffect>
      >().type.toBe<never>()
