...
export interface HttpServerResponse
  extends Effect.Effect<HttpServerResponse>, Inspectable, Respondable {
 ...
 * @since 1.0.0
 */
export const isServerResponse: (u: unknown) => u is HttpServerResponse =
  internal.isServerResponse
...
) => HttpServerResponse = internal.empty
...
) => HttpServerResponse = internal.redirect
...
export const uint8Array: (
  body: Uint8Array,
  options?: Options.WithContentType | undefined
) => HttpServerResponse = internal.uint8Array
...
export const text: (
  body: string,
  options?: Options.WithContentType | undefined
) => HttpServerResponse = internal.text
...
export const unsafeJson: (
  body: unknown,
  options?: Options.WithContentType | undefined
) => HttpServerResponse = internal.unsafeJson
...
export const urlParams: (
  ...
  options?: Options.WithContentType | undefined
) => HttpServerResponse = internal.urlParams
...
) => HttpServerResponse = internal.raw
...
export const formData: (
  body: FormData,
  options?: Options.WithContent | undefined
) => HttpServerResponse = internal.formData
