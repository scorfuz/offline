...
export interface PlatformWorker {
  ...
  readonly spawn: <I, O>(
    id: number
  ) => Effect.Effect<BackingWorker<I, O>, WorkerError, Spawner>
}
 ...
 * @category tags
 */
export const PlatformWorker: Context.Tag<PlatformWorker, PlatformWorker> =
  internal.PlatformWorker
 ...
 * @category tags
 */
export const Spawner: Context.Tag<
  Spawner,
  SpawnerFn<unknown>
> = internal.Spawner
...
export declare namespace Worker {
  ...
  export interface Options<I> {
    readonly encode?:
      | ((message: I) => Effect.Effect<unknown, WorkerError>)
      | undefined
...
export declare namespace WorkerPool {
  ...
  export type Options<I> = Worker.Options<I> &
    (
      | {
          readonly onCreate?: (
            worker: Worker<I, unknown, unknown>
          ) => Effect.Effect<void, WorkerError>
 ...
 * @category tags
 */
export const WorkerManager: Context.Tag<WorkerManager, WorkerManager> =
 ...
 */
export const makeManager: Effect.Effect<WorkerManager, never, PlatformWorker> =
  internal.makeManager

/**
 * @since 1.0.0
 * @category layers
 */
export const layerManager: Layer.Layer<WorkerManager, never, PlatformWorker> =
...
export const makePool: <I, O, E>(
  ...
  WorkerPool<I, O, E>,
  WorkerError,
  WorkerManager | Spawner | Scope.Scope
> = internal.makePool
...
export const makePoolLayer: <Tag, I, O, E>(
  ...
  options: WorkerPool.Options<I>
) => Layer.Layer<Tag, WorkerError, WorkerManager | Spawner> =
  internal.makePoolLayer
...
export declare namespace SerializedWorker {
  ...
  export type Options<I> =
    Extract<I, { readonly _tag: "InitialMessage" }> extends never
      ...
      : {
          readonly initialMessage: LazyArg<
            Extract<I, { readonly _tag: "InitialMessage" }>
          >
        }
}
...
export const makePoolSerializedLayer: <Tag, I extends Schema.TaggedRequest.All>(
  ...
  internal.makePoolSerializedLayer
...
export const layerSpawner: <W = unknown>(
  spawner: SpawnerFn<W>
) => Layer.Layer<Spawner, never, never> = internal.layerSpawner
