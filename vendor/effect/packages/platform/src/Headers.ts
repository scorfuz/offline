 ...
 * @category type ids
 */
export const HeadersTypeId: unique symbol = Symbol.for(
...
export const isHeaders = (u: unknown): u is Headers =>
  Predicate.hasProperty(u, HeadersTypeId)
 ...
 * @category schemas
 */
export const schemaFromSelf: Schema.Schema<Headers> = Schema.declare(
  isHeaders,
  {
...
export const get: {
  ...
  (self: Headers, key: string) => Option.Option<string>
>(2, (self, key) =>
  Record.get(self as Record<string, string>, key.toLowerCase())
)
 ...
 * @category fiber refs
 */
export const currentRedactedNames: FiberRef.FiberRef<
  ReadonlyArray<string | RegExp>
> = globalValue("@effect/platform/Headers/currentRedactedNames", () =>
