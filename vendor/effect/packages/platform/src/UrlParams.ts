...
const fromInputNested = (
  ...
  const entries =
    Symbol.iterator in input ? Arr.fromIterable(input) : Object.entries(input)
...
export const append: {
  ...
  3,
  (self: UrlParams, key: string, value: Coercible): UrlParams =>
    Arr.append(self, [key, String(value)])
)
...
export const appendAll: {
  ...
  2,
  (self: UrlParams, input: Input): UrlParams =>
    Arr.appendAll(self, fromInput(input))
)
...
export const toString = (self: UrlParams): string =>
  new URLSearchParams(self as any).toString()
...
export const schemaStruct =
  <A, I extends Record<string, string | ReadonlyArray<string> | undefined>, R>(
    schema: Schema.Schema<A, I, R>,
    options?: ParseOptions | undefined
  ) =>
  (self: UrlParams): Effect.Effect<A, ParseResult.ParseError, R> => {
 ...
 * @category schema
 */
export const schemaFromString: Schema.Schema<UrlParams, string> =
  Schema.transform(Schema.String, schemaFromSelf, {
    decode(fromA) {
...
export const schemaRecord = <
  A,
  I extends Record<string, string | ReadonlyArray<string> | undefined>,
  R
>(
  schema: Schema.Schema<A, I, R>
...
>(
  ...
  Schema.compose(schemaFromString, schemaRecord(schema))
