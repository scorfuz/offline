...
const ATTR_HTTP_REQUEST_HEADER = (key: string): string =>
  `http.request.header.${key}`
const ATTR_HTTP_REQUEST_METHOD = "http.request.method"
const ATTR_HTTP_RESPONSE_HEADER = (key: string): string =>
    ...
    options:
      | {
          ...
          readonly schedule?: Schedule.Schedule<
            B,
            ClientResponse.HttpClientResponse | NoInfer<E>,
            R1
          >
          readonly times?: number
        }
