...
export declare namespace HttpApiEndpoint {
  ...
  export type SuccessWithName<
    Endpoints extends Any,
    Name extends string
  > = Success<WithName<Endpoints, Name>>

  /**
   * @since 1.0.0
   * @category models
   */
  export type ErrorWithName<Endpoints extends Any, Name extends string> = Error<
   ...
   * @category models
   */
  export type ContextWithName<
    Endpoints extends Any,
    Name extends string
  > = Context<WithName<Endpoints, Name>>

  /**
   * @since 1.0.0
   * @category models
   */
  export type ErrorContextWithName<
    Endpoints extends Any,
    Name extends string
  > = ErrorContext<WithName<Endpoints, Name>>

  /**
   * @since 1.0.0
   * @category models
   */
  export type ExcludeProvided<
    Endpoints extends Any,
    Name extends string,
    R
  > = Exclude<
    ...
    | HttpApiMiddleware.HttpApiMiddleware.ExtractProvides<
        ContextWithName<Endpoints, Name>
      >
  >
  ...
  > = Schemas extends [
    ...
    ...infer Tail extends ReadonlyArray<
      Schema.Schema.Any | Schema.PropertySignature.Any
    >
  ]
    ? [
        Head extends HttpApiSchema.Param<infer _Name, infer _S>
          ? HttpApiSchema.Param<_Name, any> extends Prev
            ...
            : [Schema.Schema.Encoded<Head> & {}] extends [string]
              ? Head
    ...
    Extract<keyof Schemas, string> extends infer K
      ? K extends keyof Schemas
        ? Schemas[K] extends HttpApiSchema.Param<infer _Name, infer _S>
          ? [_Name, _S]
          : Schemas[K] extends Schema.Schema.Any | Schema.PropertySignature.Any
            ? [K, Schemas[K]]
            : never
        : never
      : never
  ...
  > = Schema.Simplify<
    {
      readonly [Entry in Extract<
        PathEntries<Schemas>,
        [any, OptionalTypePropertySignature]
      > as Entry[0]]?: Schema.Schema.Type<Entry[1]>
    } & {
      readonly [Entry in Exclude<
        PathEntries<Schemas>,
        [any, OptionalTypePropertySignature]
      > as Entry[0]]: Schema.Schema.Type<Entry[1]>
    }
  ...
  export type Constructor<Name extends string, Method extends HttpMethod> = <
    const Schemas extends ReadonlyArray<
      Schema.Schema.Any | Schema.PropertySignature.Any
    >
  >(
...
const Proto = {
  ...
  addSuccess(
    ...
    return makeProto({
      ...this,
      successSchema:
        this.successSchema === HttpApiSchema.NoContent
          ? schema
 ...
 */
export const make = <Method extends HttpMethod>(
  method: Method
): {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, Method>
  <const Name extends string>(
    name: Name,
    path: PathSegment
    ...
    return (
      ...
      if (schemas.length > 0) {
        ...
        for (let i = 0; i < schemas.length; i++) {
          ...
          const optional =
            (schema.ast._tag === "PropertySignatureTransformation" &&
              schema.ast.from.isOptional) ||
            (schema.ast._tag === "PropertySignatureDeclaration" &&
              schema.ast.isOptional)
          obj[key] = schema
...
export const get: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "GET">
  <const Name extends string>(
    name: Name,
    path: PathSegment
...
export const post: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "POST">
  <const Name extends string>(
    name: Name,
    path: PathSegment
...
export const put: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "PUT">
  <const Name extends string>(
    name: Name,
    path: PathSegment
...
export const patch: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "PATCH">
  <const Name extends string>(
    name: Name,
    path: PathSegment
...
export const del: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "DELETE">
  <const Name extends string>(
    name: Name,
    path: PathSegment
...
export const head: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "HEAD">
  <const Name extends string>(
    name: Name,
    path: PathSegment
...
export const options: {
  <const Name extends string>(
    name: Name
  ): HttpApiEndpoint.Constructor<Name, "OPTIONS">
  <const Name extends string>(
    name: Name,
    path: PathSegment
