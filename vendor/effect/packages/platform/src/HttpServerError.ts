...
export class RequestError
  extends TypeIdError(TypeId, "RequestError")<{
 ...
 * @category predicates
 */
export const isServerError: (u: unknown) => u is HttpServerError =
...
export const causeResponse: <E>(
  ...
  readonly [ServerResponse.HttpServerResponse, Cause.Cause<E>]
> = internal.causeResponse
