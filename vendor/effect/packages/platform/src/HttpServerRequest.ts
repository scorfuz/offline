 ...
 * @category context
 */
export const HttpServerRequest: Context.Tag<
  HttpServerRequest,
  HttpServerRequest
> = internal.serverRequestTag
 ...
 * @category search params
 */
export const ParsedSearchParams: Context.Tag<
  ParsedSearchParams,
...
export const toWebEither = (
  ...
  if (hasBody(self.method)) {
    requestInit.body = Stream.toReadableStreamRuntime(
      self.stream,
