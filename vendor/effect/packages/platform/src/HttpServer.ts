 ...
 */
export const HttpServer: Context.Tag<HttpServer, HttpServer> =
  internal.serverTag
...
) => Layer.Layer<A, E, R | Exclude<HttpServer, A>> = internal.withLogAddress
...
export const layerContext: Layer.Layer<
  HttpPlatform | FileSystem | Generator | Path
