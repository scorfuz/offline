 ...
 * @category tags
 */
export class Collector extends Context.Tag(
 ...
 * @category constructors
 */
export const makeCollector: Effect.Effect<CollectorService> =
  Effect.sync(unsafeMakeCollector)
...
export const schema: {
  ...
  <A, I, R>(
    ...
    Schema.transformOrFail(Schema.encodedSchema(self), self, {
      strict: true,
 ...
 * @category schema
 */
export const ImageData: Schema.Schema<ImageData> = schema(Schema.Any, (_) => [
  (_ as ImageData).data.buffer
])
