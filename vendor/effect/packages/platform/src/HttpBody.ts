 ...
 * @category errors
 */
export const HttpBodyError: (reason: ErrorReason) => HttpBodyError =
  internal.HttpBodyError
...
export const uint8Array: (
  ...
  contentType?: string
) => Uint8Array = internal.uint8Array
 ...
 * @category constructors
 */
export const unsafeJson: (body: unknown, contentType?: string) => Uint8Array =
  internal.unsafeJson
...
export const json: (
  body: unknown,
  contentType?: string
) => Effect.Effect<Uint8Array, HttpBodyError> = internal.json
...
export const jsonSchema: <A, I, R>(
  ...
  body: A,
  contentType?: string
) => Effect.Effect<Uint8Array, HttpBodyError, R> = internal.jsonSchema
