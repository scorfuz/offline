...
export declare namespace All {
  ...
  export type ReturnIterable<T extends Iterable<ArgsAny>> = [T] extends [
    Iterable<Args.Variance<infer A>>
  ]
    ? Args<Array<A>>
    : never
  ...
  export type ReturnTuple<T extends ReadonlyArray<unknown>> =
    Args<
      T[number] extends never
        ? []
        : {
            -readonly [K in keyof T]: [T[K]] extends [Args.Variance<infer _A>]
              ? _A
              : never
          }
    > extends infer X
   ...
   * @since 1.0.0
   */
  export type Return<Arg extends Iterable<ArgsAny> | Record<string, ArgsAny>> =
    [Arg] extends [ReadonlyArray<ArgsAny>]
      ? ReturnTuple<Arg>
 ...
 */
export const all: <
  const Arg extends Iterable<Args<any>> | Record<string, Args<any>>
>(
  arg: Arg
 ...
 * @category constructors
 */
export const boolean: (options?: Args.BaseArgsConfig) => Args<boolean> =
 ...
 * @category constructors
 */
export const date: (config?: Args.BaseArgsConfig) => Args<globalThis.Date> =
  InternalArgs.date
 ...
 * @category constructors
 */
export const directory: (config?: Args.PathArgsConfig) => Args<string> =
  InternalArgs.directory
 ...
 * @category constructors
 */
export const file: (config?: Args.PathArgsConfig) => Args<string> =
  InternalArgs.file
...
) => Args<unknown> = InternalArgs.fileParse
 ...
 * @category constructors
 */
export const float: (config?: Args.BaseArgsConfig) => Args<number> =
  InternalArgs.float
 ...
 * @category constructors
 */
export const integer: (config?: Args.BaseArgsConfig) => Args<number> =
  InternalArgs.integer
 ...
 * @category constructors
 */
export const path: (config?: Args.PathArgsConfig) => Args<string> =
  InternalArgs.path
 ...
 * @category combinators
 */
export const repeated: <A>(self: Args<A>) => Args<Array<A>> =
  InternalArgs.repeated
 ...
 * @category constructors
 */
export const text: (config?: Args.BaseArgsConfig) => Args<string> =
  InternalArgs.text
