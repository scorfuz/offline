 ...
 * @category symbols
 */
export const ValidationErrorTypeId: unique symbol =
  InternalValidationError.ValidationErrorTypeId
...
) => self is CommandMismatch = InternalValidationError.isCommandMismatch
...
export const isInvalidArgument: (
  self: ValidationError
) => self is InvalidArgument = InternalValidationError.isInvalidArgument
...
export const isMultipleValuesDetected: (
  self: ValidationError
) => self is MultipleValuesDetected =
...
export const isMissingSubcommand: (
  self: ValidationError
) => self is MissingSubcommand = InternalValidationError.isMissingSubcommand
...
export const isNoBuiltInMatch: (
  self: ValidationError
) => self is NoBuiltInMatch = InternalValidationError.isNoBuiltInMatch
...
export const isUnclusteredFlag: (
  self: ValidationError
) => self is UnclusteredFlag = InternalValidationError.isUnclusteredFlag
 ...
 * @category constructors
 */
export const missingFlag: (error: HelpDoc) => ValidationError =
  InternalValidationError.missingFlag
