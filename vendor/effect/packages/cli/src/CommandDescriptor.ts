...
export declare namespace Command {
   ...
   * @category models
   */
  export type ParsedUserInputCommand<
    Name extends string,
    ValueType
  > = Command.ComputeParsedType<{
    readonly name: Name
   ...
   * @category models
   */
  export type ComputeParsedType<A> = { [K in keyof A]: A[K] } extends infer X
    ? X
    : never
 ...
 */
export const getHelp: <A>(self: Command<A>, config: CliConfig) => HelpDoc =
  Internal.getHelp
