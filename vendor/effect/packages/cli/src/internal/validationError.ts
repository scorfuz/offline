...
/** @internal */
export const ValidationErrorTypeId: ValidationError.ValidationErrorTypeId =
  Symbol.for(ValidationErrorSymbolKey) as ValidationError.ValidationErrorTypeId
...
export const isValidationError = (
  u: unknown
): u is ValidationError.ValidationError =>
...
export const isMultipleValuesDetected = (
  self: ValidationError.ValidationError
): self is ValidationError.MultipleValuesDetected =>
  self._tag === "MultipleValuesDetected"
...
export const isMissingSubcommand = (
  self: ValidationError.ValidationError
): self is ValidationError.MissingSubcommand =>
...
/** @internal */
export const missingSubcommand = (
  error: HelpDoc.HelpDoc
): ValidationError.ValidationError => {
  const op = Object.create(proto)
