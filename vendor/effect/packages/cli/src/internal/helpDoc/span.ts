...
/** @internal */
export const code = (value: Span.Span | string): Span.Span =>
  highlight(value, Color.white)

/** @internal */
export const error = (value: Span.Span | string): Span.Span =>
  highlight(value, Color.red)

/** @internal */
export const highlight = (
  value: Span.Span | string,
  color: Color.Color
): Span.Span => ({
  _tag: "Highlight",
...
/** @internal */
export const isSequence = (self: Span.Span): self is Span.Sequence =>
  self._tag === "Sequence"

/** @internal */
export const isStrong = (self: Span.Span): self is Span.Strong =>
  self._tag === "Strong"

/** @internal */
export const isText = (self: Span.Span): self is Span.Text =>
  self._tag === "Text"
...
/** @internal */
export const isWeak = (self: Span.Span): self is Span.Weak =>
  self._tag === "Weak"
