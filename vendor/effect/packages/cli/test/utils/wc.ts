...
export const options: Options.Options<[boolean, boolean, boolean, boolean]> =
  Options.all([bytesFlag, linesFlag, wordsFlag, charFlag])

export const args: Args.Args<ReadonlyArray<string>> = Args.repeated(
  Args.file({ name: "files" })
)
