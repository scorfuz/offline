...
class MysqlDB extends Context.Tag("MysqlDB")<
  MysqlDB,
  MysqlKysely.EffectKysely<Database>
>() {}

const MysqlLive = Layer.effect(MysqlDB, MysqlKysely.make<Database>()).pipe(
  Layer.provide(MysqlContainer.ClientLive)
)
