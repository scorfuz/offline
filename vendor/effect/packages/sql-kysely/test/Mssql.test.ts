...
class MssqlDB extends Context.Tag("PgDB")<
  MssqlDB,
  MssqlKysely.EffectKysely<Database>
>() {}

const MssqlLive = Layer.effect(MssqlDB, MssqlKysely.make<Database>()).pipe(
  Layer.provide(MssqlContainer.ClientLive)
)
