...
export class ListAssistantsParams extends S.Struct({
  ...
  order: S.optionalWith(ListAssistantsParamsOrder, {
    nullable: true,
...
export class AssistantToolsCode extends S.Class<AssistantToolsCode>(
  "AssistantToolsCode"
)({
  /**
   * The type of tool being defined: `code_interpreter`
 ...
 */
export class FileSearchRankingOptions extends S.Class<FileSearchRankingOptions>(
   ...
   */
  score_threshold: S.Number.pipe(
    S.greaterThanOrEqualTo(0),
    S.lessThanOrEqualTo(1)
  )
}) {}

export class AssistantToolsFileSearch extends S.Class<AssistantToolsFileSearch>(
  ...
  file_search: S.optionalWith(
    S.Struct({
       ...
       */
      max_num_results: S.optionalWith(
        S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(50)),
        {
          nullable: true
        }
      ),
      ranking_options: S.optionalWith(FileSearchRankingOptions, {
        nullable: true
      })
    }),
    { nullable: true }
 ...
 */
export class FunctionParameters extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
...
export class AssistantToolsFunction extends S.Class<AssistantToolsFunction>(
...
export class AssistantTool extends S.Union(
  AssistantToolsCode,
  AssistantToolsFileSearch,
  AssistantToolsFunction
) {}
 ...
 */
export class ResponseFormatText extends S.Class<ResponseFormatText>(
  "ResponseFormatText"
)({
  /**
   * The type of response format being defined. Always `text`.
 ...
 * to do so.
 */
export class ResponseFormatJsonObject extends S.Class<ResponseFormatJsonObject>(
 ...
 */
export class ResponseFormatJsonSchemaSchema extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class ResponseFormatJsonSchema extends S.Class<ResponseFormatJsonSchema>(
 ...
 */
export class AssistantObject extends S.Class<AssistantObject>(
  "AssistantObject"
)({
  /**
    ...
    S.Struct({
      ...
      file_search: S.optionalWith(
        S.Struct({
           ...
           */
          vector_store_ids: S.optionalWith(
            S.Array(S.String).pipe(S.maxItems(1)),
            { nullable: true }
          )
        }),
        { nullable: true }
  ...
  response_format: S.optionalWith(AssistantsApiResponseFormatOption, {
    nullable: true
  })
}) {}
...
export class CreateAssistantRequest extends S.Class<CreateAssistantRequest>(
  ...
  description: S.optionalWith(S.String.pipe(S.maxLength(512)), {
    nullable: true
  }),
  instructions: S.optionalWith(S.String.pipe(S.maxLength(256000)), {
    nullable: true
  }),
   ...
   * A list of tool enabled on the assistant. There can be a maximum of 128 tools per assistant. Tools can be of types `code_interpreter`, `file_search`, or `function`.
   */
  tools: S.optionalWith(S.Array(AssistantTool).pipe(S.maxItems(128)), {
    nullable: true,
    default: () => [] as const
  }),
  tool_resources: S.optionalWith(
          ...
          vector_stores: S.optionalWith(
            S.Array(
              S.Struct({
                 ...
                 */
                file_ids: S.optionalWith(
                  S.Array(S.String).pipe(S.maxItems(10000)),
                  { nullable: true }
                ),
                /**
...
export class ModifyAssistantRequest extends S.Class<ModifyAssistantRequest>(
  "ModifyAssistantRequest"
)({
  /**
   * ID of the model to use. You can use the [List models](https://platform.openai.com/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](https://platform.openai.com/docs/models) for descriptions of them.
   */
  model: S.optionalWith(S.Union(S.String, AssistantSupportedModels), {
    nullable: true
  }),
  reasoning_effort: S.optionalWith(
    S.Literal("none", "minimal", "low", "medium", "high"),
...
export class DeleteAssistantResponseObject extends S.Literal(
  "assistant.deleted"
) {}
...
export class CreateSpeechRequestModelEnum extends S.Literal(
  "tts-1",
  "tts-1-hd",
  "gpt-4o-mini-tts"
) {}

export class VoiceIdsSharedEnum extends S.Literal(
  "alloy",
  "ash",
  "ballad",
  "coral",
 ...
 */
export class CreateSpeechRequestResponseFormat extends S.Literal(
  "mp3",
  "opus",
  "aac",
  "flac",
 ...
 */
export class CreateSpeechRequestStreamFormat extends S.Literal(
  "sse",
  "audio"
) {}

export class CreateSpeechRequest extends S.Class<CreateSpeechRequest>(
  "CreateSpeechRequest"
)({
  /**
   ...
   */
  instructions: S.optionalWith(S.String.pipe(S.maxLength(4096)), {
    nullable: true
  }),
  /**
   ...
   */
  speed: S.optionalWith(
    S.Number.pipe(S.greaterThanOrEqualTo(0.25), S.lessThanOrEqualTo(4)),
    {
      nullable: true,
      default: () => 1 as const
    }
   ...
   * The format to stream the audio in. Supported formats are `sse` and `audio`. `sse` is not supported for `tts-1` or `tts-1-hd`.
   */
  stream_format: S.optionalWith(CreateSpeechRequestStreamFormat, {
    nullable: true,
    default: () => "audio" as const
  })
}) {}

export class CreateTranscriptionRequestModelEnum extends S.Literal(
  "whisper-1",
  "gpt-4o-transcribe",
 ...
 */
export class AudioResponseFormat extends S.Literal(
  "json",
  "text",
  "srt",
  "verbose_json",
...
export class VadConfig extends S.Class<VadConfig>("VadConfig")({
   ...
   * milliseconds).
   */
  prefix_padding_ms: S.optionalWith(S.Int, {
    nullable: true,
    default: () => 300 as const
  }),
  /**
   ...
   */
  silence_duration_ms: S.optionalWith(S.Int, {
    nullable: true,
    default: () => 200 as const
  }),
  /**
   ...
   */
  threshold: S.optionalWith(S.Number, {
    nullable: true,
...
export class CreateTranscriptionRequest extends S.Class<CreateTranscriptionRequest>(
  ...
  response_format: S.optionalWith(AudioResponseFormat, {
    nullable: true,
   ...
   */
  temperature: S.optionalWith(S.Number, {
    nullable: true,
    default: () => 0 as const
  }),
  /**
   ...
   */
  timestamp_granularities: S.optionalWith(
    S.Array(S.Literal("word", "segment")),
    {
      nullable: true,
   ...
   */
  known_speaker_names: S.optionalWith(S.Array(S.String).pipe(S.maxItems(4)), {
    nullable: true
  }),
  /**
   ...
   */
  known_speaker_references: S.optionalWith(
    S.Array(S.String).pipe(S.maxItems(4)),
    { nullable: true }
  )
}) {}
 ...
 */
export class TranscriptTextUsageTokens extends S.Class<TranscriptTextUsageTokens>(
 ...
 */
export class TranscriptTextUsageDuration extends S.Class<TranscriptTextUsageDuration>(
 ...
 */
export class CreateTranscriptionResponseJson extends S.Class<CreateTranscriptionResponseJson>(
   ...
   */
  usage: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  })
}) {}
 ...
 */
export class CreateTranscriptionResponseDiarizedJsonTask extends S.Literal(
  "transcribe"
) {}
 ...
 */
export class TranscriptionDiarizedSegmentType extends S.Literal(
 ...
 */
export class TranscriptionDiarizedSegment extends S.Class<TranscriptionDiarizedSegment>(
 ...
 */
export class CreateTranscriptionResponseDiarizedJson extends S.Class<CreateTranscriptionResponseDiarizedJson>(
...
export class TranscriptionWord extends S.Class<TranscriptionWord>(
  "TranscriptionWord"
)({
  /**
...
export class TranscriptionSegment extends S.Class<TranscriptionSegment>(
 ...
 */
export class CreateTranscriptionResponseVerboseJson extends S.Class<CreateTranscriptionResponseVerboseJson>(
 ...
 */
export class CreateTranslationRequestResponseFormat extends S.Literal(
  "json",
  "text",
  "srt",
  "verbose_json",
...
export class CreateTranslationRequest extends S.Class<CreateTranslationRequest>(
...
export class CreateTranslationResponseJson extends S.Class<CreateTranslationResponseJson>(
  "CreateTranslationResponseJson"
)({
  text: S.String
}) {}

export class CreateTranslationResponseVerboseJson extends S.Class<CreateTranslationResponseVerboseJson>(
...
export class CreateTranslation200 extends S.Union(
  CreateTranslationResponseJson,
  CreateTranslationResponseVerboseJson
) {}
 ...
 */
export class BatchRequestCounts extends S.Class<BatchRequestCounts>(
  "BatchRequestCounts"
)({
  /**
...
export class ListBatchesResponse extends S.Class<ListBatchesResponse>(
  "ListBatchesResponse"
)({
  data: S.Array(Batch),
 ...
 */
export class CreateBatchRequestEndpoint extends S.Literal(
  "/v1/responses",
  "/v1/chat/completions",
  "/v1/embeddings",
  "/v1/completions",
 ...
 */
export class BatchFileExpirationAfter extends S.Class<BatchFileExpirationAfter>(
   ...
   */
  seconds: S.Int.pipe(
    S.greaterThanOrEqualTo(3600),
    S.lessThanOrEqualTo(2592000)
  )
}) {}

export class CreateBatchRequest extends S.Class<CreateBatchRequest>(
  "CreateBatchRequest"
)({
  /**
  ...
  output_expires_after: S.optionalWith(BatchFileExpirationAfter, {
    nullable: true
  })
}) {}
...
export class ListChatCompletionsParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListChatCompletionsParamsOrder, {
    nullable: true,
 ...
 */
export class ChatCompletionMessageCustomToolCallType extends S.Literal(
  "custom"
) {}
 ...
 */
export class ChatCompletionMessageToolCalls extends S.Array(
  S.Union(ChatCompletionMessageToolCall, ChatCompletionMessageCustomToolCall)
) {}
...
export class ChatCompletionResponseMessage extends S.Class<ChatCompletionResponseMessage>(
  ...
  tool_calls: S.optionalWith(ChatCompletionMessageToolCalls, {
    nullable: true
  }),
  /**
 ...
 */
export class ServiceTierEnum extends S.Literal(
  "auto",
  "default",
  "flex",
  "scale",
 ...
 */
export class CreateChatCompletionResponseObject extends S.Literal(
  "chat.completion"
) {}
 ...
 */
export class CreateChatCompletionResponse extends S.Class<CreateChatCompletionResponse>(
  ...
  service_tier: S.optionalWith(
    S.Literal("auto", "default", "flex", "scale", "priority"),
    { nullable: true }
  ),
  /**
 ...
 */
export class ChatCompletionList extends S.Class<ChatCompletionList>(
  "ChatCompletionList"
)({
  /**
   * The type of this object. It is always set to "list".
   */
  object: ChatCompletionListObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "list" as const)
  ),
  /**
 ...
 */
export class ChatCompletionRequestMessageContentPartTextType extends S.Literal(
  "text"
) {}
 ...
 */
export class ChatCompletionRequestMessageContentPartText extends S.Class<ChatCompletionRequestMessageContentPartText>(
 ...
 */
export class ChatCompletionRequestDeveloperMessageRole extends S.Literal(
  "developer"
) {}
 ...
 */
export class ChatCompletionRequestDeveloperMessage extends S.Class<ChatCompletionRequestDeveloperMessage>(
  ...
  content: S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestMessageContentPartText).pipe(
      S.minItems(1)
    )
  ),
  /**
 ...
 */
export class ChatCompletionRequestSystemMessageRole extends S.Literal(
  "system"
) {}
 ...
 */
export class ChatCompletionRequestSystemMessage extends S.Class<ChatCompletionRequestSystemMessage>(
  ...
  content: S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestSystemMessageContentPart).pipe(
      S.minItems(1)
    )
  ),
  /**
 ...
 * The type of the content part.
 */
export class ChatCompletionRequestMessageContentPartImageType extends S.Literal(
  "image_url"
) {}
 ...
 */
export class ChatCompletionRequestMessageContentPartImageImageUrlDetail extends S.Literal(
  "auto",
  "low",
  "high"
) {}
 ...
 */
export class ChatCompletionRequestMessageContentPartImage extends S.Class<ChatCompletionRequestMessageContentPartImage>(
 ...
 */
export class ChatCompletionRequestMessageContentPartAudioType extends S.Literal(
  "input_audio"
) {}
 ...
 */
export class ChatCompletionRequestMessageContentPartAudioInputAudioFormat extends S.Literal(
  "wav",
  "mp3"
) {}
 ...
 */
export class ChatCompletionRequestMessageContentPartAudio extends S.Class<ChatCompletionRequestMessageContentPartAudio>(
 ...
 */
export class ChatCompletionRequestMessageContentPartFileType extends S.Literal(
  "file"
) {}
 ...
 */
export class ChatCompletionRequestMessageContentPartFile extends S.Class<ChatCompletionRequestMessageContentPartFile>(
 ...
 * information.
 */
export class ChatCompletionRequestUserMessage extends S.Class<ChatCompletionRequestUserMessage>(
  ...
  content: S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestUserMessageContentPart).pipe(
      S.minItems(1)
    )
  ),
  /**
 ...
 * The type of the content part.
 */
export class ChatCompletionRequestMessageContentPartRefusalType extends S.Literal(
  "refusal"
) {}

export class ChatCompletionRequestMessageContentPartRefusal extends S.Class<ChatCompletionRequestMessageContentPartRefusal>(
...
export class ChatCompletionRequestAssistantMessageContentPart extends S.Union(
  ChatCompletionRequestMessageContentPartText,
  ChatCompletionRequestMessageContentPartRefusal
) {}
 ...
 */
export class ChatCompletionRequestAssistantMessageRole extends S.Literal(
  "assistant"
) {}
 ...
 */
export class ChatCompletionRequestAssistantMessage extends S.Class<ChatCompletionRequestAssistantMessage>(
  ...
  content: S.optionalWith(
    S.Union(
       ...
       */
      S.NonEmptyArray(ChatCompletionRequestAssistantMessageContentPart).pipe(
        S.minItems(1)
      )
    ),
    { nullable: true }
...
export class ChatCompletionRequestToolMessage extends S.Class<ChatCompletionRequestToolMessage>(
  ...
  content: S.Union(
     ...
     */
    S.NonEmptyArray(ChatCompletionRequestToolMessageContentPart).pipe(
      S.minItems(1)
    )
  ),
  /**
 ...
 */
export class ChatCompletionRequestFunctionMessageRole extends S.Literal(
  "function"
) {}

export class ChatCompletionRequestFunctionMessage extends S.Class<ChatCompletionRequestFunctionMessage>(
 ...
 */
export class CreateChatCompletionRequestWebSearchOptionsUserLocationType extends S.Literal(
  "approximate"
) {}
 ...
 */
export class WebSearchLocation extends S.Class<WebSearchLocation>(
  "WebSearchLocation"
)({
  /**
   * The two-letter
 ...
 * `opus`, or `pcm16`.
 */
export class CreateChatCompletionRequestAudioFormat extends S.Literal(
  "wav",
  "aac",
  "mp3",
  "flac",
 ...
 */
export class StopConfiguration extends S.Union(
  S.String,
  S.NonEmptyArray(S.String).pipe(S.minItems(1), S.maxItems(4))
) {}
 ...
 * being regenerated.
 */
export class PredictionContent extends S.Class<PredictionContent>(
  "PredictionContent"
)({
  /**
   * The type of the predicted content you want to provide. This type is
 ...
 */
export class ChatCompletionTool extends S.Class<ChatCompletionTool>(
  "ChatCompletionTool"
)({
  /**
   * The type of the tool. Currently, only `function` is supported.
 ...
 */
export class CustomToolChatCompletionsCustomFormatEnumType extends S.Literal(
  "grammar"
) {}
 ...
 */
export class CustomToolChatCompletionsCustomFormatEnumGrammarSyntax extends S.Literal(
  "lark",
  "regex"
) {}
 ...
 */
export class CustomToolChatCompletions extends S.Class<CustomToolChatCompletions>(
 ...
 */
export class ChatCompletionToolChoiceOptionEnum extends S.Literal(
  "none",
  "auto",
  "required"
) {}
 ...
 */
export class ChatCompletionAllowedToolsChoiceType extends S.Literal(
  "allowed_tools"
) {}
 ...
 */
export class ChatCompletionAllowedToolsMode extends S.Literal(
  "auto",
  "required"
) {}
 ...
 * Constrains the tools available to the model to a pre-defined set.
 */
export class ChatCompletionAllowedTools extends S.Class<ChatCompletionAllowedTools>(
 ...
 * Constrains the tools available to the model to a pre-defined set.
 */
export class ChatCompletionAllowedToolsChoice extends S.Class<ChatCompletionAllowedToolsChoice>(
 ...
 */
export class ChatCompletionNamedToolChoice extends S.Class<ChatCompletionNamedToolChoice>(
 ...
 */
export class ChatCompletionNamedToolChoiceCustomType extends S.Literal(
  "custom"
) {}
 ...
 */
export class ChatCompletionNamedToolChoiceCustom extends S.Class<ChatCompletionNamedToolChoiceCustom>(
 ...
 */
export class CreateChatCompletionRequestFunctionCallEnum extends S.Literal(
  "none",
  "auto"
) {}
 ...
 */
export class ChatCompletionFunctionCallOption extends S.Class<ChatCompletionFunctionCallOption>(
...
export class ChatCompletionFunctions extends S.Class<ChatCompletionFunctions>(
 ...
 */
export class CreateChatCompletionRequestPromptCacheRetentionEnum extends S.Literal(
  "in-memory",
  "24h"
) {}

export class CreateChatCompletionRequest extends S.Class<CreateChatCompletionRequest>(
  ...
  modalities: S.optionalWith(S.Array(S.Literal("text", "audio")), {
    nullable: true
  }),
  verbosity: S.optionalWith(S.Literal("low", "medium", "high"), {
    nullable: true
  }),
  reasoning_effort: S.optionalWith(
    S.Literal("none", "minimal", "low", "medium", "high"),
  ...
  web_search_options: S.optionalWith(
    S.Struct({
      ...
      search_context_size: S.optionalWith(WebSearchContextSize, {
        nullable: true,
   ...
   */
  store: S.optionalWith(S.Boolean, {
    nullable: true,
   ...
   * `content` of `message`.
   */
  logprobs: S.optionalWith(S.Boolean, {
    nullable: true,
    default: () => false as const
  }),
  /**
  ...
  tools: S.optionalWith(
    S.Array(S.Union(ChatCompletionTool, CustomToolChatCompletions)),
    { nullable: true }
  ),
  tool_choice: S.optionalWith(ChatCompletionToolChoiceOption, {
    nullable: true
  }),
  parallel_tool_calls: S.optionalWith(ParallelToolCalls, {
    nullable: true,
  ...
  functions: S.optionalWith(
    S.NonEmptyArray(ChatCompletionFunctions).pipe(
      S.minItems(1),
      S.maxItems(128)
    ),
    {
  ...
  prompt_cache_retention: S.optionalWith(
    CreateChatCompletionRequestPromptCacheRetentionEnum,
    { nullable: true }
  )
}) {}

export class UpdateChatCompletionRequest extends S.Class<UpdateChatCompletionRequest>(
 ...
 */
export class ChatCompletionDeletedObject extends S.Literal(
  "chat.completion.deleted"
) {}

export class ChatCompletionDeleted extends S.Class<ChatCompletionDeleted>(
...
export class GetChatCompletionMessagesParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
...
export class GetChatCompletionMessagesParams extends S.Struct({
  after: S.optionalWith(S.String, { nullable: true }),
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(GetChatCompletionMessagesParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  })
}) {}
 ...
 */
export class ChatCompletionMessageList extends S.Class<ChatCompletionMessageList>(
  "ChatCompletionMessageList"
)({
  /**
   * The type of this object. It is always set to "list".
   */
  object: ChatCompletionMessageListObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "list" as const)
  ),
  /**
...
export class CreateCompletionRequestModelEnum extends S.Literal(
  "gpt-3.5-turbo-instruct",
  "davinci-002",
  "babbage-002"
) {}

export class CreateCompletionRequest extends S.Class<CreateCompletionRequest>(
   ...
   */
  logprobs: S.optionalWith(
    S.NullOr(S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(5))),
    {
      default: () => null
    }
  ),
   ...
   */
  max_tokens: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(0)), {
    nullable: true,
    default: () => 16 as const
  }),
  /**
 ...
 */
export class CreateCompletionResponseObject extends S.Literal(
  "text_completion"
) {}
 ...
 */
export class CreateCompletionResponse extends S.Class<CreateCompletionResponse>(
...
export class ListContainersParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListContainersParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true })
 ...
 */
export class ContainerResourceExpiresAfterAnchor extends S.Literal(
  "last_active_at"
) {}

export class ContainerResource extends S.Class<ContainerResource>(
  "ContainerResource"
)({
  /**
  ...
  expires_after: S.optionalWith(
    S.Struct({
       ...
       * The reference point for the expiration.
       */
      anchor: S.optionalWith(ContainerResourceExpiresAfterAnchor, {
        nullable: true
      }),
      /**
...
export class ContainerListResource extends S.Class<ContainerListResource>(
 ...
 */
export class CreateContainerBodyExpiresAfterAnchor extends S.Literal(
  "last_active_at"
) {}

export class CreateContainerBody extends S.Class<CreateContainerBody>(
  "CreateContainerBody"
)({
  /**
...
export class ListContainerFilesParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListContainerFilesParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true })
...
export class ContainerFileResource extends S.Class<ContainerFileResource>(
...
export class ContainerFileListResource extends S.Class<ContainerFileListResource>(
...
export class CreateContainerFileBody extends S.Class<CreateContainerFileBody>(
...
export class ListConversationItemsParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
...
export class MessageRole extends S.Literal(
  "unknown",
  "user",
  "assistant",
  "system",
 ...
 */
export class InputTextContent extends S.Class<InputTextContent>(
  "InputTextContent"
)({
  /**
   * The type of the input item. Always `input_text`.
   */
  type: InputTextContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "input_text" as const)
  ),
  /**
 ...
 */
export class FileCitationBody extends S.Class<FileCitationBody>(
  "FileCitationBody"
)({
  /**
   * The type of the file citation. Always `file_citation`.
   */
  type: FileCitationBodyType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "file_citation" as const)
  ),
  /**
   * The ID of the file.
   */
 ...
 */
export class UrlCitationBody extends S.Class<UrlCitationBody>(
  "UrlCitationBody"
)({
  /**
   * The type of the URL citation. Always `url_citation`.
   */
  type: UrlCitationBodyType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "url_citation" as const)
  ),
  /**
   * The URL of the web resource.
   */
 ...
 */
export class ContainerFileCitationBodyType extends S.Literal(
 ...
 */
export class ContainerFileCitationBody extends S.Class<ContainerFileCitationBody>(
...
export class Annotation extends S.Union(
  FileCitationBody,
  UrlCitationBody,
  ContainerFileCitationBody,
  FilePath
 ...
 */
export class OutputTextContent extends S.Class<OutputTextContent>(
  "OutputTextContent"
)({
  /**
   * The type of the output text. Always `output_text`.
   */
  type: OutputTextContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "output_text" as const)
  ),
  /**
...
export class TextContent extends S.Class<TextContent>("TextContent")({
  type: TextContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "text" as const)
  ),
  text: S.String
}) {}
 ...
 */
export class SummaryTextContent extends S.Class<SummaryTextContent>(
  "SummaryTextContent"
)({
  /**
   * The type of the object. Always `summary_text`.
   */
  type: SummaryTextContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "summary_text" as const)
  ),
  /**
 ...
 */
export class ReasoningTextContent extends S.Class<ReasoningTextContent>(
  "ReasoningTextContent"
)({
  /**
   * The type of the reasoning text. Always `reasoning_text`.
   */
  type: ReasoningTextContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "reasoning_text" as const)
  ),
  /**
...
export class RefusalContent extends S.Class<RefusalContent>("RefusalContent")({
   ...
   * The type of the refusal. Always `refusal`.
   */
  type: RefusalContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "refusal" as const)
  ),
  /**
 ...
 */
export class InputImageContent extends S.Class<InputImageContent>(
  "InputImageContent"
)({
  /**
   * The type of the input item. Always `input_image`.
   */
  type: InputImageContentType.pipe(
    S.propertySignature,
 ...
 */
export class ComputerScreenshotContentType extends S.Literal(
  "computer_screenshot"
) {}
 ...
 */
export class ComputerScreenshotContent extends S.Class<ComputerScreenshotContent>(
 ...
 */
export class InputFileContent extends S.Class<InputFileContent>(
  "InputFileContent"
)({
  /**
   * The type of the input item. Always `input_file`.
   */
  type: InputFileContentType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "input_file" as const)
  ),
  file_id: S.optionalWith(S.String, { nullable: true }),
  /**
...
export class Message extends S.Class<Message>("Message")({
  ...
  type: MessageType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "message" as const)
  ),
  /**
 ...
 */
export class FunctionToolCallResourceStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class FunctionToolCallResource extends S.Class<FunctionToolCallResource>(
 ...
 */
export class FunctionToolCallOutputResourceType extends S.Literal(
  "function_call_output"
) {}

export class FunctionAndCustomToolCallOutput extends S.Union(
  InputTextContent,
  InputImageContent,
  InputFileContent
) {}
 ...
 * `incomplete`. Populated when items are returned via API.
 */
export class FunctionToolCallOutputResourceStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class FunctionToolCallOutputResource extends S.Class<FunctionToolCallOutputResource>(
   ...
   * `incomplete`. Populated when items are returned via API.
   */
  status: S.optionalWith(FunctionToolCallOutputResourceStatus, {
    nullable: true
  })
}) {}
 ...
 */
export class FileSearchToolCallStatus extends S.Literal(
  "in_progress",
  "searching",
  "completed",
  "incomplete",
 ...
 */
export class FileSearchToolCall extends S.Class<FileSearchToolCall>(
  "FileSearchToolCall"
)({
  /**
 ...
 */
export class WebSearchToolCallStatus extends S.Literal(
  "in_progress",
  "searching",
  "completed",
  "failed"
 ...
 */
export class WebSearchActionSearch extends S.Class<WebSearchActionSearch>(
 ...
 */
export class WebSearchActionOpenPage extends S.Class<WebSearchActionOpenPage>(
 ...
 */
export class WebSearchActionFind extends S.Class<WebSearchActionFind>(
  "WebSearchActionFind"
)({
  /**
   * The action type.
 ...
 */
export class WebSearchToolCall extends S.Class<WebSearchToolCall>(
  "WebSearchToolCall"
)({
  /**
 ...
 */
export class ImageGenToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "generating",
  "failed"
 ...
 */
export class ImageGenToolCall extends S.Class<ImageGenToolCall>(
  "ImageGenToolCall"
)({
  /**
   * The type of the image generation call. Always `image_generation_call`.
...
export class ClickButtonType extends S.Literal(
  "left",
  "right",
  "wheel",
  "back",
...
export class ClickParam extends S.Class<ClickParam>("ClickParam")({
   ...
   * Specifies the event type. For a click action, this property is always `click`.
   */
  type: ClickParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "click" as const)
  ),
  /**
 ...
 */
export class DoubleClickAction extends S.Class<DoubleClickAction>(
  "DoubleClickAction"
)({
  /**
   * Specifies the event type. For a double click action, this property is always set to `double_click`.
   */
  type: DoubleClickActionType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "double_click" as const)
  ),
  /**
...
export class Drag extends S.Class<Drag>("Drag")({
  ...
  type: DragType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "drag" as const)
  ),
  /**
...
export class KeyPressAction extends S.Class<KeyPressAction>("KeyPressAction")({
   ...
   * Specifies the event type. For a keypress action, this property is always set to `keypress`.
   */
  type: KeyPressActionType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "keypress" as const)
  ),
  /**
...
export class Move extends S.Class<Move>("Move")({
  ...
  type: MoveType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "move" as const)
  ),
  /**
...
export class Screenshot extends S.Class<Screenshot>("Screenshot")({
   ...
   * always set to `screenshot`.
   */
  type: ScreenshotType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "screenshot" as const)
  )
}) {}
...
export class Scroll extends S.Class<Scroll>("Scroll")({
   ...
   * always set to `scroll`.
   */
  type: ScrollType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "scroll" as const)
  ),
  /**
...
export class Type extends S.Class<Type>("Type")({
  ...
  type: TypeType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "type" as const)
  ),
  /**
   * The text to type.
   */
...
export class Wait extends S.Class<Wait>("Wait")({
  ...
  type: WaitType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "wait" as const)
  )
}) {}

export class ComputerAction extends S.Union(
  ClickParam,
  DoubleClickAction,
  Drag,
  KeyPressAction,
 ...
 */
export class ComputerCallSafetyCheckParam extends S.Class<ComputerCallSafetyCheckParam>(
 ...
 * `incomplete`. Populated when items are returned via API.
 */
export class ComputerToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class ComputerToolCall extends S.Class<ComputerToolCall>(
  "ComputerToolCall"
)({
  /**
   * The type of the computer call. Always `computer_call`.
   */
  type: ComputerToolCallType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "computer_call" as const)
  ),
  /**
 ...
 */
export class ComputerToolCallOutputResourceType extends S.Literal(
 ...
 */
export class ComputerScreenshotImageType extends S.Literal(
  "computer_screenshot"
) {}
 ...
 */
export class ComputerScreenshotImage extends S.Class<ComputerScreenshotImage>(
 ...
 */
export class ComputerToolCallOutputResourceStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class ComputerToolCallOutputResource extends S.Class<ComputerToolCallOutputResource>(
   ...
   * developer.
   */
  acknowledged_safety_checks: S.optionalWith(
    S.Array(ComputerCallSafetyCheckParam),
    { nullable: true }
  ),
   ...
   * `incomplete`. Populated when input items are returned via API.
   */
  status: S.optionalWith(ComputerToolCallOutputResourceStatus, {
    nullable: true
  })
}) {}
 ...
 * `incomplete`. Populated when items are returned via API.
 */
export class ReasoningItemStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class CodeInterpreterToolCallType extends S.Literal(
 ...
 */
export class CodeInterpreterToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete",
  "interpreting",
 ...
 */
export class CodeInterpreterOutputLogs extends S.Class<CodeInterpreterOutputLogs>(
  "CodeInterpreterOutputLogs"
)({
  /**
   * The type of the output. Always `logs`.
   */
  type: CodeInterpreterOutputLogsType.pipe(
    S.propertySignature,
 ...
 */
export class CodeInterpreterOutputImage extends S.Class<CodeInterpreterOutputImage>(
  "CodeInterpreterOutputImage"
)({
  /**
   * The type of the output. Always `image`.
   */
  type: CodeInterpreterOutputImageType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "image" as const)
  ),
  /**
 ...
 */
export class CodeInterpreterToolCall extends S.Class<CodeInterpreterToolCall>(
  ...
  outputs: S.NullOr(
    S.Array(S.Union(CodeInterpreterOutputLogs, CodeInterpreterOutputImage))
  )
}) {}
 ...
 */
export class LocalShellExecAction extends S.Class<LocalShellExecAction>(
  "LocalShellExecAction"
)({
  /**
   * The type of the local shell action. Always `exec`.
   */
  type: LocalShellExecActionType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "exec" as const)
  ),
  /**
   * The command to run.
   */
 ...
 */
export class LocalShellToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class LocalShellToolCall extends S.Class<LocalShellToolCall>(
  "LocalShellToolCall"
)({
  /**
   * The type of the local shell call. Always `local_shell_call`.
 ...
 */
export class LocalShellToolCallOutputType extends S.Literal(
 ...
 */
export class LocalShellToolCallOutputStatusEnum extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class LocalShellToolCallOutput extends S.Class<LocalShellToolCallOutput>(
 ...
 */
export class FunctionShellAction extends S.Class<FunctionShellAction>(
  "FunctionShellAction"
)({
...
export class LocalShellCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class FunctionShellCall extends S.Class<FunctionShellCall>(
  "FunctionShellCall"
)({
  /**
   * The type of the item. Always `shell_call`.
   */
  type: FunctionShellCallType.pipe(
    S.propertySignature,
 ...
 */
export class FunctionShellCallOutputType extends S.Literal(
  "shell_call_output"
) {}
 ...
 */
export class FunctionShellCallOutputTimeoutOutcomeType extends S.Literal(
  "timeout"
) {}
 ...
 */
export class FunctionShellCallOutputTimeoutOutcome extends S.Class<FunctionShellCallOutputTimeoutOutcome>(
 ...
 */
export class FunctionShellCallOutputExitOutcome extends S.Class<FunctionShellCallOutputExitOutcome>(
 ...
 */
export class FunctionShellCallOutputContent extends S.Class<FunctionShellCallOutputContent>(
 ...
 */
export class FunctionShellCallOutput extends S.Class<FunctionShellCallOutput>(
...
export class ApplyPatchCallStatus extends S.Literal(
  "in_progress",
  "completed"
) {}
 ...
 */
export class ApplyPatchCreateFileOperationType extends S.Literal(
  "create_file"
) {}
 ...
 */
export class ApplyPatchCreateFileOperation extends S.Class<ApplyPatchCreateFileOperation>(
 ...
 */
export class ApplyPatchDeleteFileOperationType extends S.Literal(
  "delete_file"
) {}
 ...
 */
export class ApplyPatchDeleteFileOperation extends S.Class<ApplyPatchDeleteFileOperation>(
 ...
 */
export class ApplyPatchUpdateFileOperationType extends S.Literal(
  "update_file"
) {}
 ...
 */
export class ApplyPatchUpdateFileOperation extends S.Class<ApplyPatchUpdateFileOperation>(
 ...
 */
export class ApplyPatchToolCall extends S.Class<ApplyPatchToolCall>(
  "ApplyPatchToolCall"
)({
  /**
   * The type of the item. Always `apply_patch_call`.
   */
  type: ApplyPatchToolCallType.pipe(
    S.propertySignature,
 ...
 */
export class ApplyPatchToolCallOutputType extends S.Literal(
  "apply_patch_call_output"
) {}

export class ApplyPatchCallOutputStatus extends S.Literal(
  "completed",
  "failed"
) {}
 ...
 */
export class ApplyPatchToolCallOutput extends S.Class<ApplyPatchToolCallOutput>(
 ...
 */
export class MCPListToolsTool extends S.Class<MCPListToolsTool>(
  "MCPListToolsTool"
)({
  /**
  ...
  annotations: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  })
}) {}
 ...
 */
export class MCPApprovalRequest extends S.Class<MCPApprovalRequest>(
  "MCPApprovalRequest"
)({
  /**
   * The type of the item. Always `mcp_approval_request`.
 ...
 */
export class MCPApprovalResponseResourceType extends S.Literal(
 ...
 */
export class MCPApprovalResponseResource extends S.Class<MCPApprovalResponseResource>(
...
export class MCPToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete",
  "calling",
 ...
 */
export class CustomToolCallOutputType extends S.Literal(
 ...
 */
export class CustomToolCallOutput extends S.Class<CustomToolCallOutput>(
 ...
 */
export class ConversationItemList extends S.Class<ConversationItemList>(
 ...
 * `developer`.
 */
export class EasyInputMessageRole extends S.Literal(
  "user",
  "assistant",
  "system",
  "developer"
...
export class InputContent extends S.Union(
  InputTextContent,
  InputImageContent,
  InputFileContent
) {}
 ...
 * interactions.
 */
export class EasyInputMessage extends S.Class<EasyInputMessage>(
  "EasyInputMessage"
)({
  /**
   * The role of the message input. One of `user`, `assistant`, `system`, or
 ...
 */
export class InputMessageRole extends S.Literal(
  "user",
  "system",
  "developer"
) {}
 ...
 * `incomplete`. Populated when items are returned via API.
 */
export class InputMessageStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
...
export class OutputMessageContent extends S.Union(
  OutputTextContent,
  RefusalContent
) {}
 ...
 * `incomplete`. Populated when input items are returned via API.
 */
export class OutputMessageStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 * The type of the computer tool call output. Always `computer_call_output`.
 */
export class ComputerCallOutputItemParamType extends S.Literal(
  "computer_call_output"
) {}

export class FunctionCallItemStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 * The output of a computer tool call.
 */
export class ComputerCallOutputItemParam extends S.Class<ComputerCallOutputItemParam>(
 ...
 * `incomplete`. Populated when items are returned via API.
 */
export class FunctionToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 * [function calling guide](https://platform.openai.com/docs/guides/function-calling) for more information.
 */
export class FunctionToolCall extends S.Class<FunctionToolCall>(
  "FunctionToolCall"
)({
  /**
   * The unique ID of the function tool call.
 ...
 * The type of the function tool call output. Always `function_call_output`.
 */
export class FunctionCallOutputItemParamType extends S.Literal(
  "function_call_output"
) {}
 ...
 * A text input to the model.
 */
export class InputTextContentParam extends S.Class<InputTextContentParam>(
  "InputTextContentParam"
)({
  /**
   * The type of the input item. Always `input_text`.
   */
  type: InputTextContentParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "input_text" as const)
  ),
  /**
 ...
 * The type of the input item. Always `input_image`.
 */
export class InputImageContentParamAutoParamType extends S.Literal(
  "input_image"
) {}
 ...
 * An image input to the model. Learn about [image inputs](https://platform.openai.com/docs/guides/vision)
 */
export class InputImageContentParamAutoParam extends S.Class<InputImageContentParamAutoParam>(
  ...
  image_url: S.optionalWith(S.String.pipe(S.maxLength(20971520)), {
    nullable: true
  }),
  file_id: S.optionalWith(S.String, { nullable: true }),
 ...
 * A file input to the model.
 */
export class InputFileContentParam extends S.Class<InputFileContentParam>(
  "InputFileContentParam"
)({
  /**
   * The type of the input item. Always `input_file`.
   */
  type: InputFileContentParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "input_file" as const)
  ),
  file_id: S.optionalWith(S.String, { nullable: true }),
  filename: S.optionalWith(S.String, { nullable: true }),
  file_data: S.optionalWith(S.String.pipe(S.maxLength(33554432)), {
    nullable: true
  }),
  file_url: S.optionalWith(S.String, { nullable: true })
}) {}
 ...
 * The output of a function tool call.
 */
export class FunctionCallOutputItemParam extends S.Class<FunctionCallOutputItemParam>(
 ...
 */
export class FunctionShellActionParam extends S.Class<FunctionShellActionParam>(
 ...
 */
export class FunctionShellCallItemStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 */
export class FunctionShellCallItemParam extends S.Class<FunctionShellCallItemParam>(
 ...
 */
export class FunctionShellCallOutputItemParamType extends S.Literal(
  "shell_call_output"
) {}
 ...
 * The outcome type. Always `timeout`.
 */
export class FunctionShellCallOutputTimeoutOutcomeParamType extends S.Literal(
  "timeout"
) {}
 ...
 * Indicates that the function shell call exceeded its configured time limit.
 */
export class FunctionShellCallOutputTimeoutOutcomeParam extends S.Class<FunctionShellCallOutputTimeoutOutcomeParam>(
 ...
 * The outcome type. Always `exit`.
 */
export class FunctionShellCallOutputExitOutcomeParamType extends S.Literal(
  "exit"
) {}
 ...
 * Indicates that the shell commands finished and returned an exit code.
 */
export class FunctionShellCallOutputExitOutcomeParam extends S.Class<FunctionShellCallOutputExitOutcomeParam>(
 ...
 */
export class FunctionShellCallOutputOutcomeParam extends S.Union(
  FunctionShellCallOutputTimeoutOutcomeParam,
  FunctionShellCallOutputExitOutcomeParam
) {}
 ...
 */
export class FunctionShellCallOutputContentParam extends S.Class<FunctionShellCallOutputContentParam>(
 ...
 */
export class FunctionShellCallOutputItemParam extends S.Class<FunctionShellCallOutputItemParam>(
 ...
 * The type of the item. Always `apply_patch_call`.
 */
export class ApplyPatchToolCallItemParamType extends S.Literal(
  "apply_patch_call"
) {}
 ...
 */
export class ApplyPatchCallStatusParam extends S.Literal(
  "in_progress",
  "completed"
) {}
 ...
 */
export class ApplyPatchCreateFileOperationParamType extends S.Literal(
  "create_file"
) {}
 ...
 */
export class ApplyPatchCreateFileOperationParam extends S.Class<ApplyPatchCreateFileOperationParam>(
 ...
 */
export class ApplyPatchDeleteFileOperationParamType extends S.Literal(
  "delete_file"
) {}
 ...
 */
export class ApplyPatchDeleteFileOperationParam extends S.Class<ApplyPatchDeleteFileOperationParam>(
 ...
 */
export class ApplyPatchUpdateFileOperationParamType extends S.Literal(
  "update_file"
) {}
 ...
 */
export class ApplyPatchUpdateFileOperationParam extends S.Class<ApplyPatchUpdateFileOperationParam>(
 ...
 */
export class ApplyPatchToolCallItemParam extends S.Class<ApplyPatchToolCallItemParam>(
 ...
 * The type of the item. Always `apply_patch_call_output`.
 */
export class ApplyPatchToolCallOutputItemParamType extends S.Literal(
  "apply_patch_call_output"
) {}
 ...
 */
export class ApplyPatchCallOutputStatusParam extends S.Literal(
  "completed",
  "failed"
) {}
 ...
 */
export class ApplyPatchToolCallOutputItemParam extends S.Class<ApplyPatchToolCallOutputItemParam>(
  ...
  output: S.optionalWith(S.String.pipe(S.maxLength(10485760)), {
    nullable: true
  })
}) {}
 ...
 * The type of the item. Always `mcp_approval_response`.
 */
export class MCPApprovalResponseType extends S.Literal(
  "mcp_approval_response"
) {}
 ...
 * A response to an MCP approval request.
 */
export class MCPApprovalResponse extends S.Class<MCPApprovalResponse>(
  "MCPApprovalResponse"
)({
  /**
   * The type of the item. Always `mcp_approval_response`.
 ...
 */
export class ItemReferenceParam extends S.Class<ItemReferenceParam>(
  "ItemReferenceParam"
)({
...
export class CreateConversationItemsRequest extends S.Class<CreateConversationItemsRequest>(
...
export class ConversationResource extends S.Class<ConversationResource>(
...
export class ListEvalsParamsOrderBy extends S.Literal(
  "created_at",
  "updated_at"
) {}
...
export class ListEvalsParams extends S.Struct({
  after: S.optionalWith(S.String, { nullable: true }),
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListEvalsParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  }),
  order_by: S.optionalWith(ListEvalsParamsOrderBy, {
    nullable: true,
 ...
 */
export class EvalCustomDataSourceConfig extends S.Class<EvalCustomDataSourceConfig>(
  "EvalCustomDataSourceConfig"
)({
  /**
   * The type of data source. Always `custom`.
   */
  type: EvalCustomDataSourceConfigType.pipe(
    S.propertySignature,
 ...
 */
export class EvalLogsDataSourceConfig extends S.Class<EvalLogsDataSourceConfig>(
  "EvalLogsDataSourceConfig"
)({
  /**
   * The type of data source. Always `logs`.
   */
  type: EvalLogsDataSourceConfigType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "logs" as const)
  ),
  metadata: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
 ...
 */
export class EvalStoredCompletionsDataSourceConfigType extends S.Literal(
  "stored_completions"
) {}
 ...
 */
export class EvalStoredCompletionsDataSourceConfig extends S.Class<EvalStoredCompletionsDataSourceConfig>(
 ...
 * `developer`.
 */
export class EvalItemRole extends S.Literal(
  "user",
  "assistant",
  "system",
  "developer"
 ...
 * in the evaluation.
 */
export class EvalGraderLabelModel extends S.Class<EvalGraderLabelModel>(
 ...
 */
export class EvalGraderStringCheckOperation extends S.Literal(
  "eq",
  "ne",
  "like",
  "ilike"
 ...
 */
export class EvalGraderStringCheck extends S.Class<EvalGraderStringCheck>(
 ...
 * The type of grader.
 */
export class EvalGraderTextSimilarityType extends S.Literal(
  "text_similarity"
) {}
 ...
 */
export class EvalGraderTextSimilarity extends S.Class<EvalGraderTextSimilarity>(
 ...
 */
export class EvalGraderPython extends S.Class<EvalGraderPython>(
  "EvalGraderPython"
)({
  /**
   * The threshold for the score.
 ...
 */
export class EvalGraderScoreModel extends S.Class<EvalGraderScoreModel>(
  ...
  sampling_params: S.optionalWith(
    S.Struct({
      ...
      max_completions_tokens: S.optionalWith(
        S.Int.pipe(S.greaterThanOrEqualTo(1)),
        { nullable: true }
      ),
      reasoning_effort: S.optionalWith(
        S.Literal("none", "minimal", "low", "medium", "high"),
...
export class Eval extends S.Class<Eval>("Eval")({
   ...
   * The object type.
   */
  object: EvalObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "eval" as const)
  ),
  /**
 ...
 * - What data is required when creating a run
 */
export class CreateEvalCustomDataSourceConfig extends S.Class<CreateEvalCustomDataSourceConfig>(
   ...
   */
  include_sample_schema: S.optionalWith(S.Boolean, {
    nullable: true,
    default: () => false as const
  })
}) {}
 ...
 * This is usually metadata like `usecase=chatbot` or `prompt-version=v2`, etc.
 */
export class CreateEvalLogsDataSourceConfig extends S.Class<CreateEvalLogsDataSourceConfig>(
 ...
 * The type of data source. Always `stored_completions`.
 */
export class CreateEvalStoredCompletionsDataSourceConfigType extends S.Literal(
  "stored_completions"
) {}
 ...
 * Deprecated in favor of LogsDataSourceConfig.
 */
export class CreateEvalStoredCompletionsDataSourceConfig extends S.Class<CreateEvalStoredCompletionsDataSourceConfig>(
 ...
 */
export class CreateEvalItem extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 * in the evaluation.
 */
export class CreateEvalLabelModelGrader extends S.Class<CreateEvalLabelModelGrader>(
...
export class CreateEvalRequest extends S.Class<CreateEvalRequest>(
  "CreateEvalRequest"
)({
  /**
   * The name of the evaluation.
...
export class UpdateEvalRequest extends S.Class<UpdateEvalRequest>(
  "UpdateEvalRequest"
)({
  /**
...
export class GetEvalRunsParamsStatus extends S.Literal(
  "queued",
  "in_progress",
  "completed",
  "canceled",
...
export class GetEvalRunsParams extends S.Struct({
  after: S.optionalWith(S.String, { nullable: true }),
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(GetEvalRunsParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  }),
...
export class EvalJsonlFileContentSource extends S.Class<EvalJsonlFileContentSource>(
  ...
  content: S.Array(
    S.Struct({
      ...
      sample: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
        nullable: true
      })
    })
  )
...
export class EvalJsonlFileIdSource extends S.Class<EvalJsonlFileIdSource>(
  "EvalJsonlFileIdSource"
)({
  /**
   * The type of jsonl source. Always `file_id`.
   */
  type: EvalJsonlFileIdSourceType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "file_id" as const)
  ),
  /**
 ...
 */
export class CreateEvalJsonlRunDataSource extends S.Class<CreateEvalJsonlRunDataSource>(
 ...
 */
export class CreateEvalCompletionsRunDataSourceType extends S.Literal(
  "completions"
) {}
 ...
 */
export class CreateEvalCompletionsRunDataSourceInputMessagesEnumType extends S.Literal(
  "item_reference"
) {}
 ...
 */
export class EvalStoredCompletionsSourceType extends S.Literal(
  "stored_completions"
) {}
 ...
 */
export class EvalStoredCompletionsSource extends S.Class<EvalStoredCompletionsSource>(
 ...
 */
export class CreateEvalCompletionsRunDataSource extends S.Class<CreateEvalCompletionsRunDataSource>(
 ...
 */
export class CreateEvalResponsesRunDataSourceType extends S.Literal(
  "responses"
) {}
 ...
 * The type of input messages. Always `item_reference`.
 */
export class CreateEvalResponsesRunDataSourceInputMessagesEnumType extends S.Literal(
  "item_reference"
) {}
...
export class FunctionTool extends S.Class<FunctionTool>("FunctionTool")({
   ...
   * The type of the function tool. Always `function`.
   */
  type: FunctionToolType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "function" as const)
  ),
  /**
   * The name of the function to call.
   */
...
export class RankerVersionType extends S.Literal(
  "auto",
  "default-2024-11-15"
) {}

export class HybridSearchOptions extends S.Class<HybridSearchOptions>(
  "HybridSearchOptions"
)({
  /**
 ...
 * - `nin`: not in
 */
export class ComparisonFilterType extends S.Literal(
  "eq",
  "ne",
  "gt",
  "gte",
 ...
 */
export class ComparisonFilter extends S.Class<ComparisonFilter>(
  "ComparisonFilter"
)({
  /**
   * Specifies the comparison operator: `eq`, `ne`, `gt`, `gte`, `lt`, `lte`, `in`, `nin`.
   ...
   * - `nin`: not in
   */
  type: ComparisonFilterType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "eq" as const)
  ),
  /**
  ...
  value: S.Union(
    ...
    S.Number,
    S.Boolean,
    S.Array(ComparisonFilterValueItems)
  )
}) {}
...
export class FileSearchTool extends S.Class<FileSearchTool>("FileSearchTool")({
   ...
   * The type of the file search tool. Always `file_search`.
   */
  type: FileSearchToolType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "file_search" as const)
  ),
  /**
 ...
 */
export class ComputerUsePreviewToolType extends S.Literal(
  "computer_use_preview"
) {}

export class ComputerEnvironment extends S.Literal(
  "windows",
  "mac",
  "linux",
  "ubuntu",
 ...
 */
export class ComputerUsePreviewTool extends S.Class<ComputerUsePreviewTool>(
 ...
 */
export class WebSearchToolType extends S.Literal(
  "web_search",
 ...
 * The type of location approximation. Always `approximate`.
 */
export class WebSearchApproximateLocationEnumType extends S.Literal(
  "approximate"
) {}
 ...
 */
export class WebSearchToolSearchContextSize extends S.Literal(
  "low",
  "medium",
  "high"
) {}
...
export class WebSearchTool extends S.Class<WebSearchTool>("WebSearchTool")({
   ...
   * The type of the web search tool. One of `web_search` or `web_search_2025_08_26`.
   */
  type: WebSearchToolType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "web_search" as const)
  ),
  ...
  user_location: S.optionalWith(
    S.Struct({
       ...
       * The type of location approximation. Always `approximate`.
       */
      type: S.optionalWith(S.Literal("approximate"), {
        nullable: true,
        default: () => "approximate" as const
      }),
      country: S.optionalWith(S.String, { nullable: true }),
...
export class MCPTool extends S.Class<MCPTool>("MCPTool")({
  ...
  headers: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  }),
 ...
 */
export class CodeInterpreterContainerAuto extends S.Class<CodeInterpreterContainerAuto>(
  "CodeInterpreterContainerAuto"
)({
  /**
   * Always `auto`.
   */
  type: CodeInterpreterContainerAutoType.pipe(
    S.propertySignature,
   ...
   */
  file_ids: S.optionalWith(S.Array(S.String).pipe(S.maxItems(50)), {
    nullable: true
  }),
 ...
 */
export class CodeInterpreterTool extends S.Class<CodeInterpreterTool>(
  "CodeInterpreterTool"
)({
  /**
   * The type of the code interpreter tool. Always `code_interpreter`.
 ...
 */
export class ImageGenToolModel extends S.Literal(
  "gpt-image-1",
  "gpt-image-1-mini"
) {}
 ...
 */
export class ImageGenToolQuality extends S.Literal(
  "low",
  "medium",
  "high",
  "auto"
 ...
 */
export class ImageGenToolSize extends S.Literal(
  "1024x1024",
  "1024x1536",
  "1536x1024",
  "auto"
 ...
 * `jpeg`. Default: `png`.
 */
export class ImageGenToolOutputFormat extends S.Literal(
  "png",
  "webp",
  "jpeg"
) {}
 ...
 */
export class ImageGenToolBackground extends S.Literal(
  "transparent",
  "opaque",
  "auto"
) {}
...
export class ImageGenTool extends S.Class<ImageGenTool>("ImageGenTool")({
   ...
   * The image generation model to use. Default: `gpt-image-1`.
   */
  model: S.optionalWith(ImageGenToolModel, {
    nullable: true,
    default: () => "gpt-image-1" as const
  }),
  /**
   * The quality of the generated image. One of `low`, `medium`, `high`,
   * or `auto`. Default: `auto`.
   */
  quality: S.optionalWith(ImageGenToolQuality, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   ...
   * `1536x1024`, or `auto`. Default: `auto`.
   */
  size: S.optionalWith(ImageGenToolSize, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   ...
   * `jpeg`. Default: `png`.
   */
  output_format: S.optionalWith(ImageGenToolOutputFormat, {
    nullable: true,
   ...
   */
  output_compression: S.optionalWith(
   ...
   * Moderation level for the generated image. Default: `auto`.
   */
  moderation: S.optionalWith(ImageGenToolModeration, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   ...
   * `opaque`, or `auto`. Default: `auto`.
   */
  background: S.optionalWith(ImageGenToolBackground, {
    nullable: true,
    default: () => "auto" as const
  }),
 ...
 */
export class LocalShellToolParam extends S.Class<LocalShellToolParam>(
  "LocalShellToolParam"
)({
  /**
   * The type of the local shell tool. Always `local_shell`.
   */
  type: LocalShellToolParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "local_shell" as const)
  )
}) {}
 ...
 */
export class FunctionShellToolParam extends S.Class<FunctionShellToolParam>(
  "FunctionShellToolParam"
)({
  /**
   * The type of the shell tool. Always `shell`.
   */
  type: FunctionShellToolParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "shell" as const)
  )
}) {}
 ...
 * Unconstrained free-form text.
 */
export class CustomTextFormatParam extends S.Class<CustomTextFormatParam>(
  "CustomTextFormatParam"
)({
  /**
   * Unconstrained text format. Always `text`.
   */
  type: CustomTextFormatParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "text" as const)
  )
}) {}
 ...
 * A grammar defined by the user.
 */
export class CustomGrammarFormatParam extends S.Class<CustomGrammarFormatParam>(
  "CustomGrammarFormatParam"
)({
  /**
   * Grammar format. Always `grammar`.
   */
  type: CustomGrammarFormatParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "grammar" as const)
  ),
  /**
   * The syntax of the grammar definition. One of `lark` or `regex`.
   */
 ...
 */
export class CustomToolParam extends S.Class<CustomToolParam>(
  "CustomToolParam"
)({
  /**
   * The type of the custom tool. Always `custom`.
   */
  type: CustomToolParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "custom" as const)
  ),
  /**
   ...
   */
  format: S.optionalWith(
    S.Union(CustomTextFormatParam, CustomGrammarFormatParam),
    { nullable: true }
  )
}) {}
 ...
 */
export class WebSearchPreviewToolType extends S.Literal(
  "web_search_preview",
...
export class ApproximateLocation extends S.Class<ApproximateLocation>(
  "ApproximateLocation"
)({
  /**
   * The type of location approximation. Always `approximate`.
   */
  type: ApproximateLocationType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "approximate" as const)
  ),
  country: S.optionalWith(S.String, { nullable: true }),
  region: S.optionalWith(S.String, { nullable: true }),
  city: S.optionalWith(S.String, { nullable: true }),
 ...
 */
export class WebSearchPreviewTool extends S.Class<WebSearchPreviewTool>(
 ...
 */
export class ApplyPatchToolParam extends S.Class<ApplyPatchToolParam>(
  "ApplyPatchToolParam"
)({
  /**
   * The type of the tool. Always `apply_patch`.
   */
  type: ApplyPatchToolParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "apply_patch" as const)
  )
}) {}
 ...
 * The type of response format being defined. Always `json_schema`.
 */
export class TextResponseFormatJsonSchemaType extends S.Literal(
  "json_schema"
) {}
 ...
 * Learn more about [Structured Outputs](https://platform.openai.com/docs/guides/structured-outputs).
 */
export class TextResponseFormatJsonSchema extends S.Class<TextResponseFormatJsonSchema>(
 ...
 * is preferred for models that support it.
 */
export class TextResponseFormatConfiguration extends S.Union(
  ResponseFormatText,
  TextResponseFormatJsonSchema,
  ResponseFormatJsonObject
) {}
 ...
 */
export class EvalResponsesSource extends S.Class<EvalResponsesSource>(
  "EvalResponsesSource"
)({
  /**
   * The type of run data source. Always `responses`.
  ...
  created_after: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(0)), {
    nullable: true
  }),
  created_before: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(0)), {
    nullable: true
  }),
 ...
 */
export class CreateEvalResponsesRunDataSource extends S.Class<CreateEvalResponsesRunDataSource>(
  ...
  sampling_params: S.optionalWith(
    S.Struct({
      ...
      text: S.optionalWith(
        S.Struct({
          format: S.optionalWith(TextResponseFormatConfiguration, {
            nullable: true
          })
        }),
        { nullable: true }
...
export class EvalRun extends S.Class<EvalRun>("EvalRun")({
   ...
   * The type of the object. Always "eval.run".
   */
  object: EvalRunObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "eval.run" as const)
  ),
  /**
   ...
   */
  per_testing_criteria_results: S.Array(
    S.Struct({
      /**
...
export class CreateEvalRunRequest extends S.Class<CreateEvalRunRequest>(
...
export class GetEvalRunOutputItemsParamsStatus extends S.Literal(
  "fail",
  "pass"
) {}

export class GetEvalRunOutputItemsParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
...
export class GetEvalRunOutputItemsParams extends S.Struct({
  ...
  order: S.optionalWith(GetEvalRunOutputItemsParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  })
}) {}
 ...
 */
export class EvalRunOutputItemObject extends S.Literal(
 ...
 */
export class EvalRunOutputItemResult extends S.Class<EvalRunOutputItemResult>(
 ...
 */
export class EvalRunOutputItem extends S.Class<EvalRunOutputItem>(
  "EvalRunOutputItem"
)({
  /**
   * The type of the object. Always "eval.run.output_item".
 ...
 */
export class EvalRunOutputItemList extends S.Class<EvalRunOutputItemList>(
  "EvalRunOutputItemList"
)({
  /**
   * The type of this object. It is always set to "list".
   */
  object: EvalRunOutputItemListObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "list" as const)
  ),
  /**
...
export class ListFilesParams extends S.Struct({
  ...
  limit: S.optionalWith(S.Int, {
    nullable: true,
    default: () => 10000 as const
  }),
  order: S.optionalWith(ListFilesParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true })
 ...
 */
export class OpenAIFileStatus extends S.Literal(
  "uploaded",
  "processed",
  "error"
) {}
...
export class ListFilesResponse extends S.Class<ListFilesResponse>(
  "ListFilesResponse"
)({
  object: S.String,
 ...
 */
export class FilePurpose extends S.Literal(
  "assistants",
  "batch",
  "fine-tune",
  "vision",
 ...
 */
export class FileExpirationAfter extends S.Class<FileExpirationAfter>(
  "FileExpirationAfter"
)({
  /**
   * Anchor timestamp after which the expiration policy applies. Supported anchors: `created_at`.
...
export class CreateFileRequest extends S.Class<CreateFileRequest>(
  "CreateFileRequest"
)({
  /**
   * The File object (not file name) to be uploaded.
...
export class DeleteFileResponse extends S.Class<DeleteFileResponse>(
  "DeleteFileResponse"
)({
  id: S.String,
 ...
 * The string check operation to perform. One of `eq`, `ne`, `like`, or `ilike`.
 */
export class GraderStringCheckOperation extends S.Literal(
  "eq",
  "ne",
  "like",
  "ilike"
 ...
 * A StringCheckGrader object that performs a string comparison between input and reference using a specified operation.
 */
export class GraderStringCheck extends S.Class<GraderStringCheck>(
  "GraderStringCheck"
)({
  /**
   * The object type, which is always `string_check`.
 ...
 * A TextSimilarityGrader object which grades text based on similarity metrics.
 */
export class GraderTextSimilarity extends S.Class<GraderTextSimilarity>(
 ...
 * A ScoreModelGrader object that uses a model to assign a score to the input.
 */
export class GraderScoreModel extends S.Class<GraderScoreModel>(
  "GraderScoreModel"
)({
  /**
   * The object type, which is always `score_model`.
 ...
 * in the evaluation.
 */
export class GraderLabelModel extends S.Class<GraderLabelModel>(
  "GraderLabelModel"
)({
  /**
   * The object type, which is always `label_model`.
...
export class GraderMulti extends S.Class<GraderMulti>("GraderMulti")({
   ...
   * The object type, which is always `multi`.
   */
  type: GraderMultiType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "multi" as const)
  ),
  /**
   * The name of the grader.
   */
...
export class RunGraderRequest extends S.Class<RunGraderRequest>(
  "RunGraderRequest"
)({
  /**
   ...
   */
  item: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  }),
  /**
...
export class RunGraderResponse extends S.Class<RunGraderResponse>(
  "RunGraderResponse"
)({
  reward: S.Number,
  metadata: S.Struct({
  ...
  model_grader_token_usage_per_model: S.Record({
    key: S.String,
    value: S.Unknown
  })
}) {}

export class ValidateGraderRequest extends S.Class<ValidateGraderRequest>(
...
export class ValidateGraderResponse extends S.Class<ValidateGraderResponse>(
  "ValidateGraderResponse"
)({
  /**
   * The grader used for the fine-tuning job.
   */
  grader: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  })
}) {}

export class ListFineTuningCheckpointPermissionsParamsOrder extends S.Literal(
  "ascending",
  "descending"
) {}
 ...
 */
export class FineTuningCheckpointPermissionObject extends S.Literal(
 ...
 */
export class FineTuningCheckpointPermission extends S.Class<FineTuningCheckpointPermission>(
...
export class ListFineTuningCheckpointPermissionResponseObject extends S.Literal(
  "list"
) {}

export class ListFineTuningCheckpointPermissionResponse extends S.Class<ListFineTuningCheckpointPermissionResponse>(
...
export class CreateFineTuningCheckpointPermissionRequest extends S.Class<CreateFineTuningCheckpointPermissionRequest>(
 ...
 * The object type, which is always "checkpoint.permission".
 */
export class DeleteFineTuningCheckpointPermissionResponseObject extends S.Literal(
  "checkpoint.permission"
) {}

export class DeleteFineTuningCheckpointPermissionResponse extends S.Class<DeleteFineTuningCheckpointPermissionResponse>(
...
export class FineTuningJobHyperparametersBatchSizeEnum extends S.Literal(
  "auto"
) {}

export class FineTuningJobHyperparametersLearningRateMultiplierEnum extends S.Literal(
  "auto"
) {}

export class FineTuningJobHyperparametersNEpochsEnum extends S.Literal(
  "auto"
) {}
 ...
 */
export class FineTuningJobStatus extends S.Literal(
  "validating_files",
  "queued",
  "running",
  "succeeded",
...
export class FineTuningIntegration extends S.Class<FineTuningIntegration>(
 ...
 */
export class FineTuneMethodType extends S.Literal(
  "supervised",
  "dpo",
  "reinforcement"
) {}

export class FineTuneSupervisedHyperparametersBatchSizeEnum extends S.Literal(
  "auto"
) {}

export class FineTuneSupervisedHyperparametersLearningRateMultiplierEnum extends S.Literal(
  "auto"
) {}

export class FineTuneSupervisedHyperparametersNEpochsEnum extends S.Literal(
  "auto"
) {}
 ...
 */
export class FineTuneSupervisedHyperparameters extends S.Class<FineTuneSupervisedHyperparameters>(
  ...
  learning_rate_multiplier: S.optionalWith(
    S.Union(
      FineTuneSupervisedHyperparametersLearningRateMultiplierEnum,
 ...
 */
export class FineTuneSupervisedMethod extends S.Class<FineTuneSupervisedMethod>(
  "FineTuneSupervisedMethod"
)({
  hyperparameters: S.optionalWith(FineTuneSupervisedHyperparameters, {
    nullable: true
  })
}) {}
...
export class FineTuneDPOHyperparametersBatchSizeEnum extends S.Literal(
  "auto"
) {}

export class FineTuneDPOHyperparametersLearningRateMultiplierEnum extends S.Literal(
  "auto"
) {}
 ...
 */
export class FineTuneDPOHyperparameters extends S.Class<FineTuneDPOHyperparameters>(
  ...
  beta: S.optionalWith(
    S.Union(
      FineTuneDPOHyperparametersBetaEnum,
      S.Number.pipe(S.greaterThan(0), S.lessThanOrEqualTo(2))
    ),
    { nullable: true }
  ),
  /**
  ...
  batch_size: S.optionalWith(
    S.Union(
      FineTuneDPOHyperparametersBatchSizeEnum,
      S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(256))
    ),
    {
      nullable: true,
  ...
  learning_rate_multiplier: S.optionalWith(
    S.Union(
      FineTuneDPOHyperparametersLearningRateMultiplierEnum,
      S.Number.pipe(S.greaterThan(0))
    ),
    { nullable: true }
  ),
  ...
  n_epochs: S.optionalWith(
    S.Union(
      FineTuneDPOHyperparametersNEpochsEnum,
      S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(50))
    ),
    {
      nullable: true,
 ...
 */
export class FineTuneDPOMethod extends S.Class<FineTuneDPOMethod>(
  "FineTuneDPOMethod"
)({
  hyperparameters: S.optionalWith(FineTuneDPOHyperparameters, {
    nullable: true
  })
}) {}

export class FineTuneReinforcementHyperparametersBatchSizeEnum extends S.Literal(
  "auto"
) {}

export class FineTuneReinforcementHyperparametersLearningRateMultiplierEnum extends S.Literal(
  "auto"
) {}

export class FineTuneReinforcementHyperparametersNEpochsEnum extends S.Literal(
  "auto"
) {}
 ...
 */
export class FineTuneReinforcementHyperparametersReasoningEffort extends S.Literal(
  "default",
  "low",
  "medium",
  "high"
...
export class FineTuneReinforcementHyperparametersComputeMultiplierEnum extends S.Literal(
  "auto"
) {}

export class FineTuneReinforcementHyperparametersEvalIntervalEnum extends S.Literal(
  "auto"
) {}

export class FineTuneReinforcementHyperparametersEvalSamplesEnum extends S.Literal(
  "auto"
) {}
 ...
 */
export class FineTuneReinforcementHyperparameters extends S.Class<FineTuneReinforcementHyperparameters>(
  ...
  learning_rate_multiplier: S.optionalWith(
    S.Union(
      FineTuneReinforcementHyperparametersLearningRateMultiplierEnum,
      S.Number.pipe(S.greaterThan(0))
    ),
    { nullable: true }
  ),
  ...
  eval_interval: S.optionalWith(
    S.Union(
      FineTuneReinforcementHyperparametersEvalIntervalEnum,
      S.Int.pipe(S.greaterThanOrEqualTo(1))
    ),
    {
      nullable: true,
 ...
 */
export class FineTuneReinforcementMethod extends S.Class<FineTuneReinforcementMethod>(
   ...
   */
  grader: S.Record({ key: S.String, value: S.Unknown }),
  hyperparameters: S.optionalWith(FineTuneReinforcementHyperparameters, {
    nullable: true
  })
}) {}
...
export class FineTuningJob extends S.Class<FineTuningJob>("FineTuningJob")({
  ...
  hyperparameters: S.Struct({
    ...
    learning_rate_multiplier: S.optionalWith(
      S.Union(
        FineTuningJobHyperparametersLearningRateMultiplierEnum,
        S.Number.pipe(S.greaterThan(0))
      ),
      { nullable: true }
    ),
    ...
    n_epochs: S.optionalWith(
      S.Union(
        FineTuningJobHyperparametersNEpochsEnum,
        S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(50))
      ),
      {
        nullable: true,
  ...
  integrations: S.optionalWith(
    S.Array(FineTuningIntegration).pipe(S.maxItems(5)),
    { nullable: true }
  ),
  /**
...
export class ListPaginatedFineTuningJobsResponseObject extends S.Literal(
  "list"
) {}

export class ListPaginatedFineTuningJobsResponse extends S.Class<ListPaginatedFineTuningJobsResponse>(
...
export class CreateFineTuningJobRequestModelEnum extends S.Literal(
  "babbage-002",
  "davinci-002",
  "gpt-3.5-turbo",
  "gpt-4o-mini"
...
export class CreateFineTuningJobRequestHyperparametersBatchSizeEnum extends S.Literal(
  "auto"
) {}

export class CreateFineTuningJobRequestHyperparametersLearningRateMultiplierEnum extends S.Literal(
  "auto"
) {}

export class CreateFineTuningJobRequestHyperparametersNEpochsEnum extends S.Literal(
  "auto"
) {}

export class CreateFineTuningJobRequest extends S.Class<CreateFineTuningJobRequest>(
  ...
  hyperparameters: S.optionalWith(
    S.Struct({
      ...
      learning_rate_multiplier: S.optionalWith(
        S.Union(
          CreateFineTuningJobRequestHyperparametersLearningRateMultiplierEnum,
          S.Number.pipe(S.greaterThan(0))
        ),
        { nullable: true }
      ),
   ...
   */
  suffix: S.optionalWith(
    S.NullOr(S.String.pipe(S.minLength(1), S.maxLength(64))),
    { default: () => null }
  ),
  /**
 ...
 */
export class FineTuningJobCheckpointObject extends S.Literal(
 ...
 */
export class FineTuningJobCheckpoint extends S.Class<FineTuningJobCheckpoint>(
...
export class ListFineTuningJobCheckpointsResponseObject extends S.Literal(
  "list"
) {}

export class ListFineTuningJobCheckpointsResponse extends S.Class<ListFineTuningJobCheckpointsResponse>(
 ...
 */
export class FineTuningJobEventObject extends S.Literal(
 ...
 */
export class FineTuningJobEventLevel extends S.Literal(
  "info",
  "warn",
  "error"
) {}
 ...
 */
export class FineTuningJobEvent extends S.Class<FineTuningJobEvent>(
  "FineTuningJobEvent"
)({
  /**
   * The object type, which is always "fine_tuning.job.event".
   ...
   */
  data: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  })
}) {}
...
export class ListFineTuningJobEventsResponse extends S.Class<ListFineTuningJobEventsResponse>(
 ...
 */
export class CreateImageEditRequestBackground extends S.Literal(
  "transparent",
  "opaque",
  "auto"
) {}

export class CreateImageEditRequestModelEnum extends S.Literal(
  "dall-e-2",
  "gpt-image-1",
  "gpt-image-1-mini"
) {}
 ...
 */
export class CreateImageEditRequestSize extends S.Literal(
  "256x256",
  "512x512",
  "1024x1024",
  "1536x1024",
 ...
 */
export class CreateImageEditRequestResponseFormat extends S.Literal(
  "url",
  "b64_json"
) {}
 ...
 */
export class CreateImageEditRequestOutputFormat extends S.Literal(
  "png",
  "jpeg",
  "webp"
) {}
 ...
 */
export class CreateImageEditRequestQuality extends S.Literal(
  "standard",
  "low",
  "medium",
  "high",
...
export class CreateImageEditRequest extends S.Class<CreateImageEditRequest>(
   ...
   */
  image: S.Union(
    S.instanceOf(globalThis.Blob),
    S.Array(S.instanceOf(globalThis.Blob)).pipe(S.maxItems(16))
  ),
  /**
   ...
   * should be set to either `png` (default value) or `webp`.
   */
  background: S.optionalWith(CreateImageEditRequestBackground, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   ...
   */
  n: S.optionalWith(
    S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(10)),
    {
      nullable: true,
      default: () => 1 as const
    }
   ...
   * The size of the generated images. Must be one of `1024x1024`, `1536x1024` (landscape), `1024x1536` (portrait), or `auto` (default value) for `gpt-image-1`, and one of `256x256`, `512x512`, or `1024x1024` for `dall-e-2`.
   */
  size: S.optionalWith(CreateImageEditRequestSize, {
    nullable: true,
   ...
   */
  output_compression: S.optionalWith(S.Int, {
    nullable: true,
    default: () => 100 as const
  }),
  /**
   ...
   * The quality of the image that will be generated. `high`, `medium` and `low` are only supported for `gpt-image-1`. `dall-e-2` only supports `standard` quality. Defaults to `auto`.
   */
  quality: S.optionalWith(CreateImageEditRequestQuality, {
    nullable: true,
    default: () => "auto" as const
  })
}) {}
 ...
 */
export class ImagesResponseBackground extends S.Literal(
  "transparent",
  "opaque"
) {}
 ...
 */
export class ImagesResponseOutputFormat extends S.Literal(
  "png",
  "webp",
  "jpeg"
) {}
 ...
 */
export class ImagesResponseSize extends S.Literal(
  "1024x1024",
  "1024x1536",
  "1536x1024"
) {}
 ...
 */
export class ImageGenInputUsageDetails extends S.Class<ImageGenInputUsageDetails>(
...
export class CreateImageRequestModelEnum extends S.Literal(
  "dall-e-2",
  "dall-e-3",
  "gpt-image-1",
  "gpt-image-1-mini"
 ...
 */
export class CreateImageRequestQuality extends S.Literal(
  "standard",
  "hd",
  "low",
  "medium",
 ...
 */
export class CreateImageRequestResponseFormat extends S.Literal(
  "url",
  "b64_json"
) {}
 ...
 */
export class CreateImageRequestOutputFormat extends S.Literal(
  "png",
  "jpeg",
  "webp"
) {}
 ...
 */
export class CreateImageRequestSize extends S.Literal(
  "auto",
  "1024x1024",
  "1536x1024",
  "1024x1536",
 ...
 * should be set to either `png` (default value) or `webp`.
 */
export class CreateImageRequestBackground extends S.Literal(
  "transparent",
  "opaque",
  "auto"
) {}
...
export class CreateImageRequest extends S.Class<CreateImageRequest>(
   ...
   * - `standard` is the only option for `dall-e-2`.
   */
  quality: S.optionalWith(CreateImageRequestQuality, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   ...
   * The format in which the generated images are returned. This parameter is only supported for `gpt-image-1`. Must be one of `png`, `jpeg`, or `webp`.
   */
  output_format: S.optionalWith(CreateImageRequestOutputFormat, {
    nullable: true,
    default: () => "png" as const
  }),
  /**
   ...
   * The size of the generated images. Must be one of `1024x1024`, `1536x1024` (landscape), `1024x1536` (portrait), or `auto` (default value) for `gpt-image-1`, one of `256x256`, `512x512`, or `1024x1024` for `dall-e-2`, and one of `1024x1024`, `1792x1024`, or `1024x1792` for `dall-e-3`.
   */
  size: S.optionalWith(CreateImageRequestSize, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   * Control the content-moderation level for images generated by `gpt-image-1`. Must be either `low` for less restrictive filtering or `auto` (default value).
   */
  moderation: S.optionalWith(CreateImageRequestModeration, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   ...
   * should be set to either `png` (default value) or `webp`.
   */
  background: S.optionalWith(CreateImageRequestBackground, {
    nullable: true,
    default: () => "auto" as const
  }),
  /**
   * The style of the generated images. This parameter is only supported for `dall-e-3`. Must be one of `vivid` or `natural`. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images.
   */
  style: S.optionalWith(CreateImageRequestStyle, {
    nullable: true,
    default: () => "vivid" as const
  }),
  /**
   * A unique identifier representing your end-user, which can help OpenAI to monitor and detect abuse. [Learn more](https://platform.openai.com/docs/guides/safety-best-practices#end-user-ids).
   */
...
export class CreateImageVariationRequestModelEnum extends S.Literal(
  "dall-e-2"
) {}
 ...
 */
export class CreateImageVariationRequestResponseFormat extends S.Literal(
  "url",
  "b64_json"
) {}
 ...
 */
export class CreateImageVariationRequestSize extends S.Literal(
  "256x256",
  "512x512",
  "1024x1024"
) {}

export class CreateImageVariationRequest extends S.Class<CreateImageVariationRequest>(
  ...
  model: S.optionalWith(
    S.Union(S.String, CreateImageVariationRequestModelEnum),
    { nullable: true }
  ),
  /**
   * The number of images to generate. Must be between 1 and 10.
   ...
   * The size of the generated images. Must be one of `256x256`, `512x512`, or `1024x1024`.
   */
  size: S.optionalWith(CreateImageVariationRequestSize, {
    nullable: true,
    default: () => "1024x1024" as const
  }),
  /**
 ...
 */
export class ModerationImageURLInput extends S.Class<ModerationImageURLInput>(
 ...
 */
export class ModerationTextInput extends S.Class<ModerationTextInput>(
  "ModerationTextInput"
)({
  /**
   * Always `text`.
...
export class CreateModerationRequest extends S.Class<CreateModerationRequest>(
 ...
 */
export class CreateModerationResponse extends S.Class<CreateModerationResponse>(
...
export class AdminApiKeysListParams extends S.Struct({
   ...
   * Order results by creation time, ascending or descending.
   */
  order: S.optionalWith(AdminApiKeysListParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  }),
  /**
...
export class AdminApiKeysCreateRequest extends S.Class<AdminApiKeysCreateRequest>(
...
export class ListAuditLogsParams extends S.Struct({
  ...
  "event_types[]": S.optionalWith(S.Array(AuditLogEventType), {
    nullable: true
  }),
 ...
 */
export class AuditLogActorUser extends S.Class<AuditLogActorUser>(
  "AuditLogActorUser"
)({
  /**
   * The user id.
 ...
 */
export class AuditLogActorSession extends S.Class<AuditLogActorSession>(
 ...
 */
export class AuditLogActorApiKeyType extends S.Literal(
  "user",
  "service_account"
) {}
 ...
 */
export class AuditLogActorServiceAccount extends S.Class<AuditLogActorServiceAccount>(
 ...
 */
export class AuditLogActorApiKey extends S.Class<AuditLogActorApiKey>(
  "AuditLogActorApiKey"
)({
  /**
  ...
  user: S.optionalWith(AuditLogActorUser, { nullable: true }),
  service_account: S.optionalWith(AuditLogActorServiceAccount, {
    nullable: true
  })
}) {}
...
export class AuditLog extends S.Class<AuditLog>("AuditLog")({
    ...
    S.Struct({
      ...
      data: S.optionalWith(
        S.Struct({
           ...
           */
          fine_tuned_model_checkpoint: S.optionalWith(S.String, {
            nullable: true
          })
        }),
        { nullable: true }
   ...
   */
  "login.succeeded": S.optionalWith(
    S.Record({ key: S.String, value: S.Unknown }),
    { nullable: true }
  ),
  /**
   ...
   * This event has no additional fields beyond the standard audit log attributes.
   */
  "logout.succeeded": S.optionalWith(
    S.Record({ key: S.String, value: S.Unknown }),
    { nullable: true }
  ),
  /**
    ...
    S.Struct({
      ...
      changes_requested: S.optionalWith(
        S.Struct({
           ...
           */
          usage_dashboard_visibility: S.optionalWith(S.String, {
            nullable: true
          }),
          /**
           ...
           */
          api_call_logging_project_ids: S.optionalWith(S.String, {
            nullable: true
          })
        }),
        { nullable: true }
    ...
    S.Struct({
      ...
      changes_requested: S.optionalWith(
        S.Struct({
           ...
           */
          max_audio_megabytes_per_1_minute: S.optionalWith(S.Int, {
            nullable: true
          }),
          /**
           ...
           */
          batch_1_day_max_input_tokens: S.optionalWith(S.Int, {
            nullable: true
          })
        }),
        { nullable: true }
    ...
    S.Struct({
      ...
      changes_requested: S.optionalWith(
        S.Struct({
           ...
           */
          permissions_added: S.optionalWith(S.Array(S.String), {
            nullable: true
          }),
          /**
           * The permissions removed from the role.
           */
          permissions_removed: S.optionalWith(S.Array(S.String), {
            nullable: true
          }),
          /**
...
export class ListAuditLogsResponse extends S.Class<ListAuditLogsResponse>(
...
export class ListOrganizationCertificatesParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
 ...
 */
export class CertificateObject extends S.Literal(
  "certificate",
...
export class UploadCertificateRequest extends S.Class<UploadCertificateRequest>(
...
export class ToggleCertificatesRequest extends S.Class<ToggleCertificatesRequest>(
...
export class ModifyCertificateRequest extends S.Class<ModifyCertificateRequest>(
...
export class UsageCostsParams extends S.Struct({
  ...
  bucket_width: S.optionalWith(UsageCostsParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  project_ids: S.optionalWith(S.Array(S.String), { nullable: true }),
...
export class UsageCompletionsResultObject extends S.Literal(
 ...
 */
export class UsageCompletionsResult extends S.Class<UsageCompletionsResult>(
...
export class UsageEmbeddingsResultObject extends S.Literal(
 ...
 */
export class UsageEmbeddingsResult extends S.Class<UsageEmbeddingsResult>(
...
export class UsageModerationsResultObject extends S.Literal(
 ...
 */
export class UsageModerationsResult extends S.Class<UsageModerationsResult>(
...
export class UsageImagesResultObject extends S.Literal(
 ...
 */
export class UsageImagesResult extends S.Class<UsageImagesResult>(
  "UsageImagesResult"
)({
...
export class UsageAudioSpeechesResultObject extends S.Literal(
 ...
 */
export class UsageAudioSpeechesResult extends S.Class<UsageAudioSpeechesResult>(
...
export class UsageAudioTranscriptionsResultObject extends S.Literal(
 ...
 */
export class UsageAudioTranscriptionsResult extends S.Class<UsageAudioTranscriptionsResult>(
...
export class UsageVectorStoresResultObject extends S.Literal(
 ...
 */
export class UsageVectorStoresResult extends S.Class<UsageVectorStoresResult>(
...
export class UsageCodeInterpreterSessionsResultObject extends S.Literal(
 ...
 */
export class UsageCodeInterpreterSessionsResult extends S.Class<UsageCodeInterpreterSessionsResult>(
...
export class UsageTimeBucket extends S.Class<UsageTimeBucket>(
  "UsageTimeBucket"
)({
...
export class ListGroupsParams extends S.Struct({
  limit: S.optionalWith(
    S.Int.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(1000)),
    {
      nullable: true,
      default: () => 100 as const
    }
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListGroupsParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  })
}) {}
 ...
 */
export class GroupListResource extends S.Class<GroupListResource>(
  "GroupListResource"
)({
  /**
   * Always `list`.
 ...
 */
export class CreateGroupBody extends S.Class<CreateGroupBody>(
  "CreateGroupBody"
)({
  /**
 ...
 */
export class UpdateGroupBody extends S.Class<UpdateGroupBody>(
  "UpdateGroupBody"
)({
  /**
 ...
 */
export class GroupResourceWithSuccess extends S.Class<GroupResourceWithSuccess>(
 ...
 */
export class GroupDeletedResource extends S.Class<GroupDeletedResource>(
...
export class ListGroupRoleAssignmentsParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
 ...
 */
export class AssignedRoleDetails extends S.Class<AssignedRoleDetails>(
  "AssignedRoleDetails"
)({
  /**
 ...
 */
export class RoleListResource extends S.Class<RoleListResource>(
  "RoleListResource"
)({
  /**
   * Always `list`.
 ...
 */
export class PublicAssignOrganizationGroupRoleBody extends S.Class<PublicAssignOrganizationGroupRoleBody>(
 ...
 */
export class GroupRoleAssignment extends S.Class<GroupRoleAssignment>(
  "GroupRoleAssignment"
)({
  /**
   * Always `group.role`.
 ...
 */
export class DeletedRoleAssignmentResource extends S.Class<DeletedRoleAssignmentResource>(
...
export class ListGroupUsersParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListGroupUsersParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  })
}) {}
 ...
 */
export class UserListResource extends S.Class<UserListResource>(
  "UserListResource"
)({
  /**
   * Always `list`.
 ...
 */
export class CreateGroupUserBody extends S.Class<CreateGroupUserBody>(
  "CreateGroupUserBody"
)({
  /**
 ...
 */
export class GroupUserAssignment extends S.Class<GroupUserAssignment>(
  "GroupUserAssignment"
)({
  /**
   * Always `group.user`.
 ...
 */
export class GroupUserDeletedResourceObject extends S.Literal(
  "group.user.deleted"
) {}
 ...
 */
export class GroupUserDeletedResource extends S.Class<GroupUserDeletedResource>(
...
export class InviteListResponse extends S.Class<InviteListResponse>(
  "InviteListResponse"
)({
  /**
   * The object type, which is always `list`
 ...
 */
export class InviteDeleteResponseObject extends S.Literal(
  "organization.invite.deleted"
) {}

export class InviteDeleteResponse extends S.Class<InviteDeleteResponse>(
...
export class ListProjectsParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  after: S.optionalWith(S.String, { nullable: true }),
  include_archived: S.optionalWith(S.Boolean, {
    nullable: true,
    default: () => false as const
  })
}) {}
 ...
 */
export class ProjectCreateRequestGeography extends S.Literal(
  "US",
  "EU",
  "JP",
  "IN",
 ...
 */
export class ProjectApiKeyObject extends S.Literal(
 ...
 */
export class ProjectApiKeyOwnerType extends S.Literal(
  "user",
  "service_account"
) {}
 ...
 */
export class ProjectServiceAccountObject extends S.Literal(
 ...
 */
export class ProjectServiceAccount extends S.Class<ProjectServiceAccount>(
...
export class ProjectApiKeyListResponse extends S.Class<ProjectApiKeyListResponse>(
...
export class ProjectApiKeyDeleteResponseObject extends S.Literal(
  "organization.project.api_key.deleted"
) {}

export class ProjectApiKeyDeleteResponse extends S.Class<ProjectApiKeyDeleteResponse>(
...
export class ListProjectCertificatesParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
...
export class ListProjectGroupsParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListProjectGroupsParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  })
}) {}
 ...
 */
export class ProjectGroupListResource extends S.Class<ProjectGroupListResource>(
 ...
 */
export class InviteProjectGroupBody extends S.Class<InviteProjectGroupBody>(
 ...
 */
export class ProjectGroupDeletedResourceObject extends S.Literal(
 ...
 */
export class ProjectGroupDeletedResource extends S.Class<ProjectGroupDeletedResource>(
 ...
 */
export class ProjectRateLimit extends S.Class<ProjectRateLimit>(
  "ProjectRateLimit"
)({
  /**
   * The object type, which is always `project.rate_limit`
...
export class ProjectRateLimitListResponse extends S.Class<ProjectRateLimitListResponse>(
...
export class ProjectRateLimitUpdateRequest extends S.Class<ProjectRateLimitUpdateRequest>(
...
export class ProjectServiceAccountListResponseObject extends S.Literal(
  "list"
) {}

export class ProjectServiceAccountListResponse extends S.Class<ProjectServiceAccountListResponse>(
...
export class ProjectServiceAccountCreateRequest extends S.Class<ProjectServiceAccountCreateRequest>(
...
export class ProjectServiceAccountCreateResponseObject extends S.Literal(
  "organization.project.service_account"
) {}
 ...
 */
export class ProjectServiceAccountCreateResponseRole extends S.Literal(
  "member"
) {}
 ...
 */
export class ProjectServiceAccountApiKeyObject extends S.Literal(
  "organization.project.service_account.api_key"
) {}

export class ProjectServiceAccountApiKey extends S.Class<ProjectServiceAccountApiKey>(
...
export class ProjectServiceAccountCreateResponse extends S.Class<ProjectServiceAccountCreateResponse>(
...
export class ProjectServiceAccountDeleteResponseObject extends S.Literal(
  "organization.project.service_account.deleted"
) {}

export class ProjectServiceAccountDeleteResponse extends S.Class<ProjectServiceAccountDeleteResponse>(
...
export class ProjectUserListResponse extends S.Class<ProjectUserListResponse>(
 ...
 * `owner` or `member`
 */
export class ProjectUserCreateRequestRole extends S.Literal(
  "owner",
  "member"
) {}

export class ProjectUserCreateRequest extends S.Class<ProjectUserCreateRequest>(
 ...
 * `owner` or `member`
 */
export class ProjectUserUpdateRequestRole extends S.Literal(
  "owner",
  "member"
) {}

export class ProjectUserUpdateRequest extends S.Class<ProjectUserUpdateRequest>(
...
export class ProjectUserDeleteResponseObject extends S.Literal(
  "organization.project.user.deleted"
) {}

export class ProjectUserDeleteResponse extends S.Class<ProjectUserDeleteResponse>(
...
export class ListRolesParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListRolesParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  })
}) {}
 ...
 */
export class PublicRoleListResource extends S.Class<PublicRoleListResource>(
 ...
 */
export class PublicCreateOrganizationRoleBody extends S.Class<PublicCreateOrganizationRoleBody>(
 ...
 */
export class PublicUpdateOrganizationRoleBody extends S.Class<PublicUpdateOrganizationRoleBody>(
 ...
 */
export class RoleDeletedResource extends S.Class<RoleDeletedResource>(
  "RoleDeletedResource"
)({
  /**
   * Always `role.deleted`.
...
export class UsageAudioSpeechesParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageAudioSpeechesParams extends S.Struct({
  start_time: S.Int,
  end_time: S.optionalWith(S.Int, { nullable: true }),
  bucket_width: S.optionalWith(UsageAudioSpeechesParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  project_ids: S.optionalWith(S.Array(S.String), { nullable: true }),
  ...
  group_by: S.optionalWith(
    S.Array(S.Literal("project_id", "user_id", "api_key_id", "model")),
    { nullable: true }
  ),
  limit: S.optionalWith(S.Int, { nullable: true }),
  page: S.optionalWith(S.String, { nullable: true })
...
export class UsageAudioTranscriptionsParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageCodeInterpreterSessionsParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageCompletionsParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageCompletionsParams extends S.Struct({
  start_time: S.Int,
  end_time: S.optionalWith(S.Int, { nullable: true }),
  bucket_width: S.optionalWith(UsageCompletionsParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  project_ids: S.optionalWith(S.Array(S.String), { nullable: true }),
...
export class UsageEmbeddingsParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageEmbeddingsParams extends S.Struct({
  start_time: S.Int,
  end_time: S.optionalWith(S.Int, { nullable: true }),
  bucket_width: S.optionalWith(UsageEmbeddingsParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  project_ids: S.optionalWith(S.Array(S.String), { nullable: true }),
...
export class UsageImagesParams extends S.Struct({
  start_time: S.Int,
  end_time: S.optionalWith(S.Int, { nullable: true }),
  bucket_width: S.optionalWith(UsageImagesParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  sources: S.optionalWith(
    S.Array(S.Literal("image.generation", "image.edit", "image.variation")),
    {
      nullable: true
    }
  ),
  sizes: S.optionalWith(
    S.Array(
      S.Literal("256x256", "512x512", "1024x1024", "1792x1792", "1024x1792")
    ),
    {
      nullable: true
    }
...
export class UsageModerationsParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageModerationsParams extends S.Struct({
  start_time: S.Int,
  end_time: S.optionalWith(S.Int, { nullable: true }),
  bucket_width: S.optionalWith(UsageModerationsParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  project_ids: S.optionalWith(S.Array(S.String), { nullable: true }),
...
export class UsageVectorStoresParamsBucketWidth extends S.Literal(
  "1m",
  "1h",
  "1d"
) {}
...
export class UsageVectorStoresParams extends S.Struct({
  start_time: S.Int,
  end_time: S.optionalWith(S.Int, { nullable: true }),
  bucket_width: S.optionalWith(UsageVectorStoresParamsBucketWidth, {
    nullable: true,
    default: () => "1d" as const
  }),
  project_ids: S.optionalWith(S.Array(S.String), { nullable: true }),
...
export class UserRoleUpdateRequest extends S.Class<UserRoleUpdateRequest>(
...
export class UserDeleteResponseObject extends S.Literal(
  "organization.user.deleted"
) {}

export class UserDeleteResponse extends S.Class<UserDeleteResponse>(
  "UserDeleteResponse"
)({
...
export class ListUserRoleAssignmentsParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
 ...
 */
export class UserRoleAssignment extends S.Class<UserRoleAssignment>(
  "UserRoleAssignment"
)({
  /**
   * Always `user.role`.
...
export class ListProjectGroupRoleAssignmentsParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
...
export class ListProjectGroupRoleAssignmentsParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListProjectGroupRoleAssignmentsParamsOrder, {
    nullable: true
  })
}) {}
...
export class ListProjectRolesParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListProjectRolesParamsOrder, {
    nullable: true,
    default: () => "asc" as const
  })
}) {}

export class ListProjectUserRoleAssignmentsParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}
...
export class ListProjectUserRoleAssignmentsParams extends S.Struct({
  ...
  after: S.optionalWith(S.String, { nullable: true }),
  order: S.optionalWith(ListProjectUserRoleAssignmentsParamsOrder, {
    nullable: true
  })
}) {}
 ...
 */
export class AudioTranscriptionModel extends S.Literal(
  "whisper-1",
  "gpt-4o-mini-transcribe",
  "gpt-4o-transcribe",
  "gpt-4o-transcribe-diarize"
...
export class AudioTranscription extends S.Class<AudioTranscription>(
  "AudioTranscription"
)({
  /**
   * The model to use for transcription. Current options are `whisper-1`, `gpt-4o-mini-transcribe`, `gpt-4o-transcribe`, and `gpt-4o-transcribe-diarize`. Use `gpt-4o-transcribe-diarize` when you need diarization with speaker labels.
 ...
 */
export class RealtimeTurnDetectionEnumEagerness extends S.Literal(
  "low",
  "medium",
  "high",
  "auto"
...
export class RealtimeTurnDetection extends S.Union(
  ...
  S.Union(
    ...
    S.Struct({
       ...
       */
      create_response: S.optionalWith(S.Boolean, {
        nullable: true,
        default: () => true as const
      }),
      /**
       ...
       */
      interrupt_response: S.optionalWith(S.Boolean, {
        nullable: true,
        default: () => true as const
      }),
 ...
 */
export class RealtimeSessionCreateRequestGATracingEnum extends S.Literal(
  "auto"
) {}
...
export class RealtimeFunctionTool extends S.Class<RealtimeFunctionTool>(
   ...
   */
  parameters: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  })
}) {}
 ...
 */
export class ToolChoiceFunction extends S.Class<ToolChoiceFunction>(
  "ToolChoiceFunction"
)({
  /**
   * For function calling, the type is always `function`.
...
export class RealtimeSessionCreateRequestGAMaxOutputTokensEnum extends S.Literal(
  "inf"
) {}
  ...
  S.Struct({
    ...
    token_limits: S.optionalWith(
      S.Struct({
         ...
         */
        post_instructions: S.optionalWith(
          S.Int.pipe(S.greaterThanOrEqualTo(0)),
          { nullable: true }
        )
      }),
      { nullable: true }
...
export class Prompt extends S.Union(
  ...
  S.Struct({
    ...
    variables: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
      nullable: true
    })
  }),
  S.Null
 ...
 */
export class RealtimeSessionCreateRequestGA extends S.Class<RealtimeSessionCreateRequestGA>(
   ...
   */
  model: S.optionalWith(
    S.Union(S.String, RealtimeSessionCreateRequestGAModelEnum),
    { nullable: true }
  ),
  /**
    ...
    S.Struct({
          ...
          turn_detection: S.optionalWith(
            S.Union(
              ...
              S.Struct({
                ...
                idle_timeout_ms: S.optionalWith(
                  S.Int.pipe(
                    S.greaterThanOrEqualTo(5000),
                    S.lessThanOrEqualTo(30000)
                  ),
                  { nullable: true }
                )
              }),
              ...
              S.Struct({
                 ...
                 * Used only for `semantic_vad` mode. The eagerness of the model to respond. `low` will wait longer for the user to continue speaking, `high` will respond more quickly. `auto` is the default and is equivalent to `medium`. `low`, `medium`, and `high` have max timeouts of 8s, 4s, and 2s respectively.
                 */
                eagerness: S.optionalWith(
                  S.Literal("low", "medium", "high", "auto"),
                  {
                    nullable: true,
                    default: () => "auto" as const
                  }
      ...
      output: S.optionalWith(
        S.Struct({
          ...
          speed: S.optionalWith(
            S.Number.pipe(
              S.greaterThanOrEqualTo(0.25),
              S.lessThanOrEqualTo(1.5)
            ),
            {
              nullable: true,
              default: () => 1 as const
  ...
  include: S.optionalWith(
    S.Array(S.Literal("item.input_audio_transcription.logprobs")),
    { nullable: true }
  ),
  /**
   ...
   */
  tools: S.optionalWith(S.Array(S.Union(RealtimeFunctionTool, MCPTool)), {
    nullable: true
  }),
  /**
  ...
  tool_choice: S.optionalWith(
    S.Union(ToolChoiceOptions, ToolChoiceFunction, ToolChoiceMCP),
    {
      nullable: true,
      default: () => "auto" as const
    }
   ...
   */
  max_output_tokens: S.optionalWith(
    S.Union(S.Int, RealtimeSessionCreateRequestGAMaxOutputTokensEnum),
    {
      nullable: true
    }
  ),
 ...
 */
export class RealtimeCallCreateRequest extends S.Class<RealtimeCallCreateRequest>(
 ...
 * Realtime API.
 */
export class RealtimeCallReferRequest extends S.Class<RealtimeCallReferRequest>(
 ...
 */
export class RealtimeCallRejectRequest extends S.Class<RealtimeCallRejectRequest>(
 ...
 */
export class RealtimeCreateClientSecretRequestExpiresAfterAnchor extends S.Literal(
  "created_at"
) {}
 ...
 */
export class RealtimeTranscriptionSessionCreateRequestGAType extends S.Literal(
  "transcription"
) {}
 ...
 */
export class RealtimeTranscriptionSessionCreateRequestGA extends S.Class<RealtimeTranscriptionSessionCreateRequestGA>(
 ...
 */
export class RealtimeCreateClientSecretRequest extends S.Class<RealtimeCreateClientSecretRequest>(
  ...
  expires_after: S.optionalWith(
    S.Struct({
       ...
       */
      seconds: S.optionalWith(
        S.Int.pipe(S.greaterThanOrEqualTo(10), S.lessThanOrEqualTo(7200)),
        {
          nullable: true,
 ...
 * The type of session to create. Always `realtime` for the Realtime API.
 */
export class RealtimeSessionCreateResponseGAType extends S.Literal(
  "realtime"
) {}
 ...
 * Enables tracing and sets default values for tracing configuration options. Always `auto`.
 */
export class RealtimeSessionCreateResponseGATracingEnum extends S.Literal(
  "auto"
) {}

export class RealtimeSessionCreateResponseGAMaxOutputTokensEnum extends S.Literal(
  "inf"
) {}
 ...
 */
export class RealtimeSessionCreateResponseGA extends S.Class<RealtimeSessionCreateResponseGA>(
   ...
   */
  model: S.optionalWith(
    S.Union(S.String, RealtimeSessionCreateResponseGAModelEnum),
    { nullable: true }
  ),
  /**
   * The default system instructions (i.e. system message) prepended to model calls. This field allows the client to guide the model on desired responses. The model can be instructed on response content and format, (e.g. "be extremely succinct", "act friendly", "here are examples of good responses") and on audio behavior (e.g. "talk quickly", "inject emotion into your voice", "laugh frequently"). The instructions are not guaranteed to be followed by the model, but they provide guidance to the model on the desired behavior.
   ...
   */
  max_output_tokens: S.optionalWith(
    S.Union(S.Int, RealtimeSessionCreateResponseGAMaxOutputTokensEnum),
    {
      nullable: true
    }
  ),
 ...
 */
export class RealtimeTranscriptionSessionCreateResponseGAType extends S.Literal(
  "transcription"
) {}
 ...
 */
export class RealtimeTranscriptionSessionCreateResponseGA extends S.Class<RealtimeTranscriptionSessionCreateResponseGA>(
 ...
 */
export class RealtimeCreateClientSecretResponse extends S.Class<RealtimeCreateClientSecretResponse>(
 ...
 */
export class RealtimeSessionCreateRequestTracingEnum extends S.Literal(
  "auto"
) {}

export class RealtimeSessionCreateRequestMaxResponseOutputTokensEnum extends S.Literal(
  "inf"
) {}
 ...
 * for keys is one minute.
 */
export class RealtimeSessionCreateRequest extends S.Class<RealtimeSessionCreateRequest>(
   ...
   */
  speed: S.optionalWith(
    S.Number.pipe(S.greaterThanOrEqualTo(0.25), S.lessThanOrEqualTo(1.5)),
    {
      nullable: true,
      default: () => 1 as const
    }
 ...
 * Default tracing mode for the session.
 */
export class RealtimeSessionCreateResponseTracingEnum extends S.Literal(
  "auto"
) {}

export class RealtimeSessionCreateResponseMaxOutputTokensEnum extends S.Literal(
  "inf"
) {}
 ...
 */
export class RealtimeSessionCreateResponse extends S.Class<RealtimeSessionCreateResponse>(
   ...
   */
  max_output_tokens: S.optionalWith(
    S.Union(S.Int, RealtimeSessionCreateResponseMaxOutputTokensEnum),
    {
      nullable: true
    }
  )
 ...
 */
export class RealtimeTranscriptionSessionCreateRequestTurnDetectionType extends S.Literal(
  "server_vad"
) {}
 ...
 */
export class RealtimeTranscriptionSessionCreateRequestInputAudioFormat extends S.Literal(
  "pcm16",
  "g711_ulaw",
  "g711_alaw"
) {}
 ...
 * Realtime transcription session object configuration.
 */
export class RealtimeTranscriptionSessionCreateRequest extends S.Class<RealtimeTranscriptionSessionCreateRequest>(
   ...
   * single channel (mono), and little-endian byte order.
   */
  input_audio_format: S.optionalWith(
   ...
   */
  input_audio_transcription: S.optionalWith(AudioTranscription, {
    nullable: true
  }),
  /**
 ...
 */
export class RealtimeTranscriptionSessionCreateResponse extends S.Class<RealtimeTranscriptionSessionCreateResponse>(
 ...
 */
export class ConversationParam2 extends S.Class<ConversationParam2>(
  "ConversationParam2"
)({
  /**
   * The unique ID of the conversation.
...
export class ModelIdsResponses extends S.Union(
  ModelIdsShared,
  ModelIdsResponsesEnum
) {}
 ...
 * - [Structured Outputs](https://platform.openai.com/docs/guides/structured-outputs)
 */
export class ResponseTextParam extends S.Class<ResponseTextParam>(
  "ResponseTextParam"
)({
 ...
 * Constrains the tools available to the model to a pre-defined set.
 */
export class ToolChoiceAllowed extends S.Class<ToolChoiceAllowed>(
  "ToolChoiceAllowed"
)({
  /**
   * Allowed tool configuration type. Always `allowed_tools`.
 ...
 */
export class ToolChoiceTypes extends S.Class<ToolChoiceTypes>(
  "ToolChoiceTypes"
)({
  /**
   * The type of hosted tool the model should to use. Learn more about
 ...
 */
export class ToolChoiceCustom extends S.Class<ToolChoiceCustom>(
  "ToolChoiceCustom"
)({
  /**
   * For custom tool calling, the type is always `custom`.
 ...
 */
export class SpecificApplyPatchParam extends S.Class<SpecificApplyPatchParam>(
  "SpecificApplyPatchParam"
)({
  /**
   * The tool to call. Always `apply_patch`.
   */
  type: SpecificApplyPatchParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "apply_patch" as const)
  )
}) {}
 ...
 */
export class SpecificFunctionShellParam extends S.Class<SpecificFunctionShellParam>(
  "SpecificFunctionShellParam"
)({
  /**
   * The tool to call. Always `shell`.
   */
  type: SpecificFunctionShellParamType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "shell" as const)
  )
}) {}
 ...
 */
export class CreateResponseTruncationEnum extends S.Literal(
  "auto",
  "disabled"
) {}
 ...
 * The retention policy for the prompt cache. Set to `24h` to enable extended prompt caching, which keeps cached prefixes active for longer, up to a maximum of 24 hours. [Learn more](https://platform.openai.com/docs/guides/prompt-caching#prompt-cache-retention).
 */
export class CreateResponsePromptCacheRetentionEnum extends S.Literal(
  "in-memory",
  "24h"
) {}
...
export class CreateResponse extends S.Class<CreateResponse>("CreateResponse")({
  ...
  prompt_cache_retention: S.optionalWith(
    CreateResponsePromptCacheRetentionEnum,
    { nullable: true }
  )
}) {}
 ...
 */
export class ResponseStatus extends S.Literal(
  "completed",
  "failed",
  "in_progress",
  "cancelled",
 ...
 */
export class ResponseIncompleteDetailsEnumReason extends S.Literal(
  "max_output_tokens",
  "content_filter"
) {}
 ...
 * The retention policy for the prompt cache. Set to `24h` to enable extended prompt caching, which keeps cached prefixes active for longer, up to a maximum of 24 hours. [Learn more](https://platform.openai.com/docs/guides/prompt-caching#prompt-cache-retention).
 */
export class ResponsePromptCacheRetentionEnum extends S.Literal(
  "in-memory",
  "24h"
) {}
...
export class Response extends S.Class<Response>("Response")({
  ...
  incomplete_details: S.NullOr(
    S.Struct({
      /**
       * The reason why the response is incomplete.
       */
      reason: S.optionalWith(S.Literal("max_output_tokens", "content_filter"), {
        nullable: true
      })
    })
  ),
   ...
   */
  parallel_tool_calls: S.Boolean.pipe(
    S.propertySignature,
  ...
  prompt_cache_retention: S.optionalWith(ResponsePromptCacheRetentionEnum, {
    nullable: true
  })
}) {}
 ...
 * The role of the message input. One of `user`, `system`, or `developer`.
 */
export class InputMessageResourceRole extends S.Literal(
  "user",
  "system",
  "developer"
) {}
 ...
 * `incomplete`. Populated when items are returned via API.
 */
export class InputMessageResourceStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
 ...
 * precedence over instructions given with the `user` role.
 */
export class InputMessageResource extends S.Class<InputMessageResource>(
 ...
 */
export class ResponseItemList extends S.Class<ResponseItemList>(
  "ResponseItemList"
)({
  /**
   * The type of object returned, must be `list`.
 ...
 * Always `image_file`.
 */
export class MessageContentImageFileObjectType extends S.Literal(
  "image_file"
) {}
 ...
 */
export class MessageContentImageFileObjectImageFileDetail extends S.Literal(
  "auto",
  "low",
  "high"
) {}
 ...
 */
export class MessageContentImageFileObject extends S.Class<MessageContentImageFileObject>(
 ...
 */
export class MessageContentImageUrlObjectImageUrlDetail extends S.Literal(
  "auto",
  "low",
  "high"
) {}
 ...
 */
export class MessageContentImageUrlObject extends S.Class<MessageContentImageUrlObject>(
 ...
 */
export class MessageRequestContentTextObject extends S.Class<MessageRequestContentTextObject>(
 ...
 * The type of tool being defined: `file_search`
 */
export class AssistantToolsFileSearchTypeOnlyType extends S.Literal(
  "file_search"
) {}

export class AssistantToolsFileSearchTypeOnly extends S.Class<AssistantToolsFileSearchTypeOnly>(
...
export class CreateMessageRequest extends S.Class<CreateMessageRequest>(
  ...
  attachments: S.optionalWith(
    S.Array(
      S.Struct({
        ...
        tools: S.optionalWith(
          S.Array(
            S.Union(AssistantToolsCode, AssistantToolsFileSearchTypeOnly)
          ),
          {
            nullable: true
          }
 ...
 */
export class CreateThreadAndRunRequestTruncationStrategyEnumType extends S.Literal(
  "auto",
  "last_messages"
) {}
...
export class CreateThreadAndRunRequestTruncationStrategy extends S.Struct({
  ...
  last_messages: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(1)), {
    nullable: true
  })
}) {}
 ...
 */
export class CreateThreadAndRunRequestToolChoiceEnum extends S.Literal(
  "none",
  "auto",
  "required"
) {}
 ...
 */
export class AssistantsNamedToolChoiceType extends S.Literal(
  "function",
  "code_interpreter",
  "file_search"
) {}
 ...
 */
export class AssistantsNamedToolChoice extends S.Class<AssistantsNamedToolChoice>(
...
export class CreateThreadAndRunRequest extends S.Class<CreateThreadAndRunRequest>(
   ...
   */
  model: S.optionalWith(S.Union(S.String, CreateThreadAndRunRequestModelEnum), {
    nullable: true
  }),
  /**
   ...
   */
  tools: S.optionalWith(S.Array(AssistantTool).pipe(S.maxItems(20)), {
    nullable: true
  }),
  /**
   ...
   */
  max_prompt_tokens: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(256)), {
    nullable: true
  }),
  /**
   * The maximum number of completion tokens that may be used over the course of the run. The run will make a best effort to use only the number of completion tokens specified, across multiple turns of the run. If the run exceeds the number of completion tokens specified, the run will end with status `incomplete`. See `incomplete_details` for more info.
   */
  max_completion_tokens: S.optionalWith(
    S.Int.pipe(S.greaterThanOrEqualTo(256)),
    { nullable: true }
  ),
  ...
  tool_choice: S.optionalWith(CreateThreadAndRunRequestToolChoice, {
    nullable: true
  }),
  parallel_tool_calls: S.optionalWith(ParallelToolCalls, {
    nullable: true,
 ...
 */
export class RunObjectRequiredActionType extends S.Literal(
  "submit_tool_outputs"
) {}
 ...
 * Tool call objects
 */
export class RunToolCallObject extends S.Class<RunToolCallObject>(
  "RunToolCallObject"
)({
  /**
 ...
 */
export class RunObjectLastErrorCode extends S.Literal(
  "server_error",
  "rate_limit_exceeded",
  "invalid_prompt"
) {}
 ...
 */
export class RunObjectIncompleteDetailsReason extends S.Literal(
 ...
 * The truncation strategy to use for the thread. The default is `auto`. If set to `last_messages`, the thread will be truncated to the n most recent messages in the thread. When set to `auto`, messages in the middle of the thread will be dropped to fit the context length of the model, `max_prompt_tokens`.
 */
export class RunObjectTruncationStrategyEnumType extends S.Literal(
  "auto",
  "last_messages"
) {}
 ...
 * `none` means the model will not call any tools and instead generates a message. `auto` means the model can pick between generating a message or calling one or more tools. `required` means the model must call one or more tools before responding to the user.
 */
export class RunObjectToolChoiceEnum extends S.Literal(
  "none",
  "auto",
  "required"
) {}
...
export class RunObject extends S.Class<RunObject>("RunObject")({
  ...
  incomplete_details: S.NullOr(
    S.Struct({
       ...
       * The reason why the run is incomplete. This will point to which specific token limit was reached over the course of the run.
       */
      reason: S.optionalWith(RunObjectIncompleteDetailsReason, {
        nullable: true
      })
    })
  ),
  ...
  parallel_tool_calls: ParallelToolCalls.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => true as const)
  ),
...
export class ModifyThreadRequest extends S.Class<ModifyThreadRequest>(
  "ModifyThreadRequest"
)({
  tool_resources: S.optionalWith(
    S.Struct({
...
export class DeleteThreadResponse extends S.Class<DeleteThreadResponse>(
...
export class ListMessagesParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListMessagesParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true }),
 ...
 */
export class MessageObjectStatus extends S.Literal(
  "in_progress",
  "incomplete",
  "completed"
) {}
 ...
 */
export class MessageObjectIncompleteDetailsEnumReason extends S.Literal(
  "content_filter",
  "max_tokens",
  "run_cancelled",
  "run_expired",
 ...
 */
export class MessageContentTextAnnotationsFileCitationObjectType extends S.Literal(
  "file_citation"
) {}
 ...
 */
export class MessageContentTextAnnotationsFileCitationObject extends S.Class<MessageContentTextAnnotationsFileCitationObject>(
 ...
 * Always `file_path`.
 */
export class MessageContentTextAnnotationsFilePathObjectType extends S.Literal(
  "file_path"
) {}
 ...
 */
export class MessageContentTextAnnotationsFilePathObject extends S.Class<MessageContentTextAnnotationsFilePathObject>(
...
export class TextAnnotation extends S.Union(
  MessageContentTextAnnotationsFileCitationObject,
  MessageContentTextAnnotationsFilePathObject
) {}
 ...
 * The text content that is part of a message.
 */
export class MessageContentTextObject extends S.Class<MessageContentTextObject>(
 ...
 */
export class MessageContentRefusalObject extends S.Class<MessageContentRefusalObject>(
...
export class ModifyMessageRequest extends S.Class<ModifyMessageRequest>(
...
export class DeleteMessageResponseObject extends S.Literal(
...
export class ListRunsParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListRunsParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true }),
...
export class CreateRunParams extends S.Struct({
  "include[]": S.optionalWith(
    S.Array(
      S.Literal("step_details.tool_calls[*].file_search.results[*].content")
    ),
    {
      nullable: true
    }
 ...
 * The truncation strategy to use for the thread. The default is `auto`. If set to `last_messages`, the thread will be truncated to the n most recent messages in the thread. When set to `auto`, messages in the middle of the thread will be dropped to fit the context length of the model, `max_prompt_tokens`.
 */
export class CreateRunRequestTruncationStrategyEnumType extends S.Literal(
  "auto",
  "last_messages"
) {}
 ...
 * `none` means the model will not call any tools and instead generates a message. `auto` means the model can pick between generating a message or calling one or more tools. `required` means the model must call one or more tools before responding to the user.
 */
export class CreateRunRequestToolChoiceEnum extends S.Literal(
  "none",
  "auto",
  "required"
) {}
...
export class CreateRunRequest extends S.Class<CreateRunRequest>(
  "CreateRunRequest"
)({
  /**
   * The ID of the [assistant](https://platform.openai.com/docs/api-reference/assistants) to use to execute this run.
   ...
   */
  additional_messages: S.optionalWith(S.Array(CreateMessageRequest), {
    nullable: true
  }),
  /**
   * Override the tools the assistant can use for this run. This is useful for modifying the behavior on a per-run basis.
  ...
  truncation_strategy: S.optionalWith(CreateRunRequestTruncationStrategy, {
    nullable: true
  }),
...
export class ModifyRunRequest extends S.Class<ModifyRunRequest>(
  "ModifyRunRequest"
)({
  metadata: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
...
export class ListRunStepsParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListRunStepsParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true }),
 ...
 */
export class RunStepObjectType extends S.Literal(
  "message_creation",
  "tool_calls"
) {}
 ...
 */
export class RunStepObjectStatus extends S.Literal(
  "in_progress",
  "cancelled",
  "failed",
  "completed",
 ...
 */
export class RunStepDetailsMessageCreationObjectType extends S.Literal(
  "message_creation"
) {}
 ...
 */
export class RunStepDetailsMessageCreationObject extends S.Class<RunStepDetailsMessageCreationObject>(
 ...
 * Always `tool_calls`.
 */
export class RunStepDetailsToolCallsObjectType extends S.Literal(
  "tool_calls"
) {}
 ...
 */
export class RunStepDetailsToolCallsCodeObjectType extends S.Literal(
  "code_interpreter"
) {}
 ...
 * Always `logs`.
 */
export class RunStepDetailsToolCallsCodeOutputLogsObjectType extends S.Literal(
  "logs"
) {}
 ...
 */
export class RunStepDetailsToolCallsCodeOutputLogsObject extends S.Class<RunStepDetailsToolCallsCodeOutputLogsObject>(
 ...
 * Always `image`.
 */
export class RunStepDetailsToolCallsCodeOutputImageObjectType extends S.Literal(
  "image"
) {}

export class RunStepDetailsToolCallsCodeOutputImageObject extends S.Class<RunStepDetailsToolCallsCodeOutputImageObject>(
 ...
 */
export class RunStepDetailsToolCallsCodeObject extends S.Class<RunStepDetailsToolCallsCodeObject>(
 ...
 */
export class RunStepDetailsToolCallsFileSearchObjectType extends S.Literal(
  "file_search"
) {}
 ...
 */
export class RunStepDetailsToolCallsFileSearchRankingOptionsObject extends S.Class<RunStepDetailsToolCallsFileSearchRankingOptionsObject>(
 ...
 */
export class RunStepDetailsToolCallsFileSearchResultObject extends S.Class<RunStepDetailsToolCallsFileSearchResultObject>(
...
export class RunStepDetailsToolCallsFileSearchObject extends S.Class<RunStepDetailsToolCallsFileSearchObject>(
  ...
  file_search: S.Struct({
     ...
     */
    results: S.optionalWith(
      S.Array(RunStepDetailsToolCallsFileSearchResultObject),
      { nullable: true }
    )
  })
}) {}
 ...
 */
export class RunStepDetailsToolCallsFunctionObjectType extends S.Literal(
  "function"
) {}

export class RunStepDetailsToolCallsFunctionObject extends S.Class<RunStepDetailsToolCallsFunctionObject>(
 ...
 */
export class RunStepDetailsToolCallsObject extends S.Class<RunStepDetailsToolCallsObject>(
 ...
 */
export class RunStepObjectLastErrorEnumCode extends S.Literal(
  "server_error",
  "rate_limit_exceeded"
) {}
...
export class ListRunStepsResponse extends S.Class<ListRunStepsResponse>(
...
export class SubmitToolOutputsRunRequest extends S.Class<SubmitToolOutputsRunRequest>(
  "SubmitToolOutputsRunRequest"
)({
  /**
   * A list of tools for which the outputs are being submitted.
   */
  tool_outputs: S.Array(
    S.Struct({
      /**
 ...
 */
export class CreateUploadRequestPurpose extends S.Literal(
  "assistants",
  "batch",
  "fine-tune",
  "vision"
 ...
 */
export class UploadStatus extends S.Literal(
  "pending",
  "completed",
  "cancelled",
  "expired"
 ...
 * Deprecated. The current status of the file, which can be either `uploaded`, `processed`, or `error`.
 */
export class UploadFileEnumStatus extends S.Literal(
  "uploaded",
  "processed",
  "error"
) {}
...
export class CompleteUploadRequest extends S.Class<CompleteUploadRequest>(
...
export class AddUploadPartRequest extends S.Class<AddUploadPartRequest>(
...
export class ListVectorStoresParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListVectorStoresParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true }),
 ...
 */
export class VectorStoreObjectStatus extends S.Literal(
  "expired",
  "in_progress",
  "completed"
) {}
 ...
 */
export class VectorStoreExpirationAfterAnchor extends S.Literal(
  "last_active_at"
) {}
 ...
 */
export class VectorStoreExpirationAfter extends S.Class<VectorStoreExpirationAfter>(
 ...
 */
export class VectorStoreObject extends S.Class<VectorStoreObject>(
  "VectorStoreObject"
)({
  /**
   * The identifier, which can be referenced in API endpoints.
...
export class ListVectorStoresResponse extends S.Class<ListVectorStoresResponse>(
 ...
 */
export class AutoChunkingStrategyRequestParam extends S.Class<AutoChunkingStrategyRequestParam>(
 ...
 * Always `static`.
 */
export class StaticChunkingStrategyRequestParamType extends S.Literal(
  "static"
) {}

export class StaticChunkingStrategy extends S.Class<StaticChunkingStrategy>(
  "StaticChunkingStrategy"
)({
  /**
   * The maximum number of tokens in each chunk. The default value is `800`. The minimum value is `100` and the maximum value is `4096`.
   */
  max_chunk_size_tokens: S.Int.pipe(
    S.greaterThanOrEqualTo(100),
    S.lessThanOrEqualTo(4096)
  ),
  /**
 ...
 */
export class StaticChunkingStrategyRequestParam extends S.Class<StaticChunkingStrategyRequestParam>(
 ...
 */
export class ChunkingStrategyRequestParam extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}

export class CreateVectorStoreRequest extends S.Class<CreateVectorStoreRequest>(
  "CreateVectorStoreRequest"
)({
  /**
   * A list of [File](https://platform.openai.com/docs/api-reference/files) IDs that the vector store should use. Useful for tools like `file_search` that can access files.
   */
  file_ids: S.optionalWith(S.Array(S.String).pipe(S.maxItems(500)), {
    nullable: true
  }),
  /**
   * The name of the vector store.
  ...
  description: S.optionalWith(S.String, { nullable: true }),
  expires_after: S.optionalWith(VectorStoreExpirationAfter, { nullable: true }),
  chunking_strategy: S.optionalWith(ChunkingStrategyRequestParam, {
    nullable: true
  }),
  metadata: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
 ...
 * Anchor timestamp after which the expiration policy applies. Supported anchors: `last_active_at`.
 */
export class UpdateVectorStoreRequestExpiresAfterEnumAnchor extends S.Literal(
  "last_active_at"
) {}
...
export class UpdateVectorStoreRequest extends S.Class<UpdateVectorStoreRequest>(
   ...
   */
  name: S.optionalWith(S.String, { nullable: true }),
  expires_after: S.optionalWith(UpdateVectorStoreRequestExpiresAfter, {
    nullable: true
  }),
  metadata: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
...
export class DeleteVectorStoreResponseObject extends S.Literal(
  "vector_store.deleted"
) {}

export class DeleteVectorStoreResponse extends S.Class<DeleteVectorStoreResponse>(
...
export class CreateVectorStoreFileRequest extends S.Class<CreateVectorStoreFileRequest>(
...
export class CreateVectorStoreFileBatchRequest extends S.Class<CreateVectorStoreFileBatchRequest>(
   ...
   */
  file_ids: S.optionalWith(
    S.NonEmptyArray(S.String).pipe(S.minItems(1), S.maxItems(500)),
    { nullable: true }
  ),
  /**
   ...
   */
  files: S.optionalWith(
    S.NonEmptyArray(CreateVectorStoreFileRequest).pipe(
      S.minItems(1),
      S.maxItems(500)
    ),
    {
 ...
 */
export class VectorStoreFileBatchObjectObject extends S.Literal(
 ...
 */
export class VectorStoreFileBatchObjectStatus extends S.Literal(
  "in_progress",
  "completed",
  "cancelled",
  "failed"
 ...
 */
export class VectorStoreFileBatchObject extends S.Class<VectorStoreFileBatchObject>(
...
export class ListFilesInVectorStoreBatchParamsOrder extends S.Literal(
  "asc",
  "desc"
) {}

export class ListFilesInVectorStoreBatchParamsFilter extends S.Literal(
  "in_progress",
  "completed",
  "failed",
  "cancelled"
...
export class ListFilesInVectorStoreBatchParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListFilesInVectorStoreBatchParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true }),
  before: S.optionalWith(S.String, { nullable: true }),
  filter: S.optionalWith(ListFilesInVectorStoreBatchParamsFilter, {
    nullable: true
  })
}) {}
 ...
 */
export class VectorStoreFileObjectObject extends S.Literal(
  "vector_store.file"
) {}
 ...
 */
export class VectorStoreFileObjectStatus extends S.Literal(
  "in_progress",
  "completed",
  "cancelled",
  "failed"
 ...
 */
export class VectorStoreFileObjectLastErrorEnumCode extends S.Literal(
  "server_error",
  "unsupported_file",
  "invalid_file"
) {}
 ...
 * Always `static`.
 */
export class StaticChunkingStrategyResponseParamType extends S.Literal(
  "static"
) {}

export class StaticChunkingStrategyResponseParam extends S.Class<StaticChunkingStrategyResponseParam>(
 ...
 * Always `other`.
 */
export class OtherChunkingStrategyResponseParamType extends S.Literal(
  "other"
) {}
 ...
 */
export class OtherChunkingStrategyResponseParam extends S.Class<OtherChunkingStrategyResponseParam>(
 ...
 */
export class ChunkingStrategyResponse extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class VectorStoreFileObject extends S.Class<VectorStoreFileObject>(
  ...
  chunking_strategy: S.optionalWith(ChunkingStrategyResponse, {
    nullable: true
  }),
  attributes: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
...
export class ListVectorStoreFilesResponse extends S.Class<ListVectorStoreFilesResponse>(
...
export class ListVectorStoreFilesParamsFilter extends S.Literal(
  "in_progress",
  "completed",
  "failed",
  "cancelled"
...
export class ListVectorStoreFilesParams extends S.Struct({
  limit: S.optionalWith(S.Int, { nullable: true, default: () => 20 as const }),
  order: S.optionalWith(ListVectorStoreFilesParamsOrder, {
    nullable: true,
    default: () => "desc" as const
  }),
  after: S.optionalWith(S.String, { nullable: true }),
...
export class UpdateVectorStoreFileAttributesRequest extends S.Class<UpdateVectorStoreFileAttributesRequest>(
  "UpdateVectorStoreFileAttributesRequest"
)({
  attributes: S.NullOr(S.Record({ key: S.String, value: S.Unknown }))
}) {}

export class DeleteVectorStoreFileResponseObject extends S.Literal(
  "vector_store.file.deleted"
) {}

export class DeleteVectorStoreFileResponse extends S.Class<DeleteVectorStoreFileResponse>(
 ...
 */
export class VectorStoreFileContentResponseObject extends S.Literal(
 ...
 */
export class VectorStoreFileContentResponse extends S.Class<VectorStoreFileContentResponse>(
 ...
 */
export class VectorStoreSearchRequestRankingOptionsRanker extends S.Literal(
  "none",
  "auto",
  "default-2024-11-15"
) {}

export class VectorStoreSearchRequest extends S.Class<VectorStoreSearchRequest>(
   ...
   */
  rewrite_query: S.optionalWith(S.Boolean, {
    nullable: true,
    default: () => false as const
  }),
  /**
   ...
   */
  filters: S.optionalWith(S.Union(ComparisonFilter, CompoundFilter), {
    nullable: true
  }),
  /**
   * Ranking options for search.
  ...
  ranking_options: S.optionalWith(
    S.Struct({
      ...
      score_threshold: S.optionalWith(
        S.Number.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(1)),
        {
          nullable: true,
          default: () => 0 as const
 ...
 */
export class VectorStoreSearchResultsPageObject extends S.Literal(
 ...
 * The type of content.
 */
export class VectorStoreSearchResultContentObjectType extends S.Literal(
  "text"
) {}

export class VectorStoreSearchResultContentObject extends S.Class<VectorStoreSearchResultContentObject>(
...
export class VectorStoreSearchResultItem extends S.Class<VectorStoreSearchResultItem>(
...
export class VectorStoreSearchResultsPage extends S.Class<VectorStoreSearchResultsPage>(
...
export class CreateConversationBody extends S.Class<CreateConversationBody>(
  "CreateConversationBody"
)({
  metadata: S.optionalWith(Metadata, { nullable: true }),
  items: S.optionalWith(S.Array(InputItem).pipe(S.maxItems(20)), {
    nullable: true
  })
}) {}

export class UpdateConversationBody extends S.Class<UpdateConversationBody>(
...
export class DeletedConversationResourceObject extends S.Literal(
  "conversation.deleted"
) {}

export class DeletedConversationResource extends S.Class<DeletedConversationResource>(
...
export class VideoStatus extends S.Literal(
  "queued",
  "in_progress",
  "completed",
  "failed"
...
export class VideoSize extends S.Literal(
  "720x1280",
  "1280x720",
  "1024x1792",
  "1792x1024"
...
export class VideoResource extends S.Class<VideoResource>("VideoResource")({
   ...
   * The object type, which is always `video`.
   */
  object: VideoResourceObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "video" as const)
  ),
  /**
...
export class VideoListResource extends S.Class<VideoListResource>(
  "VideoListResource"
)({
  /**
   * The type of object returned, must be `list`.
   */
  object: S.Literal("list").pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "list" as const)
  ),
  /**
 ...
 */
export class CreateVideoBody extends S.Class<CreateVideoBody>(
  "CreateVideoBody"
)({
  /**
   ...
   */
  input_reference: S.optionalWith(S.instanceOf(globalThis.Blob), {
    nullable: true
  }),
  /**
 ...
 */
export class DeletedVideoResource extends S.Class<DeletedVideoResource>(
...
export class VideoContentVariant extends S.Literal(
  "video",
  "thumbnail",
  "spritesheet"
) {}
 ...
 */
export class CreateVideoRemixBody extends S.Class<CreateVideoRemixBody>(
...
export class TokenCountsBody extends S.Class<TokenCountsBody>(
  "TokenCountsBody"
)({
  model: S.optionalWith(S.String, { nullable: true }),
  input: S.optionalWith(
...
export class TokenCountsResourceObject extends S.Literal(
  "response.input_tokens"
) {}

export class TokenCountsResource extends S.Class<TokenCountsResource>(
  "TokenCountsResource"
)({
 ...
 */
export class ChatkitWorkflowTracing extends S.Class<ChatkitWorkflowTracing>(
 ...
 */
export class ChatkitWorkflow extends S.Class<ChatkitWorkflow>(
  "ChatkitWorkflow"
)({
  /**
 ...
 */
export class ChatSessionRateLimits extends S.Class<ChatSessionRateLimits>(
...
export class ChatSessionStatus extends S.Literal(
  "active",
  "expired",
  "cancelled"
) {}
 ...
 */
export class ChatSessionAutomaticThreadTitling extends S.Class<ChatSessionAutomaticThreadTitling>(
 ...
 */
export class ChatSessionFileUpload extends S.Class<ChatSessionFileUpload>(
 ...
 */
export class ChatSessionHistory extends S.Class<ChatSessionHistory>(
  "ChatSessionHistory"
)({
  /**
 ...
 */
export class ChatSessionChatkitConfiguration extends S.Class<ChatSessionChatkitConfiguration>(
 ...
 */
export class ChatSessionResource extends S.Class<ChatSessionResource>(
  "ChatSessionResource"
)({
  /**
 ...
 * Controls diagnostic tracing during the session.
 */
export class WorkflowTracingParam extends S.Class<WorkflowTracingParam>(
...
export class WorkflowParam extends S.Class<WorkflowParam>("WorkflowParam")({
   ...
   */
  state_variables: S.optionalWith(
    S.Record({ key: S.String, value: S.Unknown }),
    { nullable: true }
  ),
  /**
 ...
 */
export class ExpiresAfterParam extends S.Class<ExpiresAfterParam>(
  "ExpiresAfterParam"
)({
  /**
   * Base timestamp used to calculate expiration. Currently fixed to `created_at`.
   */
  anchor: ExpiresAfterParamAnchor.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "created_at" as const)
  ),
  /**
 ...
 */
export class RateLimitsParam extends S.Class<RateLimitsParam>(
  "RateLimitsParam"
)({
  /**
   * Maximum number of requests allowed per minute for the session. Defaults to 10.
   */
  max_requests_per_1_minute: S.optionalWith(
    S.Int.pipe(S.greaterThanOrEqualTo(1)),
    { nullable: true }
  )
}) {}
 ...
 */
export class AutomaticThreadTitlingParam extends S.Class<AutomaticThreadTitlingParam>(
 ...
 */
export class FileUploadParam extends S.Class<FileUploadParam>(
  "FileUploadParam"
)({
  /**
   ...
   */
  max_file_size: S.optionalWith(
    S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(512)),
    { nullable: true }
  ),
  /**
   * Maximum number of files that can be uploaded to the session. Defaults to 10.
   */
  max_files: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(1)), {
    nullable: true
  })
}) {}
...
export class HistoryParam extends S.Class<HistoryParam>("HistoryParam")({
   ...
   */
  recent_threads: S.optionalWith(S.Int.pipe(S.greaterThanOrEqualTo(1)), {
    nullable: true
  })
}) {}
 ...
 */
export class ChatkitConfigurationParam extends S.Class<ChatkitConfigurationParam>(
  "ChatkitConfigurationParam"
)({
  /**
   * Configuration for automatic thread titling. When omitted, automatic thread titling is enabled by default.
   */
  automatic_thread_titling: S.optionalWith(AutomaticThreadTitlingParam, {
    nullable: true
  }),
  /**
 ...
 */
export class CreateChatSessionBody extends S.Class<CreateChatSessionBody>(
   ...
   */
  chatkit_configuration: S.optionalWith(ChatkitConfigurationParam, {
    nullable: true
  })
}) {}
 ...
 */
export class UserMessageInputText extends S.Class<UserMessageInputText>(
  "UserMessageInputText"
)({
  /**
   * Type discriminator that is always `input_text`.
   */
  type: UserMessageInputTextType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "input_text" as const)
  ),
  /**
 ...
 */
export class UserMessageQuotedText extends S.Class<UserMessageQuotedText>(
  "UserMessageQuotedText"
)({
  /**
   * Type discriminator that is always `quoted_text`.
   */
  type: UserMessageQuotedTextType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "quoted_text" as const)
  ),
  /**
   * Quoted text content.
   */
 ...
 */
export class InferenceOptions extends S.Class<InferenceOptions>(
  "InferenceOptions"
)({
 ...
 */
export class UserMessageItem extends S.Class<UserMessageItem>(
  "UserMessageItem"
)({
  /**
 ...
 * Type discriminator that is always `chatkit.thread_item`.
 */
export class AssistantMessageItemObject extends S.Literal(
  "chatkit.thread_item"
) {}
 ...
 */
export class AssistantMessageItemType extends S.Literal(
 ...
 */
export class FileAnnotationSource extends S.Class<FileAnnotationSource>(
  "FileAnnotationSource"
)({
  /**
   * Type discriminator that is always `file`.
   */
  type: FileAnnotationSourceType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "file" as const)
  ),
  /**
 ...
 */
export class UrlAnnotationSource extends S.Class<UrlAnnotationSource>(
  "UrlAnnotationSource"
)({
  /**
   * Type discriminator that is always `url`.
   */
  type: UrlAnnotationSourceType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "url" as const)
  ),
  /**
 ...
 */
export class ResponseOutputText extends S.Class<ResponseOutputText>(
  "ResponseOutputText"
)({
  /**
   * Type discriminator that is always `output_text`.
   */
  type: ResponseOutputTextType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "output_text" as const)
  ),
  /**
 ...
 */
export class AssistantMessageItem extends S.Class<AssistantMessageItem>(
 ...
 */
export class WidgetMessageItem extends S.Class<WidgetMessageItem>(
  "WidgetMessageItem"
)({
  /**
   * Identifier of the thread item.
   ...
   * Type discriminator that is always `chatkit.widget`.
   */
  type: WidgetMessageItemType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "chatkit.widget" as const)
  ),
  /**
 ...
 * Type discriminator that is always `chatkit.thread_item`.
 */
export class ClientToolCallItemObject extends S.Literal(
  "chatkit.thread_item"
) {}
 ...
 */
export class ClientToolCallItemType extends S.Literal(
  "chatkit.client_tool_call"
) {}

export class ClientToolCallStatus extends S.Literal(
  "in_progress",
  "completed"
) {}
 ...
 */
export class ClientToolCallItem extends S.Class<ClientToolCallItem>(
  "ClientToolCallItem"
)({
  /**
   * Identifier of the thread item.
...
export class TaskItem extends S.Class<TaskItem>("TaskItem")({
   ...
   * Type discriminator that is always `chatkit.task`.
   */
  type: TaskItemType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "chatkit.task" as const)
  ),
  /**
...
export class TaskGroupItem extends S.Class<TaskGroupItem>("TaskGroupItem")({
   ...
   * Type discriminator that is always `chatkit.task_group`.
   */
  type: TaskGroupItemType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "chatkit.task_group" as const)
  ),
  /**
...
export class ThreadItem extends S.Union(
  UserMessageItem,
  AssistantMessageItem,
  WidgetMessageItem,
  ClientToolCallItem,
 ...
 */
export class ThreadItemListResource extends S.Class<ThreadItemListResource>(
...
export class ActiveStatus extends S.Class<ActiveStatus>("ActiveStatus")({
   ...
   * Status discriminator that is always `active`.
   */
  type: ActiveStatusType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "active" as const)
  )
}) {}
...
export class LockedStatus extends S.Class<LockedStatus>("LockedStatus")({
   ...
   * Status discriminator that is always `locked`.
   */
  type: LockedStatusType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "locked" as const)
  ),
...
export class ClosedStatus extends S.Class<ClosedStatus>("ClosedStatus")({
   ...
   * Status discriminator that is always `closed`.
   */
  type: ClosedStatusType.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "closed" as const)
  ),
  reason: S.NullOr(S.String)
}) {}
...
export class ThreadResource extends S.Class<ThreadResource>("ThreadResource")({
   ...
   * Type discriminator that is always `chatkit.thread`.
   */
  object: ThreadResourceObject.pipe(
    S.propertySignature,
    S.withConstructorDefault(() => "chatkit.thread" as const)
  ),
  /**
 ...
 */
export class DeletedThreadResourceObject extends S.Literal(
 ...
 */
export class DeletedThreadResource extends S.Class<DeletedThreadResource>(
...
export class ListThreadsMethodParams extends S.Struct({
   ...
   */
  user: S.optionalWith(S.String.pipe(S.minLength(1), S.maxLength(512)), {
    nullable: true
  })
}) {}
 ...
 */
export class ThreadListResource extends S.Class<ThreadListResource>(
  "ThreadListResource"
)({
  /**
   * The type of object returned, must be `list`.
...
export const make = (
  ...
  return {
    ...
    resumeFineTuningJob: (fineTuningJobId) =>
      HttpClientRequest.post(
        `/fine_tuning/jobs/${fineTuningJobId}/resume`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(FineTuningJob),
    ...
    unassignGroupRole: (groupId, roleId) =>
      HttpClientRequest.del(
        `/organization/groups/${groupId}/roles/${roleId}`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
    ...
    removeGroupUser: (groupId, userId) =>
      HttpClientRequest.del(
        `/organization/groups/${groupId}/users/${userId}`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
    ...
    removeProjectGroup: (projectId, groupId) =>
      HttpClientRequest.del(
        `/organization/projects/${projectId}/groups/${groupId}`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
    ...
    unassignUserRole: (userId, roleId) =>
      HttpClientRequest.del(
        `/organization/users/${userId}/roles/${roleId}`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(DeletedRoleAssignmentResource),
    ...
    listProjectGroupRoleAssignments: (projectId, groupId, options) =>
      HttpClientRequest.get(
        `/projects/${projectId}/groups/${groupId}/roles`
      ).pipe(
        HttpClientRequest.setUrlParams({
          limit: options?.["limit"] as any,
          after: options?.["after"] as any,
...
export interface Client {
  ...
  readonly listAssistants: (
    ...
    typeof ListAssistantsResponse.Type,
  ...
  readonly deleteAssistant: (
    ...
    typeof DeleteAssistantResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createTranscription: (
    ...
    typeof CreateTranscription200.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createTranslation: (
    ...
    typeof CreateTranslation200.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listBatches: (
    ...
    typeof ListBatchesResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listChatCompletions: (
    ...
    typeof ChatCompletionList.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteChatCompletion: (
    ...
    typeof ChatCompletionDeleted.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly getChatCompletionMessages: (
    ...
    typeof ChatCompletionMessageList.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createCompletion: (
    ...
    typeof CreateCompletionResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * List Containers
  ...
  readonly ListContainers: (
    ...
    typeof ContainerListResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Create Container
  ...
  readonly ListContainerFiles: (
    ...
    typeof ContainerFileListResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly CreateContainerFile: (
    ...
    typeof ContainerFileResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listConversationItems: (
    ...
    typeof ConversationItemList.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteConversationItem: (
    ...
    typeof ConversationResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteEval: (
    ...
    | ParseError
    | ClientError<"Error", typeof Error.Type>
  >
  /**
  ...
  readonly getEvalRunOutputItems: (
    ...
    typeof EvalRunOutputItemList.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteFile: (
    ...
    typeof DeleteFileResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly validateGrader: (
    ...
    typeof ValidateGraderResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listFineTuningCheckpointPermissions: (
    ...
    options?:
      | typeof ListFineTuningCheckpointPermissionsParams.Encoded
      | undefined
  ) => Effect.Effect<
  ...
  readonly listPaginatedFineTuningJobs: (
    ...
    typeof ListPaginatedFineTuningJobsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listFineTuningJobCheckpoints: (
    ...
    typeof ListFineTuningJobCheckpointsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listFineTuningEvents: (
    ...
    typeof ListFineTuningJobEventsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteModel: (
    ...
    typeof DeleteModelResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createModeration: (
    ...
    typeof CreateModerationResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly adminApiKeysDelete: (
    ...
    typeof AdminApiKeysDelete200.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listAuditLogs: (
    ...
    typeof ListAuditLogsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listOrganizationCertificates: (
    ...
    typeof ListCertificatesResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteCertificate: (
    ...
    typeof DeleteCertificateResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly updateGroup: (
    ...
    typeof GroupResourceWithSuccess.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteGroup: (
    ...
    typeof GroupDeletedResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly assignGroupRole: (
    ...
    typeof GroupRoleAssignment.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly unassignGroupRole: (
    ...
    typeof DeletedRoleAssignmentResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly addGroupUser: (
    ...
    typeof GroupUserAssignment.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly removeGroupUser: (
    ...
    typeof GroupUserDeletedResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listInvites: (
    ...
    typeof InviteListResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteInvite: (
    ...
    typeof InviteDeleteResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listProjectApiKeys: (
    ...
    typeof ProjectApiKeyListResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listProjectGroups: (
    ...
    typeof ProjectGroupListResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly removeProjectGroup: (
    ...
    typeof ProjectGroupDeletedResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listProjectRateLimits: (
    ...
    typeof ProjectRateLimitListResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly retrieveProjectServiceAccount: (
    ...
    typeof ProjectServiceAccount.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteProjectServiceAccount: (
    ...
    typeof ProjectServiceAccountDeleteResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listRoles: (
    ...
    typeof PublicRoleListResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteRole: (
    ...
    typeof RoleDeletedResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteUser: (
    ...
    typeof UserDeleteResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly assignUserRole: (
    ...
    typeof UserRoleAssignment.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createRealtimeClientSecret: (
    ...
    typeof RealtimeCreateClientSecretResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createRealtimeSession: (
    ...
    typeof RealtimeSessionCreateResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Create an ephemeral API token for use in client-side applications with the
  ...
  readonly deleteThread: (
    ...
    typeof DeleteThreadResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listMessages: (
    ...
    typeof ListMessagesResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Create a message.
  ...
  readonly deleteMessage: (
    ...
    typeof DeleteMessageResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listRunSteps: (
    ...
    typeof ListRunStepsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listVectorStores: (
    ...
    typeof ListVectorStoresResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteVectorStore: (
    ...
    typeof DeleteVectorStoreResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createVectorStoreFileBatch: (
    ...
    typeof VectorStoreFileBatchObject.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly listFilesInVectorStoreBatch: (
    ...
    typeof ListVectorStoreFilesResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly createVectorStoreFile: (
    ...
    typeof VectorStoreFileObject.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteVectorStoreFile: (
    ...
    typeof DeleteVectorStoreFileResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly retrieveVectorStoreFileContent: (
    ...
    typeof VectorStoreFileContentResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly searchVectorStore: (
    ...
    typeof VectorStoreSearchResultsPage.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly deleteConversation: (
    ...
    typeof DeletedConversationResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * List videos
  ...
  readonly DeleteVideo: (
    ...
    typeof DeletedVideoResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly RetrieveVideoContent: (
    ...
    typeof RetrieveVideoContent200.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly Getinputtokencounts: (
    ...
    typeof TokenCountsResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly CancelChatSessionMethod: (
    ...
    typeof ChatSessionResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListThreadItemsMethod: (
    ...
    typeof ThreadItemListResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly DeleteThreadMethod: (
    ...
    typeof DeletedThreadResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListThreadsMethod: (
    ...
    typeof ThreadListResource.Type,
    HttpClientError.HttpClientError | ParseError
  >
}
