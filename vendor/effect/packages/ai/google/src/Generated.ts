...
export class Operation extends S.Class<Operation>("Operation")({
   ...
   */
  response: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  }),
  /**
...
export class FunctionCall extends S.Class<FunctionCall>("FunctionCall")({
   ...
   */
  args: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  })
}) {}
 ...
 * field.
 */
export class FunctionResponseBlob extends S.Class<FunctionResponseBlob>(
 ...
 * bytes.
 */
export class FunctionResponsePart extends S.Class<FunctionResponsePart>(
 ...
 */
export class FunctionResponseScheduling extends S.Literal(
 ...
 */
export class ExecutableCodeLanguage extends S.Literal(
 ...
 */
export class CodeExecutionResultOutcome extends S.Literal(
  "OUTCOME_UNSPECIFIED",
  "OUTCOME_OK",
  "OUTCOME_FAILED",
 ...
 */
export class CodeExecutionResult extends S.Class<CodeExecutionResult>(
  "CodeExecutionResult"
)({
  /**
   * Required. Outcome of the code execution.
 ...
 */
export class MediaResolution extends S.Class<MediaResolution>(
  "MediaResolution"
)({
...
export class Part extends S.Class<Part>("Part")({
   ...
   */
  partMetadata: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  }),
  /**
...
export class Type extends S.Literal(
  "TYPE_UNSPECIFIED",
  "STRING",
  "NUMBER",
  "INTEGER",
...
export class Schema extends S.Class<Schema>("Schema")({
  ...schemaFields,
  anyOf: S.optionalWith(
    S.Array(S.suspend((): S.Schema<Schema, SchemaEncoded> => Schema)),
    { nullable: true }
  ),
  /**
   * Optional. Schema of the elements of Type.ARRAY.
 ...
 */
export class FunctionDeclarationBehavior extends S.Literal(
  "UNSPECIFIED",
  "BLOCKING",
  "NON_BLOCKING"
) {}
 ...
 */
export class FunctionDeclaration extends S.Class<FunctionDeclaration>(
  "FunctionDeclaration"
)({
  /**
 ...
 */
export class DynamicRetrievalConfigMode extends S.Literal(
  "MODE_UNSPECIFIED",
  "MODE_DYNAMIC"
) {}
 ...
 */
export class DynamicRetrievalConfig extends S.Class<DynamicRetrievalConfig>(
 ...
 */
export class GoogleSearchRetrieval extends S.Class<GoogleSearchRetrieval>(
  "GoogleSearchRetrieval"
)({
  /**
   * Specifies the dynamic retrieval configuration for the given source.
   */
  dynamicRetrievalConfig: S.optionalWith(DynamicRetrievalConfig, {
    nullable: true
  })
}) {}
 ...
 */
export class CodeExecution extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class ComputerUseEnvironment extends S.Literal(
 ...
 * Next ID: 6
 */
export class StreamableHttpTransport extends S.Class<StreamableHttpTransport>(
...
export class McpServer extends S.Class<McpServer>("McpServer")({
   ...
   * A transport that can stream HTTP requests and responses.
   */
  streamableHttpTransport: S.optionalWith(StreamableHttpTransport, {
    nullable: true
  }),
  /**
...
export class Tool extends S.Class<Tool>("Tool")({
   ...
   * turn.
   */
  functionDeclarations: S.optionalWith(S.Array(FunctionDeclaration), {
    nullable: true
  }),
  /**
   * Optional. Retrieval tool that is powered by Google search.
   */
  googleSearchRetrieval: S.optionalWith(GoogleSearchRetrieval, {
    nullable: true
  }),
  /**
 ...
 */
export class FunctionCallingConfigMode extends S.Literal(
  "MODE_UNSPECIFIED",
  "AUTO",
  "ANY",
  "NONE",
 ...
 */
export class FunctionCallingConfig extends S.Class<FunctionCallingConfig>(
 ...
 * Retrieval config.
 */
export class RetrievalConfig extends S.Class<RetrievalConfig>(
  "RetrievalConfig"
)({
  /**
...
export class ToolConfig extends S.Class<ToolConfig>("ToolConfig")({
   ...
   */
  functionCallingConfig: S.optionalWith(FunctionCallingConfig, {
    nullable: true
  }),
  /**
 ...
 */
export class PrebuiltVoiceConfig extends S.Class<PrebuiltVoiceConfig>(
  "PrebuiltVoiceConfig"
)({
  /**
 ...
 */
export class SpeakerVoiceConfig extends S.Class<SpeakerVoiceConfig>(
  "SpeakerVoiceConfig"
)({
  /**
 ...
 */
export class MultiSpeakerVoiceConfig extends S.Class<MultiSpeakerVoiceConfig>(
...
export class SpeechConfig extends S.Class<SpeechConfig>("SpeechConfig")({
   ...
   */
  multiSpeakerVoiceConfig: S.optionalWith(MultiSpeakerVoiceConfig, {
    nullable: true
  }),
  /**
 ...
 */
export class ThinkingConfigThinkingLevel extends S.Literal(
 ...
 */
export class GenerationConfig extends S.Class<GenerationConfig>(
  "GenerationConfig"
)({
  /**
   ...
   */
  responseModalities: S.optionalWith(
    S.Array(S.Literal("MODALITY_UNSPECIFIED", "TEXT", "IMAGE", "AUDIO")),
    {
      nullable: true
    }
  ),
   ...
   * Optional. If specified, the media resolution specified will be used.
   */
  mediaResolution: S.optionalWith(GenerationConfigMediaResolution, {
    nullable: true
  })
}) {}
 ...
 */
export class GenerateContentRequest extends S.Class<GenerateContentRequest>(
 ...
 */
export class SafetyRatingProbability extends S.Literal(
 ...
 */
export class CitationMetadata extends S.Class<CitationMetadata>(
  "CitationMetadata"
)({
  /**
 ...
 */
export class GroundingPassageId extends S.Class<GroundingPassageId>(
  "GroundingPassageId"
)({
  /**
 ...
 */
export class SemanticRetrieverChunk extends S.Class<SemanticRetrieverChunk>(
 ...
 */
export class AttributionSourceId extends S.Class<AttributionSourceId>(
  "AttributionSourceId"
)({
  /**
   ...
   */
  semanticRetrieverChunk: S.optionalWith(SemanticRetrieverChunk, {
    nullable: true
  })
}) {}
 ...
 */
export class GroundingAttribution extends S.Class<GroundingAttribution>(
 ...
 */
export class SearchEntryPoint extends S.Class<SearchEntryPoint>(
  "SearchEntryPoint"
)({
  /**
 ...
 */
export class RetrievedContext extends S.Class<RetrievedContext>(
  "RetrievedContext"
)({
  /**
 ...
 */
export class PlaceAnswerSources extends S.Class<PlaceAnswerSources>(
  "PlaceAnswerSources"
)({
  /**
 ...
 */
export class GoogleAiGenerativelanguageV1BetaSegment extends S.Class<GoogleAiGenerativelanguageV1BetaSegment>(
 ...
 * Grounding support.
 */
export class GoogleAiGenerativelanguageV1BetaGroundingSupport extends S.Class<GoogleAiGenerativelanguageV1BetaGroundingSupport>(
  "GoogleAiGenerativelanguageV1BetaGroundingSupport"
)({
  /**
   * Segment of the content this support belongs to.
   */
  segment: S.optionalWith(GoogleAiGenerativelanguageV1BetaSegment, {
    nullable: true
  }),
  /**
 ...
 */
export class RetrievalMetadata extends S.Class<RetrievalMetadata>(
  "RetrievalMetadata"
)({
  /**
   ...
   */
  googleSearchDynamicRetrievalScore: S.optionalWith(S.Number, {
    nullable: true
  })
}) {}
 ...
 */
export class GroundingMetadata extends S.Class<GroundingMetadata>(
  "GroundingMetadata"
)({
  /**
   ...
   */
  groundingSupports: S.optionalWith(
    S.Array(GoogleAiGenerativelanguageV1BetaGroundingSupport),
    { nullable: true }
  ),
  /**
   * Metadata related to retrieval in the grounding flow.
 ...
 */
export class LogprobsResultCandidate extends S.Class<LogprobsResultCandidate>(
...
export class TopCandidates extends S.Class<TopCandidates>("TopCandidates")({
   ...
   */
  candidates: S.optionalWith(S.Array(LogprobsResultCandidate), {
    nullable: true
  })
}) {}
...
export class LogprobsResult extends S.Class<LogprobsResult>("LogprobsResult")({
   ...
   */
  chosenCandidates: S.optionalWith(S.Array(LogprobsResultCandidate), {
    nullable: true
  })
}) {}
...
export class UrlMetadata extends S.Class<UrlMetadata>("UrlMetadata")({
   ...
   * Status of the url retrieval.
   */
  urlRetrievalStatus: S.optionalWith(UrlMetadataUrlRetrievalStatus, {
    nullable: true
  })
}) {}
 ...
 */
export class UrlContextMetadata extends S.Class<UrlContextMetadata>(
  "UrlContextMetadata"
)({
  /**
   * List of url context.
...
export class Candidate extends S.Class<Candidate>("Candidate")({
   ...
   */
  groundingAttributions: S.optionalWith(S.Array(GroundingAttribution), {
    nullable: true
  }),
  /**
 ...
 * Rephrase the prompt.
 */
export class PromptFeedbackBlockReason extends S.Literal(
...
export class GenerativeLanguageModality extends S.Literal(
 ...
 */
export class ModalityTokenCount extends S.Class<ModalityTokenCount>(
  "ModalityTokenCount"
)({
  /**
...
export class UsageMetadata extends S.Class<UsageMetadata>("UsageMetadata")({
   ...
   */
  promptTokensDetails: S.optionalWith(S.Array(ModalityTokenCount), {
    nullable: true
  }),
  /**
   * Output only. List of modalities of the cached content in the request input.
   */
  cacheTokensDetails: S.optionalWith(S.Array(ModalityTokenCount), {
    nullable: true
  }),
  /**
   * Output only. List of modalities that were returned in the response.
   */
  candidatesTokensDetails: S.optionalWith(S.Array(ModalityTokenCount), {
    nullable: true
  }),
  /**
   * Output only. List of modalities that were processed for tool-use request inputs.
   */
  toolUsePromptTokensDetails: S.optionalWith(S.Array(ModalityTokenCount), {
    nullable: true
  })
}) {}
 ...
 *    `safety_ratings`.
 */
export class GenerateContentResponse extends S.Class<GenerateContentResponse>(
 ...
 */
export class GroundingPassage extends S.Class<GroundingPassage>(
  "GroundingPassage"
)({
  /**
 ...
 */
export class GroundingPassages extends S.Class<GroundingPassages>(
  "GroundingPassages"
)({
  /**
   * List of passages.
 ...
 */
export class SemanticRetrieverConfig extends S.Class<SemanticRetrieverConfig>(
 ...
 */
export class GenerateAnswerRequestAnswerStyle extends S.Literal(
 ...
 */
export class GenerateAnswerRequest extends S.Class<GenerateAnswerRequest>(
   ...
   * API.
   */
  semanticRetriever: S.optionalWith(SemanticRetrieverConfig, {
    nullable: true
  }),
  /**
 ...
 * Rephrase the input.
 */
export class InputFeedbackBlockReason extends S.Literal(
  "BLOCK_REASON_UNSPECIFIED",
  "SAFETY",
  "OTHER"
) {}
 ...
 */
export class GenerateAnswerResponse extends S.Class<GenerateAnswerResponse>(
 ...
 */
export class EmbedContentRequest extends S.Class<EmbedContentRequest>(
  "EmbedContentRequest"
)({
  /**
 ...
 */
export class ContentEmbedding extends S.Class<ContentEmbedding>(
  "ContentEmbedding"
)({
  /**
 ...
 */
export class EmbedContentResponse extends S.Class<EmbedContentResponse>(
 ...
 */
export class BatchEmbedContentsRequest extends S.Class<BatchEmbedContentsRequest>(
 ...
 */
export class BatchEmbedContentsResponse extends S.Class<BatchEmbedContentsResponse>(
...
export class CountTokensRequest extends S.Class<CountTokensRequest>(
   ...
   */
  generateContentRequest: S.optionalWith(GenerateContentRequest, {
    nullable: true
  })
}) {}
 ...
 */
export class InlinedRequests extends S.Class<InlinedRequests>(
  "InlinedRequests"
)({
  /**
 ...
 */
export class InlinedResponse extends S.Class<InlinedResponse>(
  "InlinedResponse"
)({
  /**
 ...
 */
export class InlinedResponses extends S.Class<InlinedResponses>(
  "InlinedResponses"
)({
  /**
 ...
 */
export class GenerateContentBatchOutput extends S.Class<GenerateContentBatchOutput>(
 ...
 */
export class GenerateContentBatch extends S.Class<GenerateContentBatch>(
 ...
 */
export class BatchGenerateContentRequest extends S.Class<BatchGenerateContentRequest>(
 ...
 */
export class BatchGenerateContentResponse extends S.Class<BatchGenerateContentResponse>(
 ...
 * network API call.
 */
export class BatchGenerateContentOperation extends S.Class<BatchGenerateContentOperation>(
 ...
 * The request to be processed in the batch.
 */
export class InlinedEmbedContentRequest extends S.Class<InlinedEmbedContentRequest>(
 ...
 * batch creation request.
 */
export class InlinedEmbedContentRequests extends S.Class<InlinedEmbedContentRequests>(
 ...
 * Configures the input to the batch request.
 */
export class InputEmbedContentConfig extends S.Class<InputEmbedContentConfig>(
 ...
 * The response to a single request in the batch.
 */
export class InlinedEmbedContentResponse extends S.Class<InlinedEmbedContentResponse>(
 ...
 * The responses to the requests in the batch.
 */
export class InlinedEmbedContentResponses extends S.Class<InlinedEmbedContentResponses>(
  "InlinedEmbedContentResponses"
)({
  /**
   * Output only. The responses to the requests in the batch.
   */
  inlinedResponses: S.optionalWith(S.Array(InlinedEmbedContentResponse), {
    nullable: true
  })
}) {}
 ...
 */
export class EmbedContentBatchOutput extends S.Class<EmbedContentBatchOutput>(
   ...
   * the input requests.
   */
  inlinedResponses: S.optionalWith(InlinedEmbedContentResponses, {
    nullable: true
  })
}) {}
 ...
 * Stats about the batch.
 */
export class EmbedContentBatchStats extends S.Class<EmbedContentBatchStats>(
 ...
 */
export class EmbedContentBatch extends S.Class<EmbedContentBatch>(
  "EmbedContentBatch"
)({
  /**
   * Required. The name of the `Model` to use for generating the completion.
 ...
 */
export class AsyncBatchEmbedContentRequest extends S.Class<AsyncBatchEmbedContentRequest>(
 ...
 * Response for a `BatchGenerateContent` operation.
 */
export class AsyncBatchEmbedContentResponse extends S.Class<AsyncBatchEmbedContentResponse>(
 ...
 * network API call.
 */
export class AsyncBatchEmbedContentOperation extends S.Class<AsyncBatchEmbedContentOperation>(
...
export class UpdateGenerateContentBatchParams extends S.Struct({
  updateMask: S.optionalWith(
    S.String.pipe(
      S.pattern(new RegExp("^(\\s*[^,\\s.]+(\\s*[,.]\\s*[^,\\s.]+)*)?$"))
    ),
    {
      nullable: true
    }
 ...
 */
export class CachedContentUsageMetadata extends S.Class<CachedContentUsageMetadata>(
 ...
 */
export class ListCachedContentsResponse extends S.Class<ListCachedContentsResponse>(
 ...
 */
export class GenerateMessageRequest extends S.Class<GenerateMessageRequest>(
 ...
 */
export class ContentFilterReason extends S.Literal(
 ...
 */
export class GenerateMessageResponse extends S.Class<GenerateMessageResponse>(
 ...
 * `token_count`.
 */
export class CountMessageTokensRequest extends S.Class<CountMessageTokensRequest>(
 ...
 */
export class VideoFileMetadata extends S.Class<VideoFileMetadata>(
  "VideoFileMetadata"
)({
  /**
 ...
 */
export class FileState extends S.Literal(
  "STATE_UNSPECIFIED",
  "PROCESSING",
  "ACTIVE",
  "FAILED"
 ...
 * Source of the File.
 */
export class FileSource extends S.Literal(
  "SOURCE_UNSPECIFIED",
  "UPLOADED",
  "GENERATED",
  "REGISTERED"
 ...
 */
export class CreateFileResponse extends S.Class<CreateFileResponse>(
  "CreateFileResponse"
)({
  /**
 ...
 */
export class DownloadFileResponse extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class GeneratedFileState extends S.Literal(
  "STATE_UNSPECIFIED",
  "GENERATING",
  "GENERATED",
  "FAILED"
 ...
 */
export class ListGeneratedFilesResponse extends S.Class<ListGeneratedFilesResponse>(
...
export class Model extends S.Class<Model>("Model")({
   ...
   */
  supportedGenerationMethods: S.optionalWith(S.Array(S.String), {
    nullable: true
  }),
  /**
 ...
 */
export class TunedModelSource extends S.Class<TunedModelSource>(
  "TunedModelSource"
)({
  /**
 ...
 */
export class TunedModelState extends S.Literal(
  "STATE_UNSPECIFIED",
  "CREATING",
  "ACTIVE",
  "FAILED"
 ...
 */
export class Hyperparameters extends S.Class<Hyperparameters>(
  "Hyperparameters"
)({
  /**
 ...
 */
export class ListTunedModelsResponse extends S.Class<ListTunedModelsResponse>(
 ...
 */
export class CreateTunedModelMetadata extends S.Class<CreateTunedModelMetadata>(
 ...
 * network API call.
 */
export class CreateTunedModelOperation extends S.Class<CreateTunedModelOperation>(
 ...
 */
export class PermissionGranteeType extends S.Literal(
 ...
 */
export class PermissionRole extends S.Literal(
  "ROLE_UNSPECIFIED",
  "OWNER",
  "WRITER",
  "READER"
 ...
 */
export class TransferOwnershipRequest extends S.Class<TransferOwnershipRequest>(
 ...
 */
export class TransferOwnershipResponse extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class PredictResponse extends S.Class<PredictResponse>(
  "PredictResponse"
)({}) {}
 ...
 */
export class PredictLongRunningRequest extends S.Class<PredictLongRunningRequest>(
 ...
 */
export class PredictLongRunningMetadata extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 * Veo response.
 */
export class PredictLongRunningGeneratedVideoResponse extends S.Class<PredictLongRunningGeneratedVideoResponse>(
 ...
 */
export class PredictLongRunningResponse extends S.Class<PredictLongRunningResponse>(
  "PredictLongRunningResponse"
)({
  /**
   * The response of the video generation prediction.
   */
  generateVideoResponse: S.optionalWith(
    PredictLongRunningGeneratedVideoResponse,
    { nullable: true }
  )
}) {}
 ...
 * network API call.
 */
export class PredictLongRunningOperation extends S.Class<PredictLongRunningOperation>(
 ...
 */
export class FileSearchStore extends S.Class<FileSearchStore>(
  "FileSearchStore"
)({
  /**
 ...
 */
export class ListFileSearchStoresResponse extends S.Class<ListFileSearchStoresResponse>(
  "ListFileSearchStoresResponse"
)({
  /**
   * The returned rag_stores.
   */
  fileSearchStores: S.optionalWith(S.Array(FileSearchStore), {
    nullable: true
  }),
  /**
   * A token, which can be sent as `page_token` to retrieve the next page.
 ...
 */
export class ListCorporaResponse extends S.Class<ListCorporaResponse>(
  "ListCorporaResponse"
)({
  /**
 ...
 */
export class DocumentState extends S.Literal(
  "STATE_UNSPECIFIED",
  "STATE_PENDING",
  "STATE_ACTIVE",
  "STATE_FAILED"
 ...
 */
export class WhiteSpaceConfig extends S.Class<WhiteSpaceConfig>(
  "WhiteSpaceConfig"
)({
  /**
 ...
 */
export class ImportFileRequest extends S.Class<ImportFileRequest>(
  "ImportFileRequest"
)({
  /**
 ...
 */
export class ImportFileMetadata extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class ImportFileResponse extends S.Class<ImportFileResponse>(
  "ImportFileResponse"
)({
  /**
 ...
 * network API call.
 */
export class ImportFileOperation extends S.Class<ImportFileOperation>(
  "ImportFileOperation"
)({
 ...
 */
export class UploadToFileSearchStoreRequest extends S.Class<UploadToFileSearchStoreRequest>(
 ...
 */
export class UploadToFileSearchStoreMetadata extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
 ...
 */
export class UploadToFileSearchStoreResponse extends S.Class<UploadToFileSearchStoreResponse>(
 ...
 * network API call.
 */
export class UploadToFileSearchStoreOperation extends S.Class<UploadToFileSearchStoreOperation>(
 ...
 */
export class GenerateTextRequest extends S.Class<GenerateTextRequest>(
  "GenerateTextRequest"
)({
  /**
 ...
 */
export class GenerateTextResponse extends S.Class<GenerateTextResponse>(
 ...
 */
export class EmbedTextRequest extends S.Class<EmbedTextRequest>(
  "EmbedTextRequest"
)({
  /**
 ...
 */
export class EmbedTextResponse extends S.Class<EmbedTextResponse>(
  "EmbedTextResponse"
)({
  /**
 ...
 */
export class BatchEmbedTextRequest extends S.Class<BatchEmbedTextRequest>(
 ...
 * The response to a EmbedTextRequest.
 */
export class BatchEmbedTextResponse extends S.Class<BatchEmbedTextResponse>(
 ...
 * `token_count`.
 */
export class CountTextTokensRequest extends S.Class<CountTextTokensRequest>(
 ...
 * It returns the model's `token_count` for the `prompt`.
 */
export class CountTextTokensResponse extends S.Class<CountTextTokensResponse>(
...
export const make = (
  ...
  return {
    ...
    GetOperationByFileSearchStoreAndOperation: (fileSearchStore, operation) =>
      HttpClientRequest.get(
        `/v1beta/fileSearchStores/${fileSearchStore}/operations/${operation}`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
            "2xx": decodeSuccess(Operation),
    ...
    GetOperationByFileSearchStoresIdAndOperationsId: (
      fileSearchStoresId,
      operationsId
    ) =>
      HttpClientRequest.get(
    ...
    UpdateGenerateContentBatch: (generateContentBatch, options) =>
      HttpClientRequest.patch(
        `/v1beta/batches/${generateContentBatch}:updateGenerateContentBatch`
      ).pipe(
        HttpClientRequest.setUrlParams({
          updateMask: options.params?.["updateMask"] as any
        }),
    ...
    UpdateEmbedContentBatch: (generateContentBatch, options) =>
      HttpClientRequest.patch(
        `/v1beta/batches/${generateContentBatch}:updateEmbedContentBatch`
      ).pipe(
        HttpClientRequest.setUrlParams({
          updateMask: options.params?.["updateMask"] as any
        }),
    ...
    CreateTunedModel: (options) =>
      HttpClientRequest.post(`/v1beta/tunedModels`).pipe(
        HttpClientRequest.setUrlParams({
          tunedModelId: options.params?.["tunedModelId"] as any
        }),
        HttpClientRequest.bodyUnsafeJson(options.payload),
        withResponse(
          HttpClientResponse.matchStatus({
    ...
    GetDocument: (fileSearchStore, document) =>
      HttpClientRequest.get(
        `/v1beta/fileSearchStores/${fileSearchStore}/documents/${document}`
      ).pipe(
        withResponse(
          HttpClientResponse.matchStatus({
    ...
    ListDocuments: (fileSearchStore, options) =>
      HttpClientRequest.get(
        `/v1beta/fileSearchStores/${fileSearchStore}/documents`
      ).pipe(
        HttpClientRequest.setUrlParams({
          pageSize: options?.["pageSize"] as any,
          pageToken: options?.["pageToken"] as any
    ...
    ImportFile: (fileSearchStore, options) =>
      HttpClientRequest.post(
        `/v1beta/fileSearchStores/${fileSearchStore}:importFile`
      ).pipe(
        HttpClientRequest.bodyUnsafeJson(options),
        withResponse(
          HttpClientResponse.matchStatus({
    ...
    UploadToFileSearchStore: (fileSearchStore, options) =>
      HttpClientRequest.post(
        `/v1beta/fileSearchStores/${fileSearchStore}:uploadToFileSearchStore`
      ).pipe(
        HttpClientRequest.bodyUnsafeJson(options),
        withResponse(
          HttpClientResponse.matchStatus({
...
export interface Client {
  ...
  readonly ListOperations: (
    ...
    typeof ListOperationsResponse.Type,
  ...
  readonly GenerateContent: (
    ...
    typeof GenerateContentResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Generates a model response given an input `GenerateContentRequest`.
  ...
  readonly GenerateAnswer: (
    ...
    typeof GenerateAnswerResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly EmbedContent: (
    ...
    typeof EmbedContentResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly BatchEmbedContents: (
    ...
    typeof BatchEmbedContentsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly CountTokens: (
    ...
    typeof CountTokensResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly BatchGenerateContent: (
    ...
    typeof BatchGenerateContentOperation.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Enqueues a batch of `GenerateContent` requests for batch processing.
  ...
  readonly AsyncBatchEmbedContent: (
    ...
    typeof AsyncBatchEmbedContentOperation.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Enqueues a batch of `EmbedContent` requests for batch processing.
  ...
  readonly UpdateGenerateContentBatch: (
    ...
    options: {
      readonly params?:
        | typeof UpdateGenerateContentBatchParams.Encoded
        | undefined
      readonly payload: typeof GenerateContentBatch.Encoded
    }
  ) => Effect.Effect<
    typeof GenerateContentBatch.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListCachedContents: (
    ...
    typeof ListCachedContentsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly GenerateMessage: (
    ...
    typeof GenerateMessageResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly CreateFile: (
    ...
    typeof CreateFileResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly DownloadFile: (
    ...
    typeof DownloadFileResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListGeneratedFiles: (
    ...
    typeof ListGeneratedFilesResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListTunedModels: (
    ...
    typeof ListTunedModelsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly CreateTunedModel: (options: {
    ...
    typeof CreateTunedModelOperation.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListPermissions: (
    ...
    typeof ListPermissionsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly UpdatePermission: (
    ...
    permission: string,
    options: {
      readonly params: typeof UpdatePermissionParams.Encoded
  ...
  readonly TransferOwnership: (
    ...
    typeof TransferOwnershipResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly PredictLongRunning: (
    ...
    typeof PredictLongRunningOperation.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListFileSearchStores: (
    ...
    typeof ListFileSearchStoresResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListCorpora: (
    ...
    typeof ListCorporaResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ListDocuments: (
    ...
    typeof ListDocumentsResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly ImportFile: (
    ...
    typeof ImportFileOperation.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly UploadToFileSearchStore: (
    ...
    typeof UploadToFileSearchStoreOperation.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly GenerateText: (
    ...
    typeof GenerateTextResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
   * Generates a response from the model given an input message.
  ...
  readonly BatchEmbedText: (
    ...
    typeof BatchEmbedTextResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
  /**
  ...
  readonly CountTextTokens: (
    ...
    typeof CountTextTokensResponse.Type,
    HttpClientError.HttpClientError | ParseError
  >
}
