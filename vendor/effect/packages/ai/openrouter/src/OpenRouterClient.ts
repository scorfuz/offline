...
export const make: (options: {
  ...
  readonly transformClient?:
    ...
    | undefined
}) => Effect.Effect<Service, never, HttpClient.HttpClient> = Effect.fnUntraced(
  function* (options) {
      ...
      HttpClient.mapRequest((request) =>
        request.pipe(
          ...
          options.apiKey
            ...
            : identity,
          options.referrer
            ? HttpClientRequest.setHeader("HTTP-Referrer", options.referrer)
            : identity,
          options.title
...
export class ChatStreamingMessageChunk extends Schema.Class<ChatStreamingMessageChunk>(
  ...
  reasoning_details: Schema.optionalWith(
    Schema.Array(Generated.ReasoningDetail),
    { nullable: true }
  ),
  images: Schema.optionalWith(
    Schema.Array(Generated.ChatMessageContentItemImage),
    { nullable: true }
  ),
  refusal: Schema.optionalWith(Schema.String, { nullable: true }),
  tool_calls: Schema.optionalWith(Schema.Array(ChatStreamingMessageToolCall), {
    nullable: true
  }),
  annotations: Schema.optionalWith(Schema.Array(Generated.AnnotationDetail), {
    nullable: true
  })
}) {}
...
export class ChatStreamingChoice extends Schema.Class<ChatStreamingChoice>(
  ...
  finish_reason: Schema.optionalWith(Generated.ChatCompletionFinishReason, {
    nullable: true
  }),
  native_finish_reason: Schema.optionalWith(Schema.String, { nullable: true }),
  logprobs: Schema.optionalWith(Generated.ChatMessageTokenLogprobs, {
    nullable: true
  })
}) {}
...
export class ChatStreamingResponseChunk extends Schema.Class<ChatStreamingResponseChunk>(
  ...
  error: Schema.optionalWith(Generated.ChatError.fields.error, {
    nullable: true
  }),
