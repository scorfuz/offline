...
export class ReasoningSummaryText extends S.Class<ReasoningSummaryText>(
...
export class OpenResponsesReasoningStatusEnum extends S.Literal(
  "in_progress"
) {}

export class OpenResponsesReasoning extends S.Class<OpenResponsesReasoning>(
...
export class ReasoningDetailSummary extends S.Class<ReasoningDetailSummary>(
...
export class ReasoningDetailEncrypted extends S.Class<ReasoningDetailEncrypted>(
...
export class ReasoningDetailText extends S.Class<ReasoningDetailText>(
  "ReasoningDetailText"
)({
  id: S.optionalWith(S.String, { nullable: true }),
...
export class FileAnnotationDetail extends S.Class<FileAnnotationDetail>(
...
export class AnnotationDetail extends S.Union(
  FileAnnotationDetail,
  URLCitationAnnotationDetail
) {}
...
export class OpenResponsesEasyInputMessageRoleEnum extends S.Literal(
  "developer"
) {}
 ...
 */
export class ResponseInputText extends S.Class<ResponseInputText>(
  "ResponseInputText"
)({
 ...
 */
export class ResponseInputFile extends S.Class<ResponseInputFile>(
  "ResponseInputFile"
)({
...
export class ResponseInputAudioInputAudioFormat extends S.Literal(
  "mp3",
  "wav"
) {}
 ...
 */
export class ResponseInputAudio extends S.Class<ResponseInputAudio>(
  "ResponseInputAudio"
)({
 ...
 */
export class ResponseInputVideo extends S.Class<ResponseInputVideo>(
  "ResponseInputVideo"
)({
...
export class OpenResponsesInputMessageItemRoleEnum extends S.Literal(
  "developer"
) {}
...
export class OpenResponsesFunctionToolCallType extends S.Literal(
  "function_call"
) {}

export class ToolCallStatus extends S.Literal(
  "in_progress",
  "completed",
  "incomplete"
) {}
...
export class OpenResponsesFunctionCallOutputType extends S.Literal(
...
export class ResponsesOutputMessageStatusEnum extends S.Literal(
  "in_progress"
) {}
...
export class OpenAIResponsesAnnotation extends S.Union(
  FileCitation,
  URLCitation,
  FilePath
) {}
...
export class ResponseOutputText extends S.Class<ResponseOutputText>(
  ...
  text: S.String,
  annotations: S.optionalWith(S.Array(OpenAIResponsesAnnotation), {
    nullable: true
  }),
...
export class ResponsesOutputMessage extends S.Class<ResponsesOutputMessage>(
...
export class ResponsesOutputItemReasoningStatusEnum extends S.Literal(
  "in_progress"
) {}
...
export class ResponsesOutputItemReasoning extends S.Class<ResponsesOutputItemReasoning>(
   ...
   * The format of the reasoning content
   */
  format: S.optionalWith(ResponsesOutputItemReasoningFormat, {
    nullable: true
  }),
...
export class ResponsesOutputItemFunctionCallType extends S.Literal(
  "function_call"
) {}

export class ResponsesOutputItemFunctionCallStatusEnum extends S.Literal(
  "in_progress"
) {}
...
export class ResponsesWebSearchCallOutputType extends S.Literal(
  "web_search_call"
) {}

export class WebSearchStatus extends S.Literal(
  "completed",
  "searching",
  "in_progress",
  "failed"
...
export class ResponsesOutputItemFileSearchCallType extends S.Literal(
  "file_search_call"
) {}
...
export class ResponsesImageGenerationCallType extends S.Literal(
  "image_generation_call"
) {}

export class ImageGenerationStatus extends S.Literal(
  "in_progress",
  "completed",
  "generating",
  "failed"
 ...
 */
export class OpenResponsesRequestMetadata extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}

export class OpenResponsesWebSearchPreviewToolType extends S.Literal(
  "web_search_preview"
) {}
 ...
 */
export class ResponsesSearchContextSize extends S.Literal(
  "low",
  "medium",
  "high"
) {}

export class WebSearchPreviewToolUserLocationType extends S.Literal(
  "approximate"
) {}
...
export class OpenResponsesWebSearchPreviewTool extends S.Class<OpenResponsesWebSearchPreviewTool>(
  ...
  search_context_size: S.optionalWith(ResponsesSearchContextSize, {
    nullable: true
  }),
...
export class ResponsesWebSearchUserLocationType extends S.Literal(
  "approximate"
) {}
...
export class OpenResponsesWebSearchTool extends S.Class<OpenResponsesWebSearchTool>(
  ...
  user_location: S.optionalWith(ResponsesWebSearchUserLocation, {
    nullable: true
  })
}) {}

export class OpenResponsesWebSearch20250826ToolType extends S.Literal(
...
export class OpenAIResponsesToolChoiceEnumTypeEnum extends S.Literal(
  "web_search_preview"
) {}
...
export class OpenAIResponsesToolChoice extends S.Union(
  ...
  S.Struct({
    type: S.Union(
      OpenAIResponsesToolChoiceEnumTypeEnum,
      OpenAIResponsesToolChoiceEnumTypeEnum
    )
  })
) {}
 ...
 */
export class ResponsesFormatText extends S.Class<ResponsesFormatText>(
  "ResponsesFormatText"
)({
...
export class ResponsesFormatTextJSONSchemaConfigType extends S.Literal(
  "json_schema"
) {}
...
export class OpenResponsesResponseTextVerbosity extends S.Literal(
  "high",
  "low",
  "medium"
) {}
...
export class ReasoningSummaryVerbosity extends S.Literal(
  "auto",
  "concise",
  "detailed"
) {}
...
export class OpenAIResponsesPrompt extends S.Class<OpenAIResponsesPrompt>(
...
export class OpenResponsesRequestTruncationEnum extends S.Literal(
  "auto",
  "disabled"
) {}
...
export class ProviderSortConfigPartitionEnum extends S.Literal(
  "model",
  "none"
) {}

export class ProviderSortConfig extends S.Class<ProviderSortConfig>(
  "ProviderSortConfig"
)({
 ...
 */
export class PreferredMinThroughput extends S.Union(
  S.Number,
  PercentileThroughputCutoffs
) {}
 ...
 */
export class PercentileLatencyCutoffs extends S.Class<PercentileLatencyCutoffs>(
 ...
 */
export class PreferredMaxLatency extends S.Union(
  S.Number,
  PercentileLatencyCutoffs
) {}
 ...
 */
export class PDFParserEngine extends S.Literal(
  "mistral-ocr",
  "pdf-text",
  "native"
) {}
 ...
 */
export class PDFParserOptions extends S.Class<PDFParserOptions>(
  "PDFParserOptions"
)({
 ...
 */
export class OpenResponsesRequest extends S.Class<OpenResponsesRequest>(
  ...
  top_p: S.optionalWith(S.Number.pipe(S.greaterThanOrEqualTo(0)), {
    nullable: true
  }),
   ...
   */
  image_config: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  }),
  /**
   * Output modalities for the response. Supported values are "text" and "image".
   */
  modalities: S.optionalWith(S.Array(ResponsesOutputModality), {
    nullable: true
  }),
  ...
  include: S.optionalWith(S.Array(OpenAIResponsesIncludable), {
    nullable: true
  }),
  ...
  truncation: S.optionalWith(OpenResponsesRequestTruncation, {
    nullable: true
  }),
  ...
  provider: S.optionalWith(
    S.Struct({
       ...
       */
      order: S.optionalWith(S.Array(S.Union(ProviderName, S.String)), {
        nullable: true
      }),
      /**
       * List of provider slugs to allow. If provided, this list is merged with your account-wide allowed provider settings for this request.
       */
      only: S.optionalWith(S.Array(S.Union(ProviderName, S.String)), {
        nullable: true
      }),
      /**
       * List of provider slugs to ignore. If provided, this list is merged with your account-wide ignored provider settings for this request.
       */
      ignore: S.optionalWith(S.Array(S.Union(ProviderName, S.String)), {
        nullable: true
      }),
      /**
       ...
       */
      sort: S.optionalWith(S.Union(ProviderSort, ProviderSortConfig), {
        nullable: true
      }),
      /**
      ...
      preferred_min_throughput: S.optionalWith(PreferredMinThroughput, {
        nullable: true
      }),
      preferred_max_latency: S.optionalWith(PreferredMaxLatency, {
        nullable: true
      })
    }),
    { nullable: true }
   ...
   */
  session_id: S.optionalWith(S.String.pipe(S.maxLength(128)), {
    nullable: true
  })
}) {}
...
export class OutputItemReasoning extends S.Class<OutputItemReasoning>(
  "OutputItemReasoning"
)({
...
export class OutputItemFunctionCallStatusEnum extends S.Literal(
  "in_progress"
) {}

export class OutputItemFunctionCall extends S.Class<OutputItemFunctionCall>(
...
export class OutputItemWebSearchCall extends S.Class<OutputItemWebSearchCall>(
...
export class OutputItemFileSearchCallType extends S.Literal(
  "file_search_call"
) {}

export class OutputItemFileSearchCall extends S.Class<OutputItemFileSearchCall>(
...
export class OutputItemImageGenerationCallType extends S.Literal(
  "image_generation_call"
) {}
...
export class OpenAIResponsesUsage extends S.Class<OpenAIResponsesUsage>(
...
export class OpenResponsesNonStreamingResponseObject extends S.Literal(
  "response"
) {}
 ...
 */
export class ResponsesErrorField extends S.Class<ResponsesErrorField>(
  "ResponsesErrorField"
)({
...
export class OpenAIResponsesIncompleteDetails extends S.Class<OpenAIResponsesIncompleteDetails>(
  ...
  reason: S.optionalWith(OpenAIResponsesIncompleteDetailsReason, {
    nullable: true
  })
}) {}
...
export class ResponseInputImageDetail extends S.Literal(
  "auto",
  "high",
  "low"
) {}
 ...
 * Image input content item
 */
export class ResponseInputImage extends S.Class<ResponseInputImage>(
  "ResponseInputImage"
)({
...
export class OpenAIResponsesServiceTier extends S.Literal(
  "auto",
  "default",
  "flex",
  "priority",
...
export class ResponseTextConfigVerbosity extends S.Literal(
  "high",
  "low",
  "medium"
) {}
 ...
 * Text output configuration including format and verbosity
 */
export class ResponseTextConfig extends S.Class<ResponseTextConfig>(
  "ResponseTextConfig"
)({
  format: S.optionalWith(ResponseFormatTextConfig, { nullable: true }),
 ...
 */
export class BadRequestResponse extends S.Class<BadRequestResponse>(
  "BadRequestResponse"
)({
 ...
 */
export class UnauthorizedResponse extends S.Class<UnauthorizedResponse>(
 ...
 */
export class PaymentRequiredResponse extends S.Class<PaymentRequiredResponse>(
 ...
 */
export class NotFoundResponse extends S.Class<NotFoundResponse>(
  "NotFoundResponse"
)({
 ...
 */
export class RequestTimeoutResponse extends S.Class<RequestTimeoutResponse>(
 ...
 */
export class PayloadTooLargeResponse extends S.Class<PayloadTooLargeResponse>(
 ...
 */
export class TooManyRequestsResponse extends S.Class<TooManyRequestsResponse>(
 ...
 */
export class InternalServerResponse extends S.Class<InternalServerResponse>(
 ...
 */
export class BadGatewayResponse extends S.Class<BadGatewayResponse>(
  "BadGatewayResponse"
)({
...
export class OpenRouterAnthropicMessageParamRole extends S.Literal(
  "user",
  "assistant"
) {}
...
export class AnthropicMessagesRequestToolChoiceEnumType extends S.Literal(
  "tool"
) {}

export class AnthropicMessagesRequestThinkingEnumType extends S.Literal(
  "disabled"
) {}

export class AnthropicMessagesRequestServiceTier extends S.Literal(
  "auto",
  "standard_only"
) {}
 ...
 * The sorting strategy to use for this request, if "order" is not specified. When set, no load balancing is performed.
 */
export class AnthropicMessagesRequestProviderSort extends S.Literal(
  "price",
  "throughput",
  "latency"
) {}
 ...
 * **DEPRECATED** Use providers.sort.partition instead. Backwards-compatible alias for providers.sort.partition. Accepts legacy values: "fallback" (maps to "model"), "sort" (maps to "none").
 */
export class AnthropicMessagesRequestRoute extends S.Literal(
  "fallback",
  "sort"
) {}
 ...
 */
export class AnthropicMessagesRequest extends S.Class<AnthropicMessagesRequest>(
    ...
    S.Array(
      S.Union(
        ...
        S.Struct({
          ...
          name: S.Literal("web_search"),
          allowed_domains: S.optionalWith(S.Array(S.String), {
            nullable: true
          }),
  ...
  provider: S.optionalWith(
    S.Struct({
       ...
       */
      quantizations: S.optionalWith(S.Array(Quantization), { nullable: true }),
      sort: S.optionalWith(AnthropicMessagesRequestProviderSort, {
        nullable: true
      }),
      /**
       * The object specifying the maximum price you want to pay for this request. USD price per million tokens, for prompt and completion.
...
export class AnthropicMessagesResponseUsageServiceTier extends S.Literal(
  "standard",
  "priority",
  "batch"
) {}
 ...
 */
export class ForbiddenResponse extends S.Class<ForbiddenResponse>(
  "ForbiddenResponse"
)({
 ...
 */
export class CreateChargeRequest extends S.Class<CreateChargeRequest>(
  "CreateChargeRequest"
)({
  amount: S.Number,
  sender: S.String,
...
export class CreateEmbeddingsRequestEncodingFormat extends S.Literal(
  "float",
  "base64"
) {}
 ...
 * The sorting strategy to use for this request, if "order" is not specified. When set, no load balancing is performed.
 */
export class ProviderPreferencesSort extends S.Literal(
  "price",
  "throughput",
  "latency"
) {}
 ...
 */
export class ProviderPreferences extends S.Class<ProviderPreferences>(
  "ProviderPreferences"
)({
  /**
   * Whether to allow backup providers to serve requests
...
export class CreateEmbeddingsRequest extends S.Class<CreateEmbeddingsRequest>(
  ...
  model: S.String,
  encoding_format: S.optionalWith(CreateEmbeddingsRequestEncodingFormat, {
    nullable: true
  }),
...
export class InputModality extends S.Literal(
  "text",
  "image",
  "file",
  "audio",
...
export class OutputModality extends S.Literal(
  "text",
  "image",
  "embeddings",
  "audio"
 ...
 */
export class ModelArchitecture extends S.Class<ModelArchitecture>(
  "ModelArchitecture"
)({
   ...
   * Instruction format type
   */
  instruct_type: S.optionalWith(ModelArchitectureInstructType, {
    nullable: true
  }),
  /**
 ...
 */
export class TopProviderInfo extends S.Class<TopProviderInfo>(
  "TopProviderInfo"
)({
  /**
 ...
 */
export class PerRequestLimits extends S.Class<PerRequestLimits>(
  "PerRequestLimits"
)({
  /**
 ...
 */
export class DefaultParameters extends S.Class<DefaultParameters>(
  "DefaultParameters"
)({
  temperature: S.optionalWith(
    S.Number.pipe(S.greaterThanOrEqualTo(0), S.lessThanOrEqualTo(2)),
 ...
 * List of available models
 */
export class ModelsListResponse extends S.Class<ModelsListResponse>(
  "ModelsListResponse"
)({
 ...
 */
export class GetGeneration200DataApiType extends S.Literal(
  "completions",
  "embeddings"
) {}
 ...
 * Model count data
 */
export class ModelsCountResponse extends S.Class<ModelsCountResponse>(
  "ModelsCountResponse"
)({
  /**
   * Model count data
 ...
 */
export class PercentileStats extends S.Class<PercentileStats>(
  "PercentileStats"
)({
  /**
 ...
 */
export class CreateKeysRequestLimitReset extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}

export class CreateKeysRequest extends S.Class<CreateKeysRequest>(
  "CreateKeysRequest"
)({
  /**
 ...
 */
export class UpdateKeysRequestLimitReset extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}
...
export class ListGuardrails200 extends S.Struct({
  ...
  data: S.Array(
    S.Struct({
       ...
       */
      limit_usd: S.optionalWith(S.Number.pipe(S.greaterThan(0)), {
        nullable: true
      }),
      /**
       * Interval at which the limit resets (daily, weekly, monthly)
       */
      reset_interval: S.optionalWith(S.Literal("daily", "weekly", "monthly"), {
        nullable: true
      }),
      /**
 ...
 * Interval at which the limit resets (daily, weekly, monthly)
 */
export class CreateGuardrailRequestResetInterval extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}
...
export class CreateGuardrailRequest extends S.Class<CreateGuardrailRequest>(
   ...
   * Interval at which the limit resets (daily, weekly, monthly)
   */
  reset_interval: S.optionalWith(CreateGuardrailRequestResetInterval, {
    nullable: true
  }),
  /**
   * List of allowed provider IDs
   */
  allowed_providers: S.optionalWith(
 ...
 * Interval at which the limit resets (daily, weekly, monthly)
 */
export class CreateGuardrail201DataResetInterval extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}
...
export class CreateGuardrail201 extends S.Struct({
  ...
  data: S.Struct({
     ...
     * Interval at which the limit resets (daily, weekly, monthly)
     */
    reset_interval: S.optionalWith(CreateGuardrail201DataResetInterval, {
      nullable: true
    }),
    /**
     * List of allowed provider IDs
 ...
 * Interval at which the limit resets (daily, weekly, monthly)
 */
export class GetGuardrail200DataResetInterval extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}
...
export class GetGuardrail200 extends S.Struct({
  ...
  data: S.Struct({
     ...
     * Interval at which the limit resets (daily, weekly, monthly)
     */
    reset_interval: S.optionalWith(GetGuardrail200DataResetInterval, {
      nullable: true
    }),
    /**
     * List of allowed provider IDs
 ...
 * Interval at which the limit resets (daily, weekly, monthly)
 */
export class UpdateGuardrailRequestResetInterval extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}
...
export class UpdateGuardrailRequest extends S.Class<UpdateGuardrailRequest>(
   ...
   */
  name: S.optionalWith(S.String.pipe(S.minLength(1), S.maxLength(200)), {
    nullable: true
  }),
  /**
   ...
   * Interval at which the limit resets (daily, weekly, monthly)
   */
  reset_interval: S.optionalWith(UpdateGuardrailRequestResetInterval, {
    nullable: true
  }),
  /**
 ...
 * Interval at which the limit resets (daily, weekly, monthly)
 */
export class UpdateGuardrail200DataResetInterval extends S.Literal(
  "daily",
  "weekly",
  "monthly"
) {}
...
export class UpdateGuardrail200 extends S.Struct({
  ...
  data: S.Struct({
     ...
     * Interval at which the limit resets (daily, weekly, monthly)
     */
    reset_interval: S.optionalWith(UpdateGuardrail200DataResetInterval, {
      nullable: true
    }),
    /**
     * List of allowed provider IDs
...
export class BulkAssignMembersToGuardrailRequest extends S.Class<BulkAssignMembersToGuardrailRequest>(
   ...
   */
  member_user_ids: S.NonEmptyArray(S.String.pipe(S.minLength(1))).pipe(
    S.minItems(1)
  )
}) {}
 ...
 */
export class ExchangeAuthCodeForAPIKeyRequestCodeChallengeMethod extends S.Literal(
  "S256",
  "plain"
) {}
...
export class ExchangeAuthCodeForAPIKeyRequest extends S.Class<ExchangeAuthCodeForAPIKeyRequest>(
   ...
   * The method used to generate the code challenge
   */
  code_challenge_method: S.optionalWith(
    ExchangeAuthCodeForAPIKeyRequestCodeChallengeMethod,
    { nullable: true }
  )
}) {}
 ...
 * The method used to generate the code challenge
 */
export class CreateAuthKeysCodeRequestCodeChallengeMethod extends S.Literal(
  "S256",
  "plain"
) {}
...
export class ChatGenerationParamsProviderEnumDataCollectionEnum extends S.Literal(
  "deny",
  "allow"
) {}
...
export class ProviderSortUnion extends S.Union(
  ProviderSort,
  ProviderSortConfig
) {}
...
export class ChatGenerationParamsRouteEnum extends S.Literal(
  "fallback",
  "sort"
) {}

export class ChatMessageContentItemCacheControlTtl extends S.Literal(
  "5m",
  "1h"
) {}
...
export class ChatMessageContentItemText extends S.Class<ChatMessageContentItemText>(
  ...
  type: S.Literal("text"),
  text: S.String,
  cache_control: S.optionalWith(ChatMessageContentItemCacheControl, {
    nullable: true
  })
}) {}
...
export class ChatMessageContentItemImageImageUrlDetail extends S.Literal(
  "auto",
  "low",
  "high"
) {}
...
export class ChatMessageContentItemImage extends S.Class<ChatMessageContentItemImage>(
  ...
  image_url: S.Struct({
    url: S.String,
    detail: S.optionalWith(ChatMessageContentItemImageImageUrlDetail, {
      nullable: true
    })
  })
}) {}
...
export class ChatMessageContentItemVideo extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}

export class ChatMessageContentItem extends S.Record({
  key: S.String,
  value: S.Unknown
}) {}
...
export class ChatMessageToolCall extends S.Class<ChatMessageToolCall>(
  "ChatMessageToolCall"
)({
  id: S.String,
...
export class AssistantMessage extends S.Class<AssistantMessage>(
  "AssistantMessage"
)({
  role: S.Literal("assistant"),
  content: S.optionalWith(S.Union(S.String, S.Array(ChatMessageContentItem)), {
    nullable: true
  }),
  name: S.optionalWith(S.String, { nullable: true }),
...
export class ToolResponseMessage extends S.Class<ToolResponseMessage>(
  "ToolResponseMessage"
)({
  role: S.Literal("tool"),
  content: S.Union(S.String, S.Array(ChatMessageContentItem)),
...
export class JSONSchemaConfig extends S.Class<JSONSchemaConfig>(
  "JSONSchemaConfig"
)({
  name: S.String.pipe(S.maxLength(64)),
  description: S.optionalWith(S.String, { nullable: true }),
  schema: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  }),
  strict: S.optionalWith(S.Boolean, { nullable: true })
}) {}
...
export class ChatStreamOptions extends S.Class<ChatStreamOptions>(
  "ChatStreamOptions"
)({
  include_usage: S.optionalWith(S.Boolean, { nullable: true })
}) {}

export class NamedToolChoice extends S.Class<NamedToolChoice>(
  "NamedToolChoice"
)({
  type: S.Literal("function"),
  function: S.Struct({
...
export class ToolDefinitionJson extends S.Class<ToolDefinitionJson>(
  "ToolDefinitionJson"
)({
  type: S.Literal("function"),
  function: S.Struct({
...
export class ChatGenerationParams extends S.Class<ChatGenerationParams>(
  ...
  max_completion_tokens: S.optionalWith(
    S.Number.pipe(S.greaterThanOrEqualTo(1)),
    { nullable: true }
  ),
  max_tokens: S.optionalWith(S.Number.pipe(S.greaterThanOrEqualTo(1)), {
    nullable: true
  }),
  metadata: S.optionalWith(S.Record({ key: S.String, value: S.Unknown }), {
    nullable: true
  ...
  reasoning: S.optionalWith(
    S.Struct({
      effort: S.optionalWith(ChatGenerationParamsReasoningEffortEnum, {
        nullable: true
      }),
      summary: S.optionalWith(ReasoningSummaryVerbosity, { nullable: true })
    }),
  ...
  stop: S.optionalWith(
    S.Union(S.String, S.Array(S.String).pipe(S.maxItems(4))),
    { nullable: true }
  ),
  stream: S.optionalWith(S.Boolean, {
    nullable: true,
  ...
  modalities: S.optionalWith(S.Array(S.Literal("text", "image")), {
    nullable: true
  })
}) {}
...
export class ChatMessageTokenLogprob extends S.Class<ChatMessageTokenLogprob>(
...
export class ChatMessageTokenLogprobs extends S.Class<ChatMessageTokenLogprobs>(
...
export class ChatResponseChoice extends S.Class<ChatResponseChoice>(
  "ChatResponseChoice"
)({
...
export class ChatGenerationTokenUsage extends S.Class<ChatGenerationTokenUsage>(
...
export class CompletionCreateParams extends S.Class<CompletionCreateParams>(
  ...
  best_of: S.optionalWith(
    S.Int.pipe(S.greaterThanOrEqualTo(1), S.lessThanOrEqualTo(20)),
    { nullable: true }
  ),
...
export class CompletionLogprobs extends S.Class<CompletionLogprobs>(
  "CompletionLogprobs"
)({
  tokens: S.Array(S.String),
  token_logprobs: S.Array(S.Number),
  top_logprobs: S.NullOr(
    S.Array(S.Record({ key: S.String, value: S.Unknown }))
  ),
  text_offset: S.Array(S.Number)
}) {}

export class CompletionFinishReasonEnum extends S.Literal(
  "stop",
  "length",
  "content_filter"
) {}

export class CompletionFinishReason extends S.Union(
  CompletionFinishReasonEnum,
  S.Null
) {}

export class CompletionChoice extends S.Class<CompletionChoice>(
  "CompletionChoice"
)({
  text: S.String,
  index: S.Number,
...
export interface Client {
  ...
  readonly createResponses: (
    ...
    | ClientError<
        "PaymentRequiredResponse",
        typeof PaymentRequiredResponse.Type
      >
    ...
    | ClientError<
        "PayloadTooLargeResponse",
        typeof PayloadTooLargeResponse.Type
      >
    | ClientError<
        "UnprocessableEntityResponse",
        typeof UnprocessableEntityResponse.Type
      >
    | ClientError<
        "TooManyRequestsResponse",
        typeof TooManyRequestsResponse.Type
      >
    ...
    | ClientError<
        "ServiceUnavailableResponse",
        typeof ServiceUnavailableResponse.Type
      >
    | ClientError<
        "EdgeNetworkTimeoutResponse",
        typeof EdgeNetworkTimeoutResponse.Type
      >
    | ClientError<
        "ProviderOverloadedResponse",
        typeof ProviderOverloadedResponse.Type
      >
  >
  /**
