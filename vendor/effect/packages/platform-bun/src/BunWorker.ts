 ...
 * @category layers
 */
export const layerManager: Layer.Layer<Worker.WorkerManager> =
 ...
 * @category layers
 */
export const layerWorker: Layer.Layer<Worker.PlatformWorker> =
...
) => Layer.Layer<Worker.PlatformWorker | Worker.Spawner, never, never> =
  internal.layerPlatform
