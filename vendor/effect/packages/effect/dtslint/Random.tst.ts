...
describe("Random", () => {
  it("choice", () => {
    expect(Random.choice(array)).type.toBe<
      Effect.Effect<number, Cause.NoSuchElementException, never>
    >()
    expect(Random.choice(nonEmptyArray)).type.toBe<
      Effect.Effect<number, never, never>
    >()
    expect(Random.choice(readonlyArray)).type.toBe<
      Effect.Effect<number, Cause.NoSuchElementException, never>
    >()
    expect(Random.choice(nonEmptyReadonlyArray)).type.toBe<
      Effect.Effect<number, never, never>
    >()
    expect(Random.choice(chunk)).type.toBe<
      Effect.Effect<number, Cause.NoSuchElementException, never>
    >()
    expect(Random.choice(nonEmptyChunk)).type.toBe<
      Effect.Effect<number, never, never>
    >()
  })
})
