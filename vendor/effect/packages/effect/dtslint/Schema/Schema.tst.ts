...
describe("Schema", () => {
  ...
  describe("Struct", () => {
    ...
    it("pick", () => {
      ...
      when(f).isCalledWith(
        expect(S.Struct).type.not.toBeCallableWith({ b: S.String })
      )

      when(f).isCalledWith(
        expect(S.Struct).type.not.toBeCallableWith({ a: S.Number })
      )
    })
  ...
  it("transform", () => {
    ...
    when(S.String.pipe).isCalledWith(
      expect(S.transform).type.not.toBeCallableWith(
        S.Number,
        (s: any) => s,
        (n: any) => String(n)
      )
  ...
  describe("Filters", () => {
    ...
    describe("String Filters", () => {
      it("maxLength", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.maxLength).type.not.toBeCallableWith(5)
        )
      ...
      it("minLength", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.minLength).type.not.toBeCallableWith(5)
        )
      ...
      it("length", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.length).type.not.toBeCallableWith(5)
        )
      ...
      it("pattern", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.pattern).type.not.toBeCallableWith(/a/)
        )
      ...
      it("startsWith", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.startsWith).type.not.toBeCallableWith("a")
        )
      ...
      it("endsWith", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.endsWith).type.not.toBeCallableWith("a")
        )
      ...
      it("includes", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.includes).type.not.toBeCallableWith("a")
        )
      ...
      it("lowercased", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lowercased).type.not.toBeCallableWith()
        )
      ...
      it("uppercased", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.uppercased).type.not.toBeCallableWith()
        )
      ...
      it("capitalized", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.capitalized).type.not.toBeCallableWith()
        )
      ...
      it("uncapitalized", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.uncapitalized).type.not.toBeCallableWith()
        )
      ...
      it("nonEmptyString", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.nonEmptyString).type.not.toBeCallableWith()
        )
      ...
      it("trimmed", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.trimmed).type.not.toBeCallableWith()
        )
    ...
    describe("Number Filters", () => {
      it("finite", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.finite).type.not.toBeCallableWith()
        )
      ...
      it("greaterThanOrEqualTo", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanOrEqualTo).type.not.toBeCallableWith(5)
        )
      ...
      it("lessThan", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThan).type.not.toBeCallableWith(5)
        )
      ...
      it("lessThanOrEqualTo", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanOrEqualTo).type.not.toBeCallableWith(5)
        )
      ...
      it("int", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.int).type.not.toBeCallableWith()
        )
      ...
      it("multipleOf", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.multipleOf).type.not.toBeCallableWith(5)
        )
      ...
      it("between", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.between).type.not.toBeCallableWith(1, 5)
        )
      ...
      it("nonNaN", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.nonNaN).type.not.toBeCallableWith()
        )
      ...
      it("positive", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.positive).type.not.toBeCallableWith()
        )
      ...
      it("negative", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.negative).type.not.toBeCallableWith()
        )
      ...
      it("nonPositive", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.nonPositive).type.not.toBeCallableWith()
        )
      ...
      it("nonNegative", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.nonNegative).type.not.toBeCallableWith()
        )
    ...
    describe("BigInt Filters", () => {
      it("greaterThanBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanBigInt).type.not.toBeCallableWith(5n)
        )
      ...
      it("greaterThanOrEqualToBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanOrEqualToBigInt).type.not.toBeCallableWith(5n)
        )
      ...
      it("lessThanBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanBigInt).type.not.toBeCallableWith(5n)
        )
      ...
      it("lessThanOrEqualToBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanOrEqualToBigInt).type.not.toBeCallableWith(5n)
        )
      ...
      it("betweenBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.betweenBigInt).type.not.toBeCallableWith(1n, 5n)
        )
      ...
      it("positiveBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.positiveBigInt).type.not.toBeCallableWith()
        )
      ...
      it("negativeBigInt", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.negativeBigInt).type.not.toBeCallableWith()
        )
    ...
    describe("Duration filters", () => {
      it("lessThanDuration", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanDuration).type.not.toBeCallableWith("10 millis")
        )
      ...
      it("lessThanOrEqualToDuration", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanOrEqualToDuration).type.not.toBeCallableWith(
            "10 millis"
          )
        )
      ...
      it("greaterThanDuration", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanDuration).type.not.toBeCallableWith("10 millis")
        )
      ...
      it("greaterThanOrEqualToDuration", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanOrEqualToDuration).type.not.toBeCallableWith(
            "10 millis"
          )
        )
      ...
      it("betweenDuration", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.betweenDuration).type.not.toBeCallableWith(
            "10 millis",
            "50 millis"
          )
        )
    ...
    describe("Array Filters", () => {
      describe("Array", () => {
        it("minItems", () => {
          when(pipe).isCalledWith(
            S.Null,
            expect(S.minItems).type.not.toBeCallableWith(2)
          )
        ...
        it("maxItems", () => {
          when(pipe).isCalledWith(
            S.Null,
            expect(S.maxItems).type.not.toBeCallableWith(2)
          )
        ...
        it("itemsCount", () => {
          when(pipe).isCalledWith(
            S.Null,
            expect(S.itemsCount).type.not.toBeCallableWith(2)
          )
    ...
    describe("Date Filters", () => {
      it("validDate", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.validDate).type.not.toBeCallableWith()
        )
      ...
      it("lessThanDate", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanDate).type.not.toBeCallableWith(new Date())
        )
      ...
      it("lessThanOrEqualToDate", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanOrEqualToDate).type.not.toBeCallableWith(new Date())
        )
      ...
      it("greaterThanDate", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanDate).type.not.toBeCallableWith(new Date())
        )
      ...
      it("greaterThanOrEqualToDate", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanOrEqualToDate).type.not.toBeCallableWith(
            new Date()
          )
        )
      ...
      it("betweenDate", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.betweenDate).type.not.toBeCallableWith(
            new Date(0),
            new Date(100)
          )
        )
    ...
    describe("BigDecimal Filters", () => {
      ...
      it("greaterThanBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanBigDecimal).type.not.toBeCallableWith(bd)
        )
      ...
      it("greaterThanOrEqualToBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.greaterThanOrEqualToBigDecimal).type.not.toBeCallableWith(bd)
        )
      ...
      it("lessThanBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanBigDecimal).type.not.toBeCallableWith(bd)
        )
      ...
      it("lessThanOrEqualToBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.lessThanOrEqualToBigDecimal).type.not.toBeCallableWith(bd)
        )
      ...
      it("positiveBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.positiveBigDecimal).type.not.toBeCallableWith()
        )
      ...
      it("nonNegativeBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.nonNegativeBigDecimal).type.not.toBeCallableWith()
        )
      ...
      it("negativeBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.negativeBigDecimal).type.not.toBeCallableWith()
        )
      ...
      it("nonPositiveBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.nonPositiveBigDecimal).type.not.toBeCallableWith()
        )
      ...
      it("betweenBigDecimal", () => {
        when(pipe).isCalledWith(
          S.Null,
          expect(S.betweenBigDecimal).type.not.toBeCallableWith(bd, bd)
        )
  ...
  describe("Transformations", () => {
    it("clamp", () => {
      when(S.String.pipe).isCalledWith(
        expect(S.clamp).type.not.toBeCallableWith(-1, 1)
      )
    ...
    it("clampDuration", () => {
      when(S.String.pipe).isCalledWith(
        expect(S.clampDuration).type.not.toBeCallableWith(-1, 1)
      )
    ...
    it("headOrElse", () => {
      ...
      when(S.Array(S.Number).pipe).isCalledWith(
        expect(S.headOrElse).type.not.toBeCallableWith(() => "a")
      )
