...
describe("SortedSet", () => {
  ...
  it("partition", () => {
    ...
    expect(
      ...
      [
        excluded: SortedSet.SortedSet<string | number>,
        satisfying: SortedSet.SortedSet<string | number>
      ]
    >()
  ...
  it("fromIterable", () => {
    ...
    ).type.toBe<SortedSet.SortedSet<string>>()
  ...
  it("filter", () => {
    ...
    ).type.toBe<SortedSet.SortedSet<string | number>>()
    ...
    ).type.toBe<SortedSet.SortedSet<number>>()
  })
})
