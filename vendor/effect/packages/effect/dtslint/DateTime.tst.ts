...
describe("DateTime", () => {
  it("min", () => {
    ...
    expect(utc.pipe(DateTime.min(zoned))).type.toBe<
      DateTime.Utc | DateTime.Zoned
    >()
    expect(zoned.pipe(DateTime.min(utc))).type.toBe<
      DateTime.Utc | DateTime.Zoned
    >()
  ...
  it("max", () => {
    ...
    expect(utc.pipe(DateTime.max(zoned))).type.toBe<
      DateTime.Utc | DateTime.Zoned
    >()
    expect(zoned.pipe(DateTime.max(utc))).type.toBe<
      DateTime.Utc | DateTime.Zoned
    >()
