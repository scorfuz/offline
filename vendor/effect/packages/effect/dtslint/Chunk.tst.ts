...
describe("Chunk", () => {
  it("every", () => {
    ...
    expect(
      Chunk.every(numbersOrStrings, (item) => {
  ...
  it("partition", () => {
    expect(
      Chunk.partition(numbersOrStrings, (item) => {
        expect(item).type.toBe<string | number>()
        return true
      })
    ).type.toBe<
      [
        excluded: Chunk.Chunk<string | number>,
        satisfying: Chunk.Chunk<string | number>
      ]
    >()
    expect(
      pipe(
  ...
  it("append", () => {
    expect(Chunk.append(numbersOrStrings, true)).type.toBe<
      Chunk.NonEmptyChunk<string | number | boolean>
    >()
    expect(pipe(numbersOrStrings, Chunk.append(true))).type.toBe<
      Chunk.NonEmptyChunk<string | number | boolean>
    >()
    expect(Chunk.append(true)(numbersOrStrings)).type.toBe<
      Chunk.NonEmptyChunk<string | number | boolean>
    >()
  })

  it("prepend", () => {
    expect(Chunk.prepend(numbersOrStrings, true)).type.toBe<
      Chunk.NonEmptyChunk<string | number | boolean>
    >()
    expect(pipe(numbersOrStrings, Chunk.prepend(true))).type.toBe<
      Chunk.NonEmptyChunk<string | number | boolean>
    >()
    expect(Chunk.prepend(true)(numbersOrStrings)).type.toBe<
      Chunk.NonEmptyChunk<string | number | boolean>
    >()
  })
  ...
  it("filter", () => {
    ...
    expect(Chunk.filter(numbersOrStrings, predicateNumbersOrStrings)).type.toBe<
    ...
    expect(Chunk.filter(numbers, predicateNumbersOrStrings)).type.toBe<
      Chunk.Chunk<number>
    >()
    expect(pipe(numbers, Chunk.filter(predicateNumbersOrStrings))).type.toBe<
      Chunk.Chunk<number>
    >()

    expect(Chunk.filter(numbersOrStrings, Predicate.isNumber)).type.toBe<
      Chunk.Chunk<number>
    >()
    expect(pipe(numbersOrStrings, Chunk.filter(Predicate.isNumber))).type.toBe<
      Chunk.Chunk<number>
    >()
  })
  ...
  it("takeWhile", () => {
    ...
    expect(Chunk.takeWhile(numbers, predicateNumbersOrStrings)).type.toBe<
      Chunk.Chunk<number>
    >()
    expect(pipe(numbers, Chunk.takeWhile(predicateNumbersOrStrings))).type.toBe<
      Chunk.Chunk<number>
    >()

    expect(Chunk.takeWhile(numbersOrStrings, Predicate.isNumber)).type.toBe<
      Chunk.Chunk<number>
    >()
    expect(
  ...
  it("findFirst", () => {
    ...
    expect(Chunk.findFirst(numbersOrStrings, Predicate.isNumber)).type.toBe<
  ...
  it("findLast", () => {
    ...
    expect(Chunk.findLast(numbersOrStrings, Predicate.isNumber)).type.toBe<
      Option.Option<number>
    >()
    expect(
  ...
  it("splitWhere", () => {
    ...
    expect(
      ...
      [
        beforeMatch: Chunk.Chunk<string | number>,
        fromMatch: Chunk.Chunk<string | number>
      ]
    >()
  ...
  it("prependAll", () => {
    // Chunk + Chunk
    expect(Chunk.prependAll(strings, numbers)).type.toBe<
      Chunk.Chunk<string | number>
    >()
    expect(pipe(strings, Chunk.prependAll(numbers))).type.toBe<
      Chunk.Chunk<string | number>
    >()
  ...
  it("appendAll", () => {
    // Chunk + Chunk
    expect(Chunk.appendAll(strings, numbers)).type.toBe<
      Chunk.Chunk<string | number>
    >()
    expect(pipe(strings, Chunk.appendAll(numbers))).type.toBe<
      Chunk.Chunk<string | number>
    >()
  ...
  it("flatten", () => {
    ...
    expect(
      pipe(
        hole<Chunk.NonEmptyChunk<Chunk.NonEmptyChunk<number>>>(),
        Chunk.flatten
      )
    ).type.toBe<Chunk.NonEmptyChunk<number>>()

    const nestedChunk =
      hole<Effect.Effect<Chunk.Chunk<Chunk.Chunk<number>>, never, never>>()
    const nestedNonEmptyChunk =
      hole<
        Effect.Effect<
          Chunk.NonEmptyChunk<Chunk.NonEmptyChunk<number>>,
          never,
          never
        >
      >()
    ...
    ).type.toBe<Effect.Effect<Chunk.NonEmptyChunk<number>, never, never>>()
  ...
  it("reverse", () => {
    ...
    // NonEmptyChunk
    expect(Chunk.reverse(nonEmptyNumbers)).type.toBe<
      Chunk.NonEmptyChunk<number>
    >()
    expect(pipe(nonEmptyNumbers, Chunk.reverse)).type.toBe<
      Chunk.NonEmptyChunk<number>
    >()
  })
  ...
  it("toArray", () => {
    // Chunk
    expect(Chunk.toArray(hole<Chunk.Chunk<string>>())).type.toBe<
      Array<string>
    >()
    expect(pipe(hole<Chunk.Chunk<string>>(), Chunk.toArray)).type.toBe<
      Array<string>
    >()

    // NonEmptyChunk
    expect(Chunk.toArray(hole<Chunk.NonEmptyChunk<string>>())).type.toBe<
      [string, ...Array<string>]
    >()
    expect(pipe(hole<Chunk.NonEmptyChunk<string>>(), Chunk.toArray)).type.toBe<
      [string, ...Array<string>]
    >()
  })
  ...
  it("toReadonlyArray", () => {
    // Chunk
    expect(Chunk.toReadonlyArray(hole<Chunk.Chunk<string>>())).type.toBe<
      ReadonlyArray<string>
    >()
    expect(pipe(hole<Chunk.Chunk<string>>(), Chunk.toReadonlyArray)).type.toBe<
      ReadonlyArray<string>
    >()
