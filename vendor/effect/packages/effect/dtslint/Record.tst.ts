...
describe("Record", () => {
  ...
  it("get", () => {
    ...
    when(pipe).isCalledWith(
      string$numbers,
      expect(Record.get).type.not.toBeCallableWith(symA)
    )
    ...
    when(pipe).isCalledWith(
      template$numbers,
      expect(Record.get).type.not.toBeCallableWith("b")
    )
    ...
    when(pipe).isCalledWith(
      symbol$numbers,
      expect(Record.get).type.not.toBeCallableWith("a")
    )
    ...
    when(pipe).isCalledWith(
      string$structAB,
      expect(Record.get).type.not.toBeCallableWith("c")
    )
  })
  ...
  it("modify, modifyOption, and replaceOption", () => {
    ...
    when(pipe).isCalledWith(
      template$numbers,
      expect(Record.modify).type.not.toBeCallableWith("b", () => true)
    )
    expect(
      pipe(
        symbol$numbers,
  ...
  it("replaceOption", () => {
    ...
    when(pipe).isCalledWith(
      template$numbers,
      expect(Record.replaceOption).type.not.toBeCallableWith("b", true)
    )
  ...
  it("remove", () => {
    ...
    when(pipe).isCalledWith(
      template$numbers,
      expect(Record.remove).type.not.toBeCallableWith("b")
    )
  ...
  it("pop", () => {
    ...
    when(pipe).isCalledWith(
      template$numbers,
      expect(Record.pop).type.not.toBeCallableWith("b")
    )
