...
describe("Predicate", () => {
  ...
  it("isNullable", () => {
    ...
    expect(numberOrUndefined.filter(Predicate.isNullable)).type.toBe<
      Array<undefined>
    >()
    expect(numberOrNullOrUndefined.filter(Predicate.isNullable)).type.toBe<
  ...
  it("isNotNullable", () => {
    expect(numberOrNull.filter(Predicate.isNotNullable)).type.toBe<
      Array<number>
    >()
    expect(numberOrUndefined.filter(Predicate.isNotNullable)).type.toBe<
      Array<number>
    >()
    expect(numberOrNullOrUndefined.filter(Predicate.isNotNullable)).type.toBe<
      Array<number>
    >()
  ...
  it("isRecord", () => {
    expect(unknowns.filter(Predicate.isRecord)).type.toBe<
      Array<{ [x: string]: unknown; [x: symbol]: unknown }>
    >()
  })
