...
describe("Serializable", () => {
  ...
  test("serializeFailure", () => {
    const req = new GetPersonById({ id: 123 })
    deepStrictEqual(Effect.runSync(S.serializeFailure(req, "fail")), "fail")
  })
  ...
  test("serializeExit", () => {
    ...
    deepStrictEqual(Effect.runSync(S.serializeExit(req, Exit.fail("fail"))), {
      _tag: "Failure",
  ...
  test("deserializeFailure", () => {
    const req = new GetPersonById({ id: 123 })
    deepStrictEqual(Effect.runSync(S.deserializeFailure(req, "fail")), "fail")
  })

  test("deserializeSuccess", () => {
    const req = new GetPersonById({ id: 123 })
    deepStrictEqual(
      Effect.runSync(S.deserializeSuccess(req, { id: 123, name: "foo" })),
