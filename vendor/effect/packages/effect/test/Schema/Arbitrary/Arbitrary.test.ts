  ...
  describe("getDescription", () => {
    describe("String", () => {
      ...
      it("String & annotation & minLength(2)", () => {
        const f = () => (fc: typeof FastCheck) => fc.constant("a")
        const schema = S.String.annotations({ arbitrary: f }).pipe(
          S.minLength(2)
        )
        const ast = schema.ast
        assertTrue(SchemaAST.isRefinement(ast))
...
details: Generating an Arbitrary for this schema requires at least one enum`)
    ...
    describe("Unrefined Primitives", () => {
      ...
      describe("Tuple", () => {
        ...
        it("optional element with undefined", () => {
          const schema = S.Tuple(
            S.optionalElement(S.Union(S.Number, S.Undefined))
          )
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
      ...
      describe("suspend", () => {
        it("should support an arbitrary annotation", () => {
          ...
          const schema = S.Struct({
            a: S.String,
            as: S.Array(
              S.suspend((): S.Schema<A> => schema).annotations({
                arbitrary: () => () => arb
              })
            )
          })
        ...
        it("Record", () => {
          ...
          const schema = S.Record({
            key: S.String,
            value: S.suspend((): S.Schema<A> => schema)
          })
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
    ...
    describe("Data Types", () => {
      ...
      describe("Suspend", () => {
        ...
        it("SortedSetFromSelf", () => {
          const Rec = S.suspend((): any => schema)
          const schema: any = S.SortedSetFromSelf(
            Rec,
            Order.empty(),
            Order.empty()
          )
    ...
    describe("Refinement", () => {
      ...
      describe("array filters", () => {
        ...
        it("minItems (Array)", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeArrayConstraints({ minLength: 2 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("maxItems (Array)", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeArrayConstraints({ maxLength: 5 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("itemsCount (Array)", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeArrayConstraints({ minLength: 3, maxLength: 3 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
      ...
      describe("string filters", () => {
        ...
        it("length: number", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeStringConstraints({ minLength: 10, maxLength: 10 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("length: { min, max }", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeStringConstraints({ minLength: 2, maxLength: 5 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("annotation + minLength + maxLength", () => {
          const schema = S.String.annotations({
            arbitrary: () => (fc) => fc.string()
          }).pipe(S.minLength(2), S.maxLength(5))
          assertConstraints(schema, [
            Arbitrary.makeStringConstraints({ minLength: 2 }),
            Arbitrary.makeStringConstraints({ maxLength: 5 })
          ])
        ...
        it("startsWith", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeStringConstraints({ pattern: "^a" })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
      ...
      describe("number filters", () => {
        ...
        it("nonNaN", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeNumberConstraints({ noNaN: true })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("finite", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeNumberConstraints({
              noNaN: true,
        ...
        it("lessThanOrEqualTo", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeNumberConstraints({ max: 5 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("greaterThanOrEqualTo", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeNumberConstraints({ min: 2 })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("lessThan", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeNumberConstraints({ max: 5, maxExcluded: true })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("greaterThan", () => {
          ...
          assertConstraints(schema, [
            Arbitrary.makeNumberConstraints({ min: 2, minExcluded: true })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
      ...
      describe("bigint filters", () => {
        ...
        it("lessThanOrEqualTo", () => {
          const schema = S.BigIntFromSelf.pipe(
            S.lessThanOrEqualToBigInt(BigInt(5))
          )
          assertConstraints(schema, [
            Arbitrary.makeBigIntConstraints({ max: BigInt(5) })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("greaterThanOrEqualTo", () => {
          const schema = S.BigIntFromSelf.pipe(
            S.greaterThanOrEqualToBigInt(BigInt(2))
          )
          assertConstraints(schema, [
            Arbitrary.makeBigIntConstraints({ min: BigInt(2) })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
        ...
        it("between", () => {
          const schema = S.BigIntFromSelf.pipe(
            S.betweenBigInt(BigInt(2), BigInt(5))
          )
          assertConstraints(schema, [
            Arbitrary.makeBigIntConstraints({ min: BigInt(2), max: BigInt(5) })
          ])
          Util.assertions.arbitrary.validateGeneratedValues(schema)
        })
      })
      ...
      describe("date filters", () => {
        ...
        it("lessThanOrEqualTo", () => {
          const schema = S.DateFromSelf.pipe(
            S.lessThanOrEqualToDate(new Date(5))
          )
          assertConstraints(schema, [
            Arbitrary.makeDateConstraints({ noInvalidDate: false }),
        ...
        it("greaterThanOrEqualTo", () => {
          const schema = S.DateFromSelf.pipe(
            S.greaterThanOrEqualToDate(new Date(2))
          )
          assertConstraints(schema, [
            Arbitrary.makeDateConstraints({ noInvalidDate: false }),
        ...
        it("between", () => {
          const schema = S.DateFromSelf.pipe(
            S.betweenDate(new Date(2), new Date(5))
          )
          assertConstraints(schema, [
            Arbitrary.makeDateConstraints({ noInvalidDate: false }),
            Arbitrary.makeDateConstraints({
              min: new Date(2),
              max: new Date(5)
            })
          ])
    ...
    describe("Annotations", () => {
      const assertAnnotation = <A, I>(source: S.Schema<A, I>) => {
        const schema = source.annotations({
          arbitrary: () => (fc) => fc.constant("custom arbitrary") as any
        })
      ...
      it("UniqueSymbolFromSelf", () => {
        assertAnnotation(
          S.UniqueSymbolFromSelf(Symbol.for("effect/schema/test/a"))
        )
      })
