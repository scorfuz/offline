...
schema (Union): boolean | symbol`)
  ...
  it("getTemplateLiteralRegExp", () => {
    ...
    expectPattern(
      [S.Literal("a", "b"), "c", S.Literal("d", "e")],
      "^(a|b)c(d|e)$"
    )
    expectPattern(
      [S.Literal("a", "b"), S.String, S.Literal("d", "e")],
      "^(a|b)[\\s\\S]*?(d|e)$"
    )
    ...
    expectPattern(
      [S.Union(S.Literal("a", "b"), S.Literal(1, 2))],
      "^(a|b|1|2)$"
    )
    expectPattern(
      [
    ...
    expectPattern(
      [
        "-",
        S.Union(
          S.TemplateLiteral("a", S.Literal("b", "c")),
          S.TemplateLiteral("d", S.Literal("e", "f"))
        )
      ],
      "^-(a(b|c)|d(e|f))$"
    )
  ...
  describe("AST and toString", () => {
    it(`"a"`, () => {
      const expectedAST = new AST.TemplateLiteral("", [
        new AST.TemplateLiteralSpan(S.Literal("a").ast, "")
      ])
    ...
    it(`"a" + "b"`, () => {
      const expectedAST = new AST.TemplateLiteral("a", [
        new AST.TemplateLiteralSpan(S.Literal("b").ast, "")
      ])
    ...
    it(`("a" | "b) + "c" + ("d" | "e")`, () => {
      ...
      expectAST(
        [S.Literal("a", "b"), S.Literal("c"), S.Literal("d", "e")],
        expectedAST,
        expectedString
      )
      expectAST(
    ...
    it(`"a" + string`, () => {
      const expectedAST = new AST.TemplateLiteral("a", [
        new AST.TemplateLiteralSpan(AST.stringKeyword, "")
      ])
    ...
    it(`"a" + string + "b"`, () => {
      ...
      expectAST(
        [S.Literal("a"), S.String, S.Literal("b")],
        expectedAST,
        expectedString
      )
    ...
    it(`"a" + string + "b" + number`, () => {
      ...
      expectAST(
        [S.Literal("a"), S.String, S.Literal("b"), S.Number],
        expectedAST,
        expectedString
      )
    ...
    it(`string + "a"`, () => {
      const expectedAST = new AST.TemplateLiteral("", [
        new AST.TemplateLiteralSpan(AST.stringKeyword, "a")
      ])
    ...
    it(`number + "a"`, () => {
      const expectedAST = new AST.TemplateLiteral("", [
        new AST.TemplateLiteralSpan(AST.numberKeyword, "a")
      ])
    ...
    it(`(("a" | "b") | "c")`, () => {
      const expectedAST = new AST.TemplateLiteral("", [
        new AST.TemplateLiteralSpan(
          S.Union(S.Union(S.Literal("a"), S.Literal("b")), S.Literal("c")).ast,
          ""
        )
      ])
      const expectedString = '`${"a" | "b" | "c"}`'
      expectAST(
        [S.Union(S.Union(S.Literal("a"), S.Literal("b")), S.Literal("c"))],
        expectedAST,
        expectedString
      )
    })
    ...
    it("`${number}`", () => {
      const expectedAST = new AST.TemplateLiteral("", [
        new AST.TemplateLiteralSpan(S.Number.ast, "")
      ])
