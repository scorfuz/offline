...
└─ Encoded side transformation failure
  ...
  it("users can override an instance member property", () => {
    class OverrideBase1 extends S.Class<OverrideBase1>("OverrideBase1")(
      S.Struct({
        a: S.String
      })
    ) {
  ...
  it("users can override an instance member function", () => {
    class OverrideBase2 extends S.Class<OverrideBase2>("OverrideBase2")(
      S.Struct({
        a: S.String
      })
    ) {
  ...
  it("users can override a field with an instance member property", () => {
    class OverrideBase3 extends S.Class<OverrideBase3>("OverrideBase3")(
      S.Struct({
        a: S.String
      })
    ) {}
  ...
  it("users can't override an instance member property with a field", () => {
    class OverrideBase4 extends S.Class<OverrideBase4>("OverrideBase4")(
      S.Struct({
        a: S.String
      })
    ) {
