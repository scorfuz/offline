  ...
  describe("`error` option", () => {
    describe("should register the actual value", () => {
      it("struct", () => {
        ...
        const input = { a: "a", b: 1 }
        const e = ParseResult.decodeUnknownEither(schema)(
          input,
        ...
        assertLeft(
          ...
          new ParseResult.Composite(
            ...
            new ParseResult.Pointer(
              "b",
              input,
              new ParseResult.Unexpected(1, `is unexpected, expected: "a"`)
            ),
            {}
          )
        )
        ...
        assertLeft(
          ...
          new ParseResult.Composite(
            ...
            new ParseResult.Pointer(
              1,
              input,
              new ParseResult.Unexpected(1, `is unexpected, expected: 0`)
            ),
            []
          )
        )
