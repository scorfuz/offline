...
describe("RedBlackTree", () => {
  ...
  it("values", () => {
    ...
    strictEqual(RedBlackTree.size(tree), 5)
    deepStrictEqual(Array.from(RedBlackTree.values(tree)), [
      "d",
      "c",
      "b",
      "a",
  ...
  it("greaterThan", () => {
    ...
    deepStrictEqual(Array.from(RedBlackTree.greaterThanReversed(0)(tree)), [
      [1, "a"],
      [0, "b"],
      [-1, "c"],
      [-2, "d"]
  ...
  it("lessThan", () => {
    ...
    deepStrictEqual(Array.from(RedBlackTree.lessThanReversed(0)(tree)), [
      [-1, "c"],
      [-2, "d"]
    ])
  })
  ...
  it("lessThanEqual", () => {
    ...
    deepStrictEqual(Array.from(RedBlackTree.lessThanEqualReversed(0)(tree)), [
      [0, "b"],
      [-1, "c"],
      [-2, "d"]
    ])
  ...
  it("findAll", () => {
    ...
    deepStrictEqual(
      Array.from(RedBlackTree.findAll(1n)(bigintTree)),
      [1, 2, 3, 4, 5]
    )
  })
  ...
  it("findAll Eq/Ord", () => {
    ...
    deepStrictEqual(
      Array.from(
        RedBlackTree.values(RedBlackTree.removeFirst(new Key(1, "1"))(tree))
      ),
      ["f", "e", "b", "a", "c", "d"]
    )
    deepStrictEqual(
      Array.from(
        RedBlackTree.values(RedBlackTree.removeFirst(new Key(1, "0"))(tree))
      ),
      ["g", "f", "e", "b", "c", "d"]
    )
  })
