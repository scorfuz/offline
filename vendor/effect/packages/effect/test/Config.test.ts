...
describe("Config", () => {
    ...
    it("name != undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.MissingData(
          ["BOOL"],
          "Expected BOOL to exist in the provided map"
        )
      )
      assertConfigError(
        config,
    ...
    it("name != undefined", () => {
      ...
      assertConfig(
        ...
        [
          [
            "WEBSITE_URL",
            "https://effect.website/docs/introduction#what-is-effect"
          ]
        ],
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          ["WEBSITE_URL"],
          `Expected an URL value but received "abra-kadabra"`
        )
      )
      assertConfigError(
        config,
        ...
        ConfigError.MissingData(
          ["WEBSITE_URL"],
          "Expected WEBSITE_URL to exist in the provided map"
        )
      )
    })
  })
  ...
  describe("port", () => {
    it("name != undefined", () => {
      ...
      assertConfig(config, [["WEBSITE_PORT", "123"]], 123)
      assertConfigError(
        config,
        [["WEBSITE_PORT", "abra-kadabra"]],
        ConfigError.InvalidData(
          ["WEBSITE_PORT"],
          `Expected a network port value but received "abra-kadabra"`
        )
      )
      assertConfigError(
        config,
        ...
        ConfigError.MissingData(
          ["WEBSITE_PORT"],
          "Expected WEBSITE_PORT to exist in the provided map"
        )
      )
    })
  })
  ...
  describe("branded", () => {
    it("name != undefined", () => {
      ...
      assertConfig(config, [["STR", "123"]], Str("123"))
      assertConfigError(
        config,
        [["STR", "1"]],
        ConfigError.InvalidData(
          ["STR"],
          "Brand: Expected 1 to be longer than 2"
        )
      )
      assertConfigError(
        config,
        ...
        ConfigError.MissingData(
          ["STR"],
          "Expected STR to exist in the provided map"
        )
      )
    })
  ...
  describe("nonEmptyString", () => {
    it("name = undefined", () => {
      ...
      assertConfigError(
        config,
        [["ITEMS", ""]],
        ConfigError.MissingData(["ITEMS"], "Expected a non-empty string")
      )
    })
  ...
  describe("number", () => {
    it("name = undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          ["ITEMS"],
          `Expected a number value but received "123qq"`
        )
      )
      assertConfigError(
        config,
        ...
        ConfigError.InvalidData(
          ["ITEMS"],
          `Expected a number value but received "value"`
        )
      )
    })
    ...
    it("name != undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.MissingData(
          ["NUMBER"],
          "Expected NUMBER to exist in the provided map"
        )
      )
      assertConfigError(
        config,
  ...
  describe("literal", () => {
    it("name = undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          ["ITEMS"],
          `Expected one of (a, b) but received "value"`
        )
      )
    })

    it("name != undefined", () => {
      const config = Config.literal(
        "a",
        0,
        -0.3,
        BigInt(5),
      ...
      assertConfigError(
        ...
        ConfigError.MissingData(
          ["LITERAL"],
          "Expected LITERAL to exist in the provided map"
        )
      )
      assertConfigError(
        config,
        ...
        ConfigError.InvalidData(
          ["LITERAL"],
          `Expected one of (a, 0, -0.3, 5, false, null) but received "value"`
        )
      )
    })
  })
  ...
  describe("date", () => {
    it("name = undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          [],
          `Expected a Date value but received "value"`
        )
      )
    })
    ...
    it("name != undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.MissingData(
          ["DATE"],
          "Expected DATE to exist in the provided map"
        )
      )
      assertConfigError(
        config,
  ...
  it("fail", () => {
    ...
    assertConfigError(
      config,
      [],
      ConfigError.MissingData([], "failure message")
    )
  })

  it("mapAttempt", () => {
    const config = Config.string("STRING").pipe(
      Config.mapAttempt((s) => {
    ...
    assertConfigError(
      ...
      ConfigError.MissingData(
        ["STRING"],
        "Expected STRING to exist in the provided map"
      )
    )
  })
  ...
  describe("logLevel", () => {
    it("name = undefined", () => {
      ...
      assertConfigError(
        config,
        [["", "-"]],
        ConfigError.InvalidData([], `Expected a log level but received "-"`)
      )
    })
    ...
    it("name != undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          ["LOG_LEVEL"],
          `Expected a log level but received "-"`
        )
      )
    })
  })
  ...
  describe("duration", () => {
    it("name = undefined", () => {
      ...
      assertConfigError(
        config,
        [["", "-"]],
        ConfigError.InvalidData([], `Expected a duration but received "-"`)
      )
    })
    ...
    it("name != undefined", () => {
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          ["DURATION"],
          `Expected a duration but received "-"`
        )
      )
    })
  })
  ...
  describe("validate", () => {
    it("should preserve the original path", () => {
      ...
      const nested = flat.pipe(Config.nested("NESTED1"))
  ...
  describe("withDefault", () => {
    it("recovers from missing data error", () => {
      const config = pipe(Config.integer("key"), Config.withDefault(0))
      // available data
    ...
    it("does not recover from other errors", () => {
      ...
      assertConfigError(
        ...
        ConfigError.InvalidData(
          ["key"],
          `Expected an integer value but received "1.2"`
        )
      )
      assertConfigError(
        config,
        ...
        ConfigError.InvalidData(
          ["key"],
          `Expected an integer value but received "value"`
        )
      )
    })
    ...
    it("does not recover from missing data and other error", () => {
      ...
      assertConfigError(
        ...
        ConfigError.And(
          ConfigError.MissingData(
            ["key1"],
            "Expected key1 to exist in the provided map"
          ),
          ConfigError.InvalidData(
            ["key2"],
            `Expected an integer value but received "value"`
    ...
    it("does not recover from other errors", () => {
      ...
      assertConfigError(
        ...
        ConfigError.And(
          ...
          ConfigError.MissingData(
            ["key2"],
            "Expected key2 to exist in the provided map"
          )
        )
      )
      assertConfigError(
  ...
  it("withDescription", () => {
    const config = Config.number("NUMBER").pipe(
      Config.withDescription("my description")
    )
