...
describe("Stream", () => {
  ...
  it.effect(
    "whenCase - returns the resulting stream if the given partial function is defined for the given value",
    () =>
      Effect.gen(function* () {
        const result = yield* pipe(
          Stream.whenCase(
  ...
  it.effect(
    "whenCase - returns an empty stream if the given partial function is not defined for the given value",
    () =>
      Effect.gen(function* () {
        const result = yield* pipe(
          Stream.whenCase(
  ...
  it.effect(
    "whenCase - dies if evaluating the given value throws an exception",
    () =>
      Effect.gen(function* () {
        const error = new Cause.RuntimeException("boom")
        const result = yield* pipe(
  ...
  it.effect("whenCase - dies if the partial function throws an exception", () =>
    Effect.gen(function* () {
      const error = new Cause.RuntimeException("boom")
      const result = yield* pipe(
        Stream.whenCase(constVoid, (): Option.Option<Stream.Stream<void>> => {
          throw error
        }),
        Stream.runDrain,
        Effect.exit
  ...
  it.effect(
    "whenCaseEffect - returns the resulting stream if the given partial function is defined for the given effectful value",
    () =>
      Effect.gen(function* () {
        const result = yield* pipe(
          Effect.succeed(Option.some(1)),
          Stream.whenCaseEffect((option) =>
            Option.isSome(option)
              ? Option.some(Stream.make(option.value))
              : Option.none()
          ),
  ...
  it.effect(
    "whenCaseEffect - returns an empty stream if the given partial function is not defined for the given effectful value",
    () =>
      Effect.gen(function* () {
        const result = yield* pipe(
  ...
  it.effect(
    "whenCaseEffect - dies if the given partial function throws an exception",
    () =>
      Effect.gen(function* () {
        const error = new Cause.RuntimeException("boom")
        const result = yield* pipe(
  ...
  it.effect(
    "whenEffect - returns the stream if the effectful condition is satisfied",
    () =>
      Effect.gen(function* () {
        const result = yield* pipe(
          Stream.make(1, 2, 3, 4, 5),
  ...
  it.effect(
    "whenEffect - returns an empty stream if the effectful condition is not satisfied",
    () =>
      Effect.gen(function* () {
        const result = yield* pipe(
          Stream.make(1, 2, 3, 4, 5),
