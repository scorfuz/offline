...
const makeRepeats = (
  blocks: number,
  length: number
): STM.STM<TArray.TArray<number>> =>
  TArray.fromIterable(
    Array.from({ length: blocks * length }, (_, i) => (i % length) + 1)
  )

const makeStair = (length: number): STM.STM<TArray.TArray<number>> =>
  TArray.fromIterable(Array.from({ length }, (_, i) => i + 1))

const makeStairWithHoles = (
  length: number
): STM.STM<TArray.TArray<Option.Option<number>>> =>
  TArray.fromIterable(
...
const valuesOf = <A>(array: TArray.TArray<A>): STM.STM<Array<A>> =>
  pipe(
    array,
    TArray.reduce<Array<A>, A>([], (acc, a) => [...acc, a])
  )
...
describe("TArray", () => {
  ...
  it.effect("countSTM - computes correct sum", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.countSTM((n) => STM.succeed(n % 2 === 0))
      )
      strictEqual(result, 5)
    })
  )
  ...
  it.effect("countSTM - zero when the predicate does not match", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.countSTM((i) => STM.succeed(i > n))
      )
      strictEqual(result, 0)
    })
  )
  ...
  it.effect("countSTM - zero for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.countSTM(() => STM.succeed(true))
      )
      strictEqual(result, 0)
    })
  )
  ...
  it.effect("everySTM - detects satisfaction", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.everySTM((i) => STM.succeed(i < n + 1))
      )
      assertTrue(result)
    })
  )
  ...
  it.effect("everySTM - detects lack of satisfaction", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.everySTM(() => STM.succeed(false))
      )
      assertTrue(result)
    })
  )
  ...
  it.effect("everySTM - fails for errors before counterexample", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.everySTM((n) =>
          n === 4 ? STM.fail("boom") : STM.succeed(n !== 5)
        ),
        STM.flip
      )
      strictEqual(result, "boom")
  ...
  it.effect("everySTM - fails for errors after counterexample", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.everySTM((n) =>
          n === 6 ? STM.fail("boom") : STM.succeed(n === 5)
        ),
        STM.flip
      )
      strictEqual(result, "boom")
  ...
  it.effect("get - happy path", () =>
    Effect.gen(function* () {
      const result = yield* pipe(makeTArray(1, 42), STM.flatMap(TArray.get(0)))
  ...
  it.effect("findFirstIndexWhere - determines the correct index", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhere((n) => n % 5 === 0)
      )
      assertSome(result, 4)
    })
  )
  ...
  it.effect("findFirstIndexWhere - none for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhere((i) => i > n)
      )
      assertNone(result)
    })
  )
  ...
  it.effect(
    "findFirstIndexWhereFrom - determines the correct index, with offset",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
        const result = yield* pipe(
          array,
          TArray.findFirstIndexWhereFrom((n) => n % 2 === 0, 5)
        )
        assertSome(result, 5)
      })
  )
  ...
  it.effect("findFirstIndexWhereFrom - none if absent after offset", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereFrom((n) => n % 7 === 0, 7)
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findFirstIndexWhereFrom - none for a negative offset", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereFrom(constTrue, -1)
      )
      assertNone(result)
    })
  )
  ...
  it.effect(
    "findFirstIndexWhereFrom - none for an offset that is too large",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
        const result = yield* pipe(
          array,
          TArray.findFirstIndexWhereFrom(constTrue, n + 1)
        )
        assertNone(result)
      })
  )
  ...
  it.effect("findFirstIndexWhereSTM - determines the correct index", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereSTM((n) => STM.succeed(n % 5 === 0))
      )
      assertSome(result, 4)
    })
  )
  ...
  it.effect("findFirstIndexWhereSTM - none for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereSTM(() => STM.succeed(true))
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findFirstIndexWhereSTM - none for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereSTM((i) => STM.succeed(i > n))
      )
      assertNone(result)
    })
  )
  ...
  it.effect(
    "findFirstIndexWhereSTM - fails on errors before result found",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
        const result = yield* pipe(
          array,
          TArray.findFirstIndexWhereSTM((n) =>
            n === 4 ? STM.fail("boom") : STM.succeed(n % 5 === 0)
          ),
          STM.flip
        )
        strictEqual(result, "boom")
  ...
  it.effect(
    "findFirstIndexWhereSTM - succeeds on errors after result found",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
        const result = yield* pipe(
          array,
          TArray.findFirstIndexWhereSTM((n) =>
            n === 6 ? STM.fail("boom") : STM.succeed(n % 5 === 0)
          )
        )
        assertSome(result, 4)
      })
  ...
  it.effect(
    "findFirstIndexWhereFromSTM - determines the correct index, with offset",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
        const result = yield* pipe(
          array,
          TArray.findFirstIndexWhereFromSTM((n) => STM.succeed(n % 2 === 0), 5)
        )
        assertSome(result, 5)
      })
  )
  ...
  it.effect("findFirstIndexWhereFromSTM - none if absent after offset", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereFromSTM((n) => STM.succeed(n % 7 === 0), 7)
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findFirstIndexWhereFromSTM - none for a negative offset", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstIndexWhereFromSTM(() => STM.succeed(true), -1)
      )
      assertNone(result)
    })
  )
  ...
  it.effect(
    "findFirstIndexWherFromeSTM - none for an offset that is too large",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
        const result = yield* pipe(
          array,
          TArray.findFirstIndexWhereFromSTM(() => STM.succeed(true), n + 1)
        )
        assertNone(result)
      })
  )
  ...
  it.effect(
    "findFirstIndexWhereFromSTM - succeeds when error excluded by offset",
    () =>
      Effect.gen(function* () {
        const n = 10
        const array = yield* makeStair(n)
  ...
  it.effect("findFirstSTM - is correct", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstSTM((n) => STM.succeed(n % 5 === 0))
      )
      assertSome(result, 5)
    })
  )
  ...
  it.effect("findFirstSTM - succeeds for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstSTM(() => STM.succeed(true))
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findFirstSTM - fails to find absent", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findFirstSTM((i) => STM.succeed(i > n))
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findLastSTM - is correct", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findLastSTM((n) => STM.succeed(n % 5 === 0))
      )
      assertSome(result, 10)
    })
  )
  ...
  it.effect("findLastSTM - succeeds for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findLastSTM(() => STM.succeed(true))
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findLastSTM - fails to find absent", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findLastSTM((i) => STM.succeed(i > n))
      )
      assertNone(result)
    })
  )
  ...
  it.effect("findLastSTM - succeeds on errors before result found", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findLastSTM((n) =>
          n === 4 ? STM.fail("boom") : STM.succeed(n % 7 === 0)
        )
      )
      assertSome(result, 7)
    })
  ...
  it.effect("findLastSTM - fails on errors after result found", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.findLastSTM((n) =>
          n === 8 ? STM.fail("boom") : STM.succeed(n % 7 === 0)
        ),
        STM.flip
      )
      strictEqual(result, "boom")
  ...
  it.effect("get - should fail when the index is out of bounds", () =>
    Effect.gen(function* () {
      ...
      deepStrictEqual(
        result,
        Exit.die(new Cause.RuntimeException("Index out of bounds"))
      )
    })
  )
  ...
  it.effect("reduceOptionSTM - reduces correctly", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.reduceOptionSTM((x, y) => STM.succeed(x + y))
      )
      assertSome(result, (n * (n + 1)) / 2)
    })
  )
  ...
  it.effect("reduceOptionSTM - fails on errors", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.reduceOptionSTM((x, y) =>
          y === 4 ? STM.fail("boom") : STM.succeed(x + y)
        ),
        STM.flip
      )
      strictEqual(result, "boom")
  ...
  it.effect("reduceSTM - is atomic", () =>
    Effect.gen(function* () {
      ...
      const fiber = yield* pipe(
        array,
        TArray.reduceSTM(0, (x, y) => STM.succeed(x + y)),
        Effect.fork
      )
      yield* pipe(
        Chunk.range(0, n - 1),
  ...
  it.effect("reduceSTM - returns failures", () =>
    Effect.gen(function* () {
      const n = 1_000
      const failInTheMiddle = (
        acc: number,
        n: number
      ): STM.STM<number, string> =>
        acc === Math.floor(n / 2) ? STM.fail("boom") : STM.succeed(acc + n)
      const array = yield* makeTArray(n, 1)
      const result = yield* pipe(
        array,
        TArray.reduceSTM(0, failInTheMiddle),
        STM.either
      )
  ...
  it.effect("someSTM - detects satisfaction", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.someSTM((n) => STM.succeed(n % 2 === 0))
      )
      assertTrue(result)
    })
  )
  ...
  it.effect("someSTM - detects lack of satisfaction", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.someSTM((n) => STM.succeed(n % 11 === 0))
      )
      assertFalse(result)
    })
  )
  ...
  it.effect("someSTM - false for empty array", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.someSTM(() => STM.succeed(true))
      )
      assertFalse(result)
    })
  )
  ...
  it.effect("transformSTM - updates values atomically", () =>
    Effect.gen(function* () {
      ...
      const fiber = yield* pipe(
        array,
        TArray.transformSTM((s) => STM.succeed(s + "+b")),
        Effect.fork
      )
      yield* pipe(
        Chunk.range(0, n - 1),
  ...
  it.effect("transformSTM - updates all or nothing", () =>
    Effect.gen(function* () {
      ...
      yield* pipe(
        array,
        TArray.update(Math.floor(n / 2), () => 1)
      )
      const result = yield* pipe(
        array,
        TArray.transformSTM((n) =>
          n === 0 ? STM.succeed(42) : STM.fail("boom")
        ),
        STM.either
      )
      const first = yield* pipe(array, TArray.get(0))
  ...
  it.effect("updateSTM - dies with index out of bounds", () =>
    Effect.gen(function* () {
      ...
      const result = yield* pipe(
        array,
        TArray.updateSTM(-1, (n) => STM.succeed(n)),
        Effect.exit
      )
      deepStrictEqual(
        result,
