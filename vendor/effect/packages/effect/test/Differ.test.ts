...
describe("Differ", () => {
  ...
  describe("hashMap", () => {
    diffLaws(
      Differ.hashMap<number, number, (n: number) => number>(
  ...
  describe("hashSet", () => {
    diffLaws(Differ.hashSet<number>(), randomHashSet, Equal.equals)
  })
  ...
  describe("tuple", () => {
    diffLaws(
      Differ.update<number>().pipe(Differ.zip(Differ.update<number>())),
      randomPair,
