  ...
  describe("replay", () => {
        ...
        Effect.flatMap((pubsub) =>
          Effect.scoped(
            Effect.gen(function* () {
              ...
              deepStrictEqual(
                Chunk.toReadonlyArray(yield* Queue.takeUpTo(dequeue1, 2)),
                [3, 4]
              )
              deepStrictEqual(
                Chunk.toReadonlyArray(yield* Queue.takeUpTo(dequeue1, 2)),
              ...
              deepStrictEqual(
                Chunk.toReadonlyArray(yield* Queue.takeUpTo(dequeue2, 3)),
                [4, 5, 6]
              )
            })
          )
    ...
    it.scoped("dropping", () =>
      Effect.gen(function* () {
        ...
        deepStrictEqual(
          Chunk.toReadonlyArray(yield* Queue.takeAll(sub2)),
          [5, 6, 7]
        )
        ...
        deepStrictEqual(
          Chunk.toReadonlyArray(yield* Queue.takeAll(sub3)),
          [7, 8, 9]
        )
      })
    )
