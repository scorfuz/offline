...
describe("Duration", () => {
  it("decode", () => {
    ...
    throws(
      () => Duration.decode("1.5 secs" as any),
      new Error("Invalid DurationInput")
    )
    throws(
      () => Duration.decode(true as any),
      new Error("Invalid DurationInput")
    )
  ...
  it("decodeUnknown", () => {
    ...
    assertSome(
      Duration.decodeUnknown([500, 123456789]),
      Duration.nanos(500123456789n)
    )
  ...
  it("Equivalence", () => {
    deepStrictEqual(
      Duration.Equivalence(Duration.millis(1), Duration.millis(1)),
      true
    )
    deepStrictEqual(
      Duration.Equivalence(Duration.millis(1), Duration.millis(2)),
      false
    )
    deepStrictEqual(
      Duration.Equivalence(Duration.millis(1), Duration.millis(2)),
    ...
    deepStrictEqual(
      Duration.Equivalence(Duration.nanos(1n), Duration.nanos(1n)),
      true
    )
    deepStrictEqual(
      Duration.Equivalence(Duration.nanos(1n), Duration.nanos(2n)),
      false
    )
    deepStrictEqual(
      Duration.Equivalence(Duration.nanos(1n), Duration.nanos(2n)),
  ...
  it("unsafeDivide", () => {
    deepStrictEqual(
      Duration.unsafeDivide(Duration.minutes(1), 2),
      Duration.seconds(30)
    )
    deepStrictEqual(
      Duration.unsafeDivide(Duration.seconds(1), 3),
      Duration.nanos(333333333n)
    )
    deepStrictEqual(
      Duration.unsafeDivide(Duration.nanos(2n), 2),
      Duration.nanos(1n)
    )
    deepStrictEqual(Duration.unsafeDivide(Duration.nanos(1n), 3), Duration.zero)
    deepStrictEqual(
      Duration.unsafeDivide(Duration.infinity, 2),
      Duration.infinity
    )
    deepStrictEqual(Duration.unsafeDivide(Duration.zero, 2), Duration.zero)
    deepStrictEqual(
      Duration.unsafeDivide(Duration.minutes(1), 0),
      Duration.infinity
    )
    deepStrictEqual(
      Duration.unsafeDivide(Duration.minutes(1), -0),
    ...
    deepStrictEqual(
      Duration.unsafeDivide(Duration.nanos(1n), 0),
      Duration.infinity
    )
    deepStrictEqual(
      Duration.unsafeDivide(Duration.nanos(1n), -0),
    ...
    deepStrictEqual(
      Duration.unsafeDivide(Duration.minutes(1), 0.5),
      Duration.minutes(2)
    )
    deepStrictEqual(
      Duration.unsafeDivide(Duration.minutes(1), 1.5),
      Duration.seconds(40)
    )
    deepStrictEqual(
      Duration.unsafeDivide(Duration.minutes(1), NaN),
      Duration.zero
    )
  ...
  it("times", () => {
    ...
    deepStrictEqual(
      Duration.times(Duration.seconds(Infinity), 60),
  ...
  it("sum", () => {
    ...
    deepStrictEqual(
      Duration.sum(Duration.seconds(Infinity), Duration.seconds(30)),
      Duration.seconds(Infinity)
    )
    deepStrictEqual(
      Duration.sum(Duration.seconds(30), Duration.seconds(Infinity)),
      Duration.seconds(Infinity)
    )
  ...
  it("subtract", () => {
    ...
    deepStrictEqual(
      Duration.subtract(Duration.seconds(Infinity), Duration.seconds(30)),
      Duration.seconds(Infinity)
    )
    deepStrictEqual(
      Duration.subtract(Duration.seconds(30), Duration.seconds(Infinity)),
      Duration.zero
    )

    deepStrictEqual(
      Duration.subtract("30 seconds", "10 seconds"),
      Duration.seconds(20)
    )
  })
  ...
  it("greaterThan", () => {
    assertTrue(
      pipe(Duration.seconds(30), Duration.greaterThan(Duration.seconds(20)))
    )
    assertFalse(
      pipe(Duration.seconds(30), Duration.greaterThan(Duration.seconds(30)))
    )
    assertFalse(
      pipe(Duration.seconds(30), Duration.greaterThan(Duration.seconds(60)))
    )

    assertTrue(
      pipe(Duration.nanos(30n), Duration.greaterThan(Duration.nanos(20n)))
    )
    assertFalse(
      pipe(Duration.nanos(30n), Duration.greaterThan(Duration.nanos(30n)))
    )
    assertFalse(
      pipe(Duration.nanos(30n), Duration.greaterThan(Duration.nanos(60n)))
    )

    assertTrue(
      pipe(Duration.millis(1), Duration.greaterThan(Duration.nanos(1n)))
    )
  ...
  it("greaterThan - Infinity", () => {
    assertTrue(
      pipe(Duration.infinity, Duration.greaterThan(Duration.seconds(20)))
    )
    assertFalse(
      pipe(Duration.seconds(-Infinity), Duration.greaterThan(Duration.infinity))
    )
    assertFalse(
      pipe(Duration.nanos(1n), Duration.greaterThan(Duration.infinity))
    )
  })
  ...
  it("greaterThanOrEqualTo", () => {
    assertTrue(
      pipe(
        Duration.seconds(30),
        Duration.greaterThanOrEqualTo(Duration.seconds(20))
      )
    )
    assertTrue(
      pipe(
        Duration.seconds(30),
        Duration.greaterThanOrEqualTo(Duration.seconds(30))
      )
    )
    assertFalse(
      pipe(
        Duration.seconds(30),
        Duration.greaterThanOrEqualTo(Duration.seconds(60))
      )
    )
    ...
    assertTrue(
      pipe(
        Duration.nanos(30n),
        Duration.greaterThanOrEqualTo(Duration.nanos(20n))
      )
    )
    assertTrue(
      pipe(
        Duration.nanos(30n),
        Duration.greaterThanOrEqualTo(Duration.nanos(30n))
      )
    )
    assertFalse(
      pipe(
        Duration.nanos(30n),
        Duration.greaterThanOrEqualTo(Duration.nanos(60n))
      )
    )
  ...
  it("lessThan", () => {
    assertTrue(
      pipe(Duration.seconds(20), Duration.lessThan(Duration.seconds(30)))
    )
    assertFalse(
      pipe(Duration.seconds(30), Duration.lessThan(Duration.seconds(30)))
    )
    assertFalse(
      pipe(Duration.seconds(60), Duration.lessThan(Duration.seconds(30)))
    )

    assertTrue(
      pipe(Duration.nanos(20n), Duration.lessThan(Duration.nanos(30n)))
    )
    assertFalse(
      pipe(Duration.nanos(30n), Duration.lessThan(Duration.nanos(30n)))
    )
    assertFalse(
      pipe(Duration.nanos(60n), Duration.lessThan(Duration.nanos(30n)))
    )
  ...
  it("lessThanOrEqualTo", () => {
    assertTrue(
      pipe(
        Duration.seconds(20),
        Duration.lessThanOrEqualTo(Duration.seconds(30))
      )
    )
    assertTrue(
      pipe(
    ...
    assertTrue(
      pipe(Duration.nanos(20n), Duration.lessThanOrEqualTo(Duration.nanos(30n)))
    )
    assertTrue(
      pipe(Duration.nanos(30n), Duration.lessThanOrEqualTo(Duration.nanos(30n)))
    )
    assertFalse(
      pipe(Duration.nanos(60n), Duration.lessThanOrEqualTo(Duration.nanos(30n)))
    )
  ...
  it("sum/ Infinity", () => {
    deepStrictEqual(
      Duration.sum(Duration.seconds(1), Duration.infinity),
      Duration.infinity
    )
  })
  ...
  it("unsafeToNanos", () => {
    ...
    strictEqual(
      Duration.millis(1.0005).pipe(Duration.unsafeToNanos),
      1_000_500n
    )
