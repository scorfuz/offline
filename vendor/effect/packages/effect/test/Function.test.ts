...
describe("Function", () => {
  ...
  it("pipe()", () => {
    ...
    deepStrictEqual(
      pipe(2, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g),
      1022
    )
    deepStrictEqual(
      pipe(2, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f),
      1023
    )
    deepStrictEqual(
      pipe(2, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g),
      2046
    )
    deepStrictEqual(
      pipe(2, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f),
      2047
    )
    deepStrictEqual(
      (Function.pipe as any)(
        ...[2, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g, f, g]
      ),
      4094
    )
  })
  ...
  it("flow", () => {
    ...
    deepStrictEqual(
      (Function.flow as any)(...[f, g, f, g, f, g, f, g, f, g]),
      undefined
    )
  })
  ...
  describe("dual", () => {
    ...
    it("arity: 0", () => {
      throws(
        () =>
          Function.dual<() => () => number, () => number>(0, (): number => 2),
        new RangeError("Invalid arity 0")
      )
    })
    ...
    it("arity: 1", () => {
      throws(
        ...
        new RangeError("Invalid arity 1")
      )
    })
    ...
    it("arity: 5", () => {
      ...
      // should ignore excess arguments
      deepStrictEqual(
        f.apply(null, ["_", "a", "b", "c", "d", "e"] as any),
        "_abcd"
      )
    })
