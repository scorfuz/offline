...
describe("Struct", () => {
  it("pick", () => {
    deepStrictEqual(pipe({ a: "a", b: 1, c: true }, Struct.pick("a", "b")), {
      a: "a",
      b: 1
    })
    deepStrictEqual(Struct.pick({ a: "a", b: 1, c: true }, "a", "b"), {
      a: "a",
      b: 1
    })
    ...
    deepStrictEqual(pipe(optionalStringStruct1, Struct.pick("a", "b")), {
      b: 1
    })
    ...
    deepStrictEqual(pipe(optionalStringStruct2, Struct.pick("a", "b")), {
      a: "a",
      b: 1
    })
    ...
    deepStrictEqual(pipe(optionalSymbolStruct2, Struct.pick(a, "b")), {
      [a]: "a",
      b: 1
    })
  })
  ...
  it("omit", () => {
    deepStrictEqual(pipe({ a: "a", b: 1, c: true }, Struct.omit("c")), {
      a: "a",
      b: 1
    })
    deepStrictEqual(Struct.omit({ a: "a", b: 1, c: true }, "c"), {
      a: "a",
      b: 1
    })
    ...
    deepStrictEqual(pipe(optionalStringStruct2, Struct.omit("c")), {
      a: "a",
      b: 1
    })
    ...
    deepStrictEqual(pipe(optionalSymbolStruct2, Struct.omit("c")), {
      [a]: "a",
      b: 1
    })
  })
  ...
  it("entries", () => {
    ...
    deepStrictEqual(Struct.entries({ a: "a", b: 1, [c]: 2 }), [
      ["a", "a"],
      ["b", 1]
    ])
  })
