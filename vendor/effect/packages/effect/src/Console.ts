 ...
 * @category default services
 */
export const setConsole: <A extends Console>(console: A) => Layer.Layer<never> =
  internal.setConsole
...
) => Effect<A, E, R> = internal.consoleWith
 ...
 * @category accessor
 */
export const debug: (...args: ReadonlyArray<any>) => Effect<void> =
  internal.debug
 ...
 * @category accessor
 */
export const dirxml: (...args: ReadonlyArray<any>) => Effect<void> =
  internal.dirxml
 ...
 * @category accessor
 */
export const error: (...args: ReadonlyArray<any>) => Effect<void> =
  internal.error
...
) => Effect<void> = internal.table

/**
 * @since 2.0.0
 * @category accessor
 */
export const time: (label?: string | undefined) => Effect<void, never, Scope> =
  internal.time
...
export const timeLog: (
  label?: string,
  ...args: ReadonlyArray<any>
) => Effect<void> = internal.timeLog

/**
 * @since 2.0.0
 * @category accessor
 */
export const trace: (...args: ReadonlyArray<any>) => Effect<void> =
  internal.trace
