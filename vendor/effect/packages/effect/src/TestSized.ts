...
export const TestSized: Context.Tag<TestSized, TestSized> =
  Context.GenericTag("effect/TestSized")
 ...
 * @since 2.0.0
 */
export const make = (size: number): TestSized =>
  new SizedImpl(core.fiberRefUnsafeMake(size))

/**
 * @since 2.0.0
 */
export const fromFiberRef = (fiberRef: FiberRef.FiberRef<number>): TestSized =>
