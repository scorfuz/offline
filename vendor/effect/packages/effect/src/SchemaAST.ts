 ...
 * @experimental
 */
export const TypeConstructorAnnotationId: unique symbol = Symbol.for(
 ...
 * @since 3.10.0
 */
export const BrandAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Brand"
)
 ...
 * @since 3.10.0
 */
export const SchemaIdAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/SchemaId"
)
 ...
 * @since 3.10.0
 */
export const MessageAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Message"
)
 ...
 * @since 3.10.0
 */
export const MissingMessageAnnotationId: unique symbol = Symbol.for(
 ...
 * @since 3.10.0
 */
export const IdentifierAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Identifier"
)
 ...
 * @since 3.10.0
 */
export const TitleAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Title"
)

/** @internal */
export const AutoTitleAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/AutoTitle"
)
 ...
 * @since 3.10.0
 */
export const DescriptionAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Description"
)
 ...
 * @since 3.10.0
 */
export const ExamplesAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Examples"
)
 ...
 * @since 3.10.0
 */
export const DefaultAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Default"
)
 ...
 * @since 3.10.0
 */
export const JSONSchemaAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/JSONSchema"
)
 ...
 * @since 3.10.0
 */
export type EquivalenceAnnotation<
  A,
 ...
 * @since 3.10.0
 */
export const EquivalenceAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Equivalence"
)
 ...
 * @since 3.10.0
 */
export const DocumentationAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Documentation"
)
 ...
 * @since 3.10.0
 */
export const ConcurrencyAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Concurrency"
)
 ...
 * @since 3.10.0
 */
export const BatchingAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Batching"
)
 ...
 * @since 3.10.0
 */
export const ParseIssueTitleAnnotationId: unique symbol = Symbol.for(
 ...
 * @since 3.10.0
 */
export const ParseOptionsAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/ParseOptions"
)
 ...
 * @since 3.10.0
 */
export const DecodingFallbackAnnotationId: unique symbol = Symbol.for(
 ...
 * @since 3.10.0
 */
export const SurrogateAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/Surrogate"
)
...
/** @internal */
export const StableFilterAnnotationId: unique symbol = Symbol.for(
  "effect/annotation/StableFilter"
)
 ...
 * @experimental
 */
export const getTypeConstructorAnnotation =
  getAnnotation<TypeConstructorAnnotation>(TypeConstructorAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getBrandAnnotation =
  getAnnotation<BrandAnnotation>(BrandAnnotationId)

/**
 * @category annotations
 * @since 3.14.2
 */
export const getSchemaIdAnnotation =
  getAnnotation<SchemaIdAnnotation>(SchemaIdAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getMessageAnnotation =
  getAnnotation<MessageAnnotation>(MessageAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getMissingMessageAnnotation =
  getAnnotation<MissingMessageAnnotation>(MissingMessageAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getTitleAnnotation =
  getAnnotation<TitleAnnotation>(TitleAnnotationId)

/** @internal */
export const getAutoTitleAnnotation = getAnnotation<TitleAnnotation>(
  AutoTitleAnnotationId
)
 ...
 * @since 3.10.0
 */
export const getExamplesAnnotation =
  getAnnotation<ExamplesAnnotation<unknown>>(ExamplesAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getDefaultAnnotation =
  getAnnotation<DefaultAnnotation<unknown>>(DefaultAnnotationId)
 ...
 * @since 3.10.0
 */
export const getDocumentationAnnotation =
  getAnnotation<DocumentationAnnotation>(DocumentationAnnotationId)
 ...
 * @since 3.10.0
 */
export const getBatchingAnnotation =
  getAnnotation<BatchingAnnotation>(BatchingAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getParseIssueTitleAnnotation =
  getAnnotation<ParseIssueTitleAnnotation>(ParseIssueTitleAnnotationId)

/**
 * @category annotations
 * @since 3.10.0
 */
export const getParseOptionsAnnotation = getAnnotation<ParseOptions>(
 ...
 * @since 3.10.0
 */
export const getDecodingFallbackAnnotation = getAnnotation<
  DecodingFallbackAnnotation<unknown>
 ...
 * @since 3.10.0
 */
export const getSurrogateAnnotation = getAnnotation<SurrogateAnnotation>(
  SurrogateAnnotationId
)

const getStableFilterAnnotation = getAnnotation<StableFilterAnnotation>(
 ...
 * @since 3.10.0
 */
export const JSONIdentifierAnnotationId: unique symbol = Symbol.for(
 ...
 * @since 3.10.0
 */
export const getJSONIdentifierAnnotation = getAnnotation<IdentifierAnnotation>(
...
export const getJSONIdentifier = (annotated: Annotated) =>
  Option.orElse(getJSONIdentifierAnnotation(annotated), () =>
 ...
 * @since 3.10.0
 */
export const ParseJsonSchemaId: unique symbol = Symbol.for(
 ...
 * @since 3.10.0
 */
export const isDeclaration: (ast: AST) => ast is Declaration =
  createASTGuard("Declaration")
...
export class Literal implements Annotated {
  ...
  toString() {
    return Option.getOrElse(getExpected(this), () =>
      Inspectable.formatUnknown(this.literal)
    )
  }
  /**
   * @since 3.10.0
  ...
  toJSON(): object {
    return {
      _tag: this._tag,
      literal: Predicate.isBigInt(this.literal)
        ? String(this.literal)
        : this.literal,
      annotations: toJSONAnnotations(this.annotations)
    }
...
export class UniqueSymbol implements Annotated {
  ...
  toString() {
    return Option.getOrElse(getExpected(this), () =>
      Inspectable.formatUnknown(this.symbol)
    )
  }
  /**
   * @since 3.10.0
 ...
 * @since 3.10.0
 */
export const isUniqueSymbol: (ast: AST) => ast is UniqueSymbol =
  createASTGuard("UniqueSymbol")
...
export const isUndefinedKeyword: (ast: AST) => ast is UndefinedKeyword =
  createASTGuard("UndefinedKeyword")
 ...
 * @since 3.10.0
 */
export const isVoidKeyword: (ast: AST) => ast is VoidKeyword =
  createASTGuard("VoidKeyword")
 ...
 * @since 3.10.0
 */
export const isNeverKeyword: (ast: AST) => ast is NeverKeyword =
  createASTGuard("NeverKeyword")
 ...
 * @since 3.10.0
 */
export const isUnknownKeyword: (ast: AST) => ast is UnknownKeyword =
 ...
 * @since 3.10.0
 */
export const isAnyKeyword: (ast: AST) => ast is AnyKeyword =
 ...
 * @since 3.10.0
 */
export const isStringKeyword: (ast: AST) => ast is StringKeyword =
 ...
 * @since 3.10.0
 */
export const isNumberKeyword: (ast: AST) => ast is NumberKeyword =
  createASTGuard("NumberKeyword")
 ...
 * @since 3.10.0
 */
export const isBooleanKeyword: (ast: AST) => ast is BooleanKeyword =
  createASTGuard("BooleanKeyword")
 ...
 * @since 3.10.0
 */
export const isBigIntKeyword: (ast: AST) => ast is BigIntKeyword =
  createASTGuard("BigIntKeyword")
 ...
 * @since 3.10.0
 */
export const isSymbolKeyword: (ast: AST) => ast is SymbolKeyword =
  createASTGuard("SymbolKeyword")
 ...
 * @since 3.10.0
 */
export const isObjectKeyword: (ast: AST) => ast is ObjectKeyword =
  createASTGuard("ObjectKeyword")
...
type TemplateLiteralSpanBaseType =
  | StringKeyword
  | NumberKeyword
  | Literal
  | TemplateLiteral
...
type TemplateLiteralSpanType =
  | TemplateLiteralSpanBaseType
  | Union<TemplateLiteralSpanType>

const isTemplateLiteralSpanType = (
  ast: AST
): ast is TemplateLiteralSpanType => {
  switch (ast._tag) {
    case "Literal":
    case "NumberKeyword":
    case "StringKeyword":
...
const templateLiteralSpanUnionTypeToString = (
  type: TemplateLiteralSpanType
): string => {
  switch (type._tag) {
    case "Literal":
...
const templateLiteralSpanTypeToString = (
  type: TemplateLiteralSpanType
): string => {
  switch (type._tag) {
    case "Literal":
    ...
    case "Union":
      return (
        "${" +
        type.types.map(templateLiteralSpanUnionTypeToString).join(" | ") +
        "}"
      )
  }
}
...
export const isTemplateLiteral: (ast: AST) => ast is TemplateLiteral =
  createASTGuard("TemplateLiteral")
...
const getRestASTs = (rest: ReadonlyArray<Type>): ReadonlyArray<AST> =>
...
export class TupleType implements Annotated {
  ...
  constructor(
    ...
    if (hasIllegalRequiredElement || (hasOptionalElement && rest.length > 1)) {
      throw new Error(
        errors_.getASTRequiredElementFollowinAnOptionalElementErrorMessage
      )
    }
  }
  /**
 ...
 * @since 3.10.0
 */
export const isTupleType: (ast: AST) => ast is TupleType =
  createASTGuard("TupleType")
  ...
  constructor(
    ...
    for (let i = 0; i < propertySignatures.length; i++) {
      ...
      if (Object.prototype.hasOwnProperty.call(keys, name)) {
        throw new Error(
          errors_.getASTDuplicatePropertySignatureErrorMessage(name)
        )
      }
      keys[name] = null
    }
    ...
    for (let i = 0; i < indexSignatures.length; i++) {
      ...
      if (isStringKeyword(encodedParameter)) {
        if (parameters.string) {
          throw new Error(
            errors_.getASTDuplicateIndexSignatureErrorMessage("string")
          )
        }
        ...
        if (parameters.symbol) {
          throw new Error(
            errors_.getASTDuplicateIndexSignatureErrorMessage("symbol")
          )
        }
...
const formatIndexSignatures = (iss: ReadonlyArray<IndexSignature>): string =>
  iss.map(String).join("; ")
 ...
 * @since 3.10.0
 */
export const isTypeLiteral: (ast: AST) => ast is TypeLiteral =
  createASTGuard("TypeLiteral")
...
/** @internal */
export const mapMembers = <A, B>(
  members: Members<A>,
  f: (a: A) => B
): Members<B> => members.map(f) as any

/** @internal */
export const isMembers = <A>(as: ReadonlyArray<A>): as is Members<A> =>
  as.length > 1
...
export class Suspend implements Annotated {
  ...
  toString() {
    return getExpected(this).pipe(
      Option.orElse(() =>
        Option.flatMap(Option.liftThrowable(this.f)(), (ast) =>
          getExpected(ast)
        )
      ),
 ...
 * @since 3.10.0
 */
export const isRefinement: (ast: AST) => ast is Refinement<AST> =
  createASTGuard("Refinement")
 ...
 * @since 3.10.0
 */
export const isTransformation: (ast: AST) => ast is Transformation =
  createASTGuard("Transformation")
...
const createTransformationGuard =
  ...
  (ast: TransformationKind): ast is Extract<TransformationKind, { _tag: T }> =>
    ast._tag === tag
 ...
 * @since 3.10.0
 */
export const isFinalTransformation: (
  ast: TransformationKind
) => ast is FinalTransformation = createTransformationGuard(
  "FinalTransformation"
)
 ...
 * @since 3.10.0
 */
export const composeTransformation: ComposeTransformation =
  new ComposeTransformation()

/**
 * @category guards
 * @since 3.10.0
 */
export const isComposeTransformation: (
  ast: TransformationKind
) => ast is ComposeTransformation = createTransformationGuard(
  "ComposeTransformation"
)
...
const isRenamingPropertySignatureTransformation = (
  t: PropertySignatureTransformation
...
export class TypeLiteralTransformation {
  ...
  constructor(
    ...
    for (const pst of propertySignatureTransformations) {
      ...
      if (fromKeys[from]) {
        throw new Error(
          errors_.getASTDuplicatePropertySignatureTransformationErrorMessage(
            from
          )
        )
      }
      ...
      if (toKeys[to]) {
        throw new Error(
          errors_.getASTDuplicatePropertySignatureTransformationErrorMessage(to)
        )
      }
      toKeys[to] = true
    }
...
export const isTypeLiteralTransformation: (
  ast: TransformationKind
) => ast is TypeLiteralTransformation = createTransformationGuard(
  "TypeLiteralTransformation"
)
...
const getTemplateLiteralSpanTypePattern = (
  type: TemplateLiteralSpanType,
  capture: boolean
): string => {
  switch (type._tag) {
...
const getTemplateLiteralPattern = (
  ast: TemplateLiteral,
  capture: boolean,
  top: boolean
): string => {
 ...
 * @since 3.10.0
 */
export const getTemplateLiteralCapturingRegExp = (
  ast: TemplateLiteral
): RegExp => new RegExp(`^${getTemplateLiteralPattern(ast, true, true)}$`)
  ...
  switch (ast._tag) {
    ...
    case "Union":
      return new PropertySignature(
        name,
        Union.make(
          ast.types.map((ast) => getPropertyKeyIndexedAccess(ast, name).type)
        ),
        false,
        true
      )
...
export const record = (
  ...
  const go = (key: AST): void => {
    switch (key._tag) {
      ...
      case "Literal":
        if (
          Predicate.isString(key.literal) ||
          Predicate.isNumber(key.literal)
        ) {
          propertySignatures.push(
            new PropertySignature(key.literal, value, false, true)
          )
        } else {
          throw new Error(
            errors_.getASTUnsupportedLiteralErrorMessage(key.literal)
          )
        }
        break
      case "Enums": {
        for (const [_, name] of key.enums) {
          propertySignatures.push(
            new PropertySignature(name, value, false, true)
          )
        }
        break
      }
      case "UniqueSymbol":
        propertySignatures.push(
          new PropertySignature(key.symbol, value, false, true)
        )
        break
      case "Union":
  ...
  switch (ast._tag) {
    ...
    case "Union":
      return new TypeLiteral(
        keys.map((name) => getPropertyKeyIndexedAccess(ast, name)),
        []
      )
    case "Suspend":
    ...
    case "Transformation": {
      switch (ast.transformation._tag) {
        ...
        case "TypeLiteralTransformation": {
          ...
          for (const k of keys) {
            const t = ast.transformation.propertySignatureTransformations.find(
              (t) => t.to === k
            )
            if (t) {
              ts.push(t)
...
export const omit = (
  ...
  if (indexSignatures.length > 0) {
    if (
      indexSignatures.some((is) =>
        isStringKeyword(getEncodedParameter(is.parameter))
      )
    ) {
      indexSignatures = indexSignatures.filter(
        (is) => !isTemplateLiteral(getEncodedParameter(is.parameter))
      )
    }
  ...
  return pick(
    ast,
    getPropertyKeys(ast).filter((name) => !keys.includes(name))
  )
}

/** @internal */
export const orUndefined = (ast: AST): AST =>
  Union.make([ast, undefinedKeyword])
  ...
  switch (ast._tag) {
    case "TupleType":
      return new TupleType(
        ast.elements.map(
          (e) => new OptionalType(exact ? e.type : orUndefined(e.type), true)
        ),
        Arr.match(ast.rest, {
          onEmpty: () => ast.rest,
          onNonEmpty: (rest) => [
            new Type(Union.make([...getRestASTs(rest), undefinedKeyword]))
          ]
        }),
        ast.isReadonly
      )
    ...
    case "Transformation": {
      if (
        ...
        return new Transformation(
          partial(ast.from, options),
          partial(ast.to, options),
          ast.transformation
        )
      }
      throw new Error(errors_.getASTUnsupportedSchemaErrorMessage(ast))
...
export const mutable = (ast: AST): AST => {
  switch (ast._tag) {
    case "TupleType":
      return ast.isReadonly === false
        ? ast
        : new TupleType(ast.elements, ast.rest, false, ast.annotations)
    case "TypeLiteral": {
      ...
      const indexSignatures = changeMap(ast.indexSignatures, (is) =>
        is.isReadonly === false
          ? is
          : new IndexSignature(is.parameter, is.type, false)
      )
...
export const pickAnnotations =
  ...
  (annotated: Annotated): Annotations | undefined => {
...
export const typeAST = (ast: AST): AST => {
  switch (ast._tag) {
    ...
    case "Transformation": {
      ...
      return typeAST(
        preserve !== undefined ? annotations(ast.to, preserve) : ast.to
      )
    }
  }
  return ast
  ...
  switch (ast._tag) {
    ...
    case "Refinement": {
      ...
      if (isBound) {
        ...
        if (
          getTransformationFrom(ast.from) === undefined &&
          hasStableFilter(ast)
        ) {
...
export const equals = (self: AST, that: AST): boolean => {
  switch (self._tag) {
    ...
    case "TemplateLiteral":
      return (
        isTemplateLiteral(that) &&
        that.head === self.head &&
        equalsTemplateLiteralSpan(that.spans, self.spans)
      )
    case "Enums":
...
const equalsTemplateLiteralSpan = Arr.getEquivalence<TemplateLiteralSpan>(
  (self, that): boolean => {
    return self.literal === that.literal && equals(self.type, that.type)
  }
)

const equalsEnums = Arr.getEquivalence<readonly [string, string | number]>(
  (self, that) => that[0] === self[0] && that[1] === self[1]
)
  ...
  switch (ast._tag) {
    ...
    case "TypeLiteral":
      return ast.propertySignatures
        .map(
          (p): AST =>
            Predicate.isSymbol(p.name)
              ? new UniqueSymbol(p.name)
              : new Literal(p.name)
        )
        .concat(
          ast.indexSignatures.map((is) => getEncodedParameter(is.parameter))
        )
    case "Suspend":
      return _keyof(ast.f())
    case "Union":
...
/** @internal */
export const compose = (ab: AST, cd: AST): AST =>
  new Transformation(ab, cd, composeTransformation)

/** @internal */
export const rename = (
  ast: AST,
  mapping: { readonly [K in PropertyKey]?: PropertyKey }
): AST => {
  switch (ast._tag) {
    case "TypeLiteral": {
      ...
      for (const key of Reflect.ownKeys(mapping)) {
        ...
        if (name !== undefined) {
          propertySignatureTransformations.push(
            new PropertySignatureTransformation(key, name, identity, identity)
          )
        }
      }
...
const formatKeyword = (ast: AST): string =>
  Option.getOrElse(getExpected(ast), () => ast._tag)
...
function getBrands(ast: Annotated): string {
  return Option.match(getBrandAnnotation(ast), {
    ...
    onSome: (brands) =>
      brands
        .map((brand) => ` & Brand<${Inspectable.formatUnknown(brand)}>`)
        .join("")
  })
}
