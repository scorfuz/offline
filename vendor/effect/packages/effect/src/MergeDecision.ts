...
export interface MergeDecision<
  ...
  out E,
  out Z
> extends MergeDecision.Variance<R, E0, Z0, E, Z> {}
...
) => MergeDecision<R, unknown, unknown, E, Z> = internal.Done
...
export const AwaitConst: <Z, E, R>(
  effect: Effect.Effect<Z, E, R>
) => MergeDecision<R, unknown, unknown, E, Z> = internal.AwaitConst
...
export const isMergeDecision: (
  u: unknown
) => u is MergeDecision<unknown, unknown, unknown, unknown, unknown> =
