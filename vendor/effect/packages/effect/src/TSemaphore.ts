 ...
 * @category getters
 */
export const available: (self: TSemaphore) => STM.STM<number> =
  internal.available
...
export const withPermitScoped: (
  self: TSemaphore
) => Effect.Effect<void, never, Scope.Scope> = internal.withPermitScoped
...
export const withPermitsScoped: {
  (
    permits: number
  ): (self: TSemaphore) => Effect.Effect<void, never, Scope.Scope>
 ...
 * @category unsafe
 */
export const unsafeMake: (permits: number) => TSemaphore =
