 ...
 * @internal
 */
export const empty = <Input, Output>(): Differ.Context.Patch<Input, Output> =>
  _empty
...
export interface AndThen<
  ...
  in out Output,
  in out Output2
> extends Differ.Context.Patch<Input, Output2> {
...
/** @internal */
export interface AddService<in out Env, in out T, in out I> extends Differ
  .Context.Patch<Env, Env | I> {
...
/** @internal */
export interface RemoveService<in out Env, in out I> extends Differ.Context
  .Patch<Env, Exclude<Env, I>> {
...
/** @internal */
export interface UpdateService<in out Env, in out T, in out I> extends Differ
  .Context.Patch<Env | I, Env | I> {
...
export const patch = Dual.dual<
  ...
  ) => <Output>(self: Differ.Context.Patch<Input, Output>) => Context<Output>,
  <Input, Output>(
    self: Differ.Context.Patch<Input, Output>,
    context: Context<Input>
  ) => Context<Output>
