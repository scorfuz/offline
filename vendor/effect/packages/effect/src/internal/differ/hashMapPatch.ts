...
interface Empty<Key, Value, Patch> extends Differ.Differ.HashMap.Patch<
  Key,
  Value,
  Patch
> {
...
/** @internal */
export const empty = <Key, Value, Patch>(): Differ.Differ.HashMap.Patch<
  Key,
  Value,
  Patch
> => _empty

interface AndThen<Key, Value, Patch> extends Differ.Differ.HashMap.Patch<
  Key,
  Value,
  Patch
> {
...
interface Add<Key, Value, Patch> extends Differ.Differ.HashMap.Patch<
  Key,
  Value,
  Patch
> {
...
interface Remove<Key, Value, Patch> extends Differ.Differ.HashMap.Patch<
  Key,
  Value,
  Patch
> {
...
interface Update<Key, Value, Patch> extends Differ.Differ.HashMap.Patch<
  Key,
  Value,
  Patch
> {
...
>(
  ...
  <Key, Value, Patch>(
    ...
    let map = oldValue
    let patches: Chunk.Chunk<Differ.Differ.HashMap.Patch<Key, Value, Patch>> =
      Chunk.of(self)
