...
/** @internal */
export const makeAdd = <Value>(value: Value): Differ.HashSet.Patch<Value> => {
...
type Instruction = Add<any> | AndThen<any> | Empty<any> | Remove<any>
...
export const diff = <Value>(
  ...
  return HashSet.reduce(patch, (patch, value: Value) =>
    combine(makeRemove(value))(patch)
  )(removed)
}
...
export const combine = Dual.dual<
  ...
  ) => (self: Differ.HashSet.Patch<Value>) => Differ.HashSet.Patch<Value>,
  <Value>(
...
export const patch = Dual.dual<
  <Value>(
    oldValue: HashSet.HashSet<Value>
  ) => (self: Differ.HashSet.Patch<Value>) => HashSet.HashSet<Value>,
  <Value>(
    self: Differ.HashSet.Patch<Value>,
    oldValue: HashSet.HashSet<Value>
