 ...
 * @internal
 */
export const empty = <Value, Patch>(): Differ.Differ.Chunk.Patch<
  Value,
  Patch
> => _empty

interface AndThen<Value, Patch> extends Differ.Differ.Chunk.Patch<
  Value,
  Patch
> {
...
>(
  ...
  <Value, Patch>(
    ...
    let chunk = oldValue
    let patches: Chunk.Chunk<Differ.Differ.Chunk.Patch<Value, Patch>> =
      Chunk.of(self)
