...
/** @internal */
export const ReadonlyArrayPatchTypeId: Differ.Differ.ReadonlyArray.TypeId =
  Symbol.for(
...
interface Empty<Value, Patch> extends Differ.Differ.ReadonlyArray.Patch<
  Value,
  Patch
> {
  readonly _tag: "Empty"
 ...
 * @internal
 */
export const empty = <Value, Patch>(): Differ.Differ.ReadonlyArray.Patch<
  Value,
  Patch
> => _empty

interface AndThen<Value, Patch> extends Differ.Differ.ReadonlyArray.Patch<
  Value,
  Patch
> {
...
interface Append<Value, Patch> extends Differ.Differ.ReadonlyArray.Patch<
  Value,
  Patch
> {
...
interface Slice<Value, Patch> extends Differ.Differ.ReadonlyArray.Patch<
  Value,
  Patch
> {
  readonly _tag: "Slice"
...
interface Update<Value, Patch> extends Differ.Differ.ReadonlyArray.Patch<
  Value,
  Patch
> {
...
/** @internal */
export const diff = <Value, Patch>(options: {
