...
/** @internal */
export const MetricKeyTypeTypeId: MetricKeyType.MetricKeyTypeTypeId =
  Symbol.for(MetricKeyTypeSymbolKey) as MetricKeyType.MetricKeyTypeTypeId

/** @internal */
const CounterKeyTypeSymbolKey = "effect/MetricKeyType/Counter"

/** @internal */
export const CounterKeyTypeTypeId: MetricKeyType.CounterKeyTypeTypeId =
  Symbol.for(CounterKeyTypeSymbolKey) as MetricKeyType.CounterKeyTypeTypeId

/** @internal */
const FrequencyKeyTypeSymbolKey = "effect/MetricKeyType/Frequency"

/** @internal */
export const FrequencyKeyTypeTypeId: MetricKeyType.FrequencyKeyTypeTypeId =
  Symbol.for(FrequencyKeyTypeSymbolKey) as MetricKeyType.FrequencyKeyTypeTypeId
...
/** @internal */
export const HistogramKeyTypeTypeId: MetricKeyType.HistogramKeyTypeTypeId =
  Symbol.for(HistogramKeyTypeSymbolKey) as MetricKeyType.HistogramKeyTypeTypeId

/** @internal */
const SummaryKeyTypeSymbolKey = "effect/MetricKeyType/Summary"

/** @internal */
export const SummaryKeyTypeTypeId: MetricKeyType.SummaryKeyTypeTypeId =
  Symbol.for(SummaryKeyTypeSymbolKey) as MetricKeyType.SummaryKeyTypeTypeId
...
/** @internal */
class CounterKeyType<A extends number | bigint> implements MetricKeyType
  .MetricKeyType.Counter<A> {
  readonly [MetricKeyTypeTypeId] = metricKeyTypeVariance
  readonly [CounterKeyTypeTypeId]: MetricKeyType.CounterKeyTypeTypeId =
...
class FrequencyKeyType implements MetricKeyType.MetricKeyType.Frequency {
  readonly [MetricKeyTypeTypeId] = metricKeyTypeVariance
  readonly [FrequencyKeyTypeTypeId]: MetricKeyType.FrequencyKeyTypeTypeId =
...
/** @internal */
class GaugeKeyType<A extends number | bigint> implements MetricKeyType
  .MetricKeyType.Gauge<A> {
  readonly [MetricKeyTypeTypeId] = metricKeyTypeVariance
  readonly [GaugeKeyTypeTypeId]: MetricKeyType.GaugeKeyTypeTypeId =
    GaugeKeyTypeTypeId
...
export class HistogramKeyType implements MetricKeyType.MetricKeyType.Histogram {
  ...
  [Equal.symbol](that: unknown): boolean {
    return (
      isHistogramKey(that) && Equal.equals(this.boundaries, that.boundaries)
    )
  }
  pipe() {
    return pipeArguments(this, arguments)
...
class SummaryKeyType implements MetricKeyType.MetricKeyType.Summary {
  readonly [MetricKeyTypeTypeId] = metricKeyTypeVariance
  readonly [SummaryKeyTypeTypeId]: MetricKeyType.SummaryKeyTypeTypeId =
...
export const frequency = (options?: {
  ...
  new FrequencyKeyType(options?.preregisteredWords ?? [])

/** @internal */
export const gauge: <A extends number | bigint>(options?: {
  readonly bigint: boolean
}) => GaugeKeyType<A> = (options) => new GaugeKeyType(options?.bigint ?? false)
...
export const summary = (options: {
  ...
  return new SummaryKeyType(
    Duration.decode(options.maxAge),
    options.maxSize,
    options.error,
    options.quantiles
  )
...
export const isMetricKeyType = (
  u: unknown
): u is MetricKeyType.MetricKeyType<unknown, unknown> =>
  hasProperty(u, MetricKeyTypeTypeId)

/** @internal */
export const isCounterKey = (
  u: unknown
): u is MetricKeyType.MetricKeyType.Counter<number | bigint> =>
  hasProperty(u, CounterKeyTypeTypeId)

/** @internal */
export const isFrequencyKey = (
  u: unknown
): u is MetricKeyType.MetricKeyType.Frequency =>
  hasProperty(u, FrequencyKeyTypeTypeId)

/** @internal */
export const isGaugeKey = (
  u: unknown
): u is MetricKeyType.MetricKeyType.Gauge<number | bigint> =>
  hasProperty(u, GaugeKeyTypeTypeId)

/** @internal */
export const isHistogramKey = (
  u: unknown
): u is MetricKeyType.MetricKeyType.Histogram =>
  hasProperty(u, HistogramKeyTypeTypeId)

/** @internal */
export const isSummaryKey = (
  u: unknown
): u is MetricKeyType.MetricKeyType.Summary =>
