...
/** @internal */
export const MergeStrategyTypeId: MergeStrategy.MergeStrategyTypeId =
...
export const isMergeStrategy = (u: unknown): u is MergeStrategy.MergeStrategy =>
  hasProperty(u, MergeStrategyTypeId)

/** @internal */
export const isBackPressure = (
  self: MergeStrategy.MergeStrategy
): self is MergeStrategy.BackPressure => self._tag === OpCodes.OP_BACK_PRESSURE

/** @internal */
export const isBufferSliding = (
  self: MergeStrategy.MergeStrategy
): self is MergeStrategy.BufferSliding =>
