...
/** @internal */
export const MergeDecisionTypeId: MergeDecision.MergeDecisionTypeId =
  Symbol.for(MergeDecisionSymbolKey) as MergeDecision.MergeDecisionTypeId
...
/** @internal */
export type Primitive = Done | Await

/** @internal */
export type Op<Tag extends string, Body = {}> = MergeDecision.MergeDecision<
  never,
  unknown,
  unknown,
  never,
...
/** @internal */
export interface Done extends Op<
  OpCodes.OP_DONE,
  {
...
/** @internal */
export interface Await extends Op<
  OpCodes.OP_AWAIT,
  {
...
export const isMergeDecision = (
  u: unknown
): u is MergeDecision.MergeDecision<
  unknown,
  unknown,
  unknown,
  unknown,
  unknown
> => hasProperty(u, MergeDecisionTypeId)
