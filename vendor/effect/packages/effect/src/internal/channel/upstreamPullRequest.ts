...
/** @internal */
export const UpstreamPullRequestTypeId: UpstreamPullRequest.UpstreamPullRequestTypeId =
  Symbol.for(
...
/** @internal */
export const Pulled = <A>(
  value: A
): UpstreamPullRequest.UpstreamPullRequest<A> => {
...
): UpstreamPullRequest.UpstreamPullRequest<never> => {
  const op = Object.create(proto)
...
export const isUpstreamPullRequest = (
  u: unknown
): u is UpstreamPullRequest.UpstreamPullRequest<unknown> =>
...
export const isNoUpstream = <A>(
  ...
  self._tag === OpCodes.OP_NO_UPSTREAM
