...
/** @internal */
export const randomTag: Context.Tag<Random.Random, Random.Random> =
  Context.GenericTag("effect/Random")
/** @internal */
...
export const make = <A>(seed: A): Random.Random =>
  new RandomImpl(Hash.hash(seed))
...
/** @internal */
export const fixed = <T extends Arr.NonEmptyArray<any>>(
  values: T
): Random.Random => new FixedRandomImpl(values)
