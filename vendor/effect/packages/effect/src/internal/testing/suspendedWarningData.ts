...
/** @internal */
export type OP_SUSPENDED_WARNING_DATA_START =
  typeof OP_SUSPENDED_WARNING_DATA_START

/** @internal */
export const OP_SUSPENDED_WARNING_DATA_PENDING = "Pending" as const

/** @internal */
export type OP_SUSPENDED_WARNING_DATA_PENDING =
  typeof OP_SUSPENDED_WARNING_DATA_PENDING

/** @internal */
export const OP_SUSPENDED_WARNING_DATA_DONE = "Done" as const

/** @internal */
export type OP_SUSPENDED_WARNING_DATA_DONE =
  typeof OP_SUSPENDED_WARNING_DATA_DONE
