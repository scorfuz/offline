...
/** @internal */
export const HashSetTypeId: HS.TypeId = Symbol.for(
  HashSetSymbolKey
) as HS.TypeId
...
>(2, <A>(self: HS.HashSet<A>, value: A) =>
  HM.has((self as HashSetImpl<A>)._keyMap, value)
)
...
export const every: {
  ...
  ): (self: HS.HashSet<A>) => self is HS.HashSet<B>
  <A>(predicate: Predicate<A>): (self: HS.HashSet<A>) => boolean
  <A, B extends A>(
    self: HS.HashSet<A>,
    refinement: Refinement<A, B>
  ): self is HS.HashSet<B>
  ...
  <A, B extends A>(
    self: HS.HashSet<A>,
    refinement: Refinement<A, B>
  ): self is HS.HashSet<B> => !some(self, (a) => !refinement(a))
)
...
/** @internal */
export const size = <A>(self: HS.HashSet<A>): number =>
  HM.size((self as HashSetImpl<A>)._keyMap)
...
export const mutate = dual<
  <A>(
    f: (set: HS.HashSet<A>) => void
  ) => (self: HS.HashSet<A>) => HS.HashSet<A>,
...
>(2, <A>(self: HS.HashSet<A>, value: A) =>
  ((self as HashSetImpl<A>)._keyMap as HM.HashMapImpl<A, unknown>)._editable
    ? (HM.set(value as A, true as unknown)((self as HashSetImpl<A>)._keyMap),
      self)
    : makeImpl(
        HM.set(value as A, true as unknown)((self as HashSetImpl<A>)._keyMap)
      )
...
export const toggle = dual<
  ...
  <A>(self: HS.HashSet<A>, value: A) => HS.HashSet<A>
>(2, (self, value) =>
  has(self, value) ? remove(self, value) : add(self, value)
)
...
>(2, <A>(self: HS.HashSet<A>, f: (value: A) => void) =>
  HM.forEach((self as HashSetImpl<A>)._keyMap, (_, k) => f(k))
)
...
>(3, <A, Z>(self: HS.HashSet<A>, zero: Z, f: (accumulator: Z, value: A) => Z) =>
  HM.reduce((self as HashSetImpl<A>)._keyMap, zero, (z, _, a) => f(z, a))
)
...
export const filter: {
  <A, B extends A>(
    refinement: Refinement<NoInfer<A>, B>
  ): (self: HS.HashSet<A>) => HS.HashSet<B>
...
export const partition: {
  ...
  <A>(
    ...
    self: HS.HashSet<A>
  ) => [excluded: HS.HashSet<A>, satisfying: HS.HashSet<A>]
  <A, B extends A>(
    self: HS.HashSet<A>,
    refinement: Refinement<A, B>
  ): [excluded: HS.HashSet<Exclude<A, B>>, satisfying: HS.HashSet<B>]
