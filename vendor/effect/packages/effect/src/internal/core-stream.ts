...
/** @internal */
type ErasedChannel = Channel.Channel<
  never,
  unknown,
  never,
  unknown,
...
/** @internal */
export type Op<Tag extends string, Body = {}> = ErasedChannel &
  Body & { readonly _tag: Tag }
...
/** @internal */
export interface BracketOut extends Op<
  OpCodes.OP_BRACKET_OUT,
  {
...
/** @internal */
export interface Bridge extends Op<
  OpCodes.OP_BRIDGE,
  {
    readonly input: SingleProducerAsyncInput.AsyncInputProducer<
      unknown,
      unknown,
      unknown
    >
...
/** @internal */
export interface ConcatAll extends Op<
  OpCodes.OP_CONCAT_ALL,
  {
...
/** @internal */
export interface Emit extends Op<
  OpCodes.OP_EMIT,
  {
...
/** @internal */
export interface Ensuring extends Op<
  OpCodes.OP_ENSURING,
  {
    readonly channel: ErasedChannel
    finalizer(
...
/** @internal */
export interface PipeTo extends Op<
  OpCodes.OP_PIPE_TO,
  {
    left(): ErasedChannel
    right(): ErasedChannel
...
/** @internal */
export interface Provide extends Op<
  OpCodes.OP_PROVIDE,
  {
...
/** @internal */
export interface Read extends Op<
  OpCodes.OP_READ,
  {
...
/** @internal */
export interface Succeed extends Op<
  OpCodes.OP_SUCCEED,
  {
    evaluate(): unknown
  }
...
/** @internal */
export interface SucceedNow extends Op<
  OpCodes.OP_SUCCEED_NOW,
  {
...
> => {
  return suspend(() => {
    ...
    return flatMap(pipeTo(self, collectElementsReader(builder)), (value) =>
      sync(() => [Chunk.fromIterable(builder), value])
    )
  })
}
...
export const concatAll = <OutElem, InElem, OutErr, InErr, InDone, Env>(
  ...
  concatAllWith(channels, constVoid, constVoid)
...
>(options: {
  ...
  ) => Channel.Channel<OutElem3, InElem, OutErr3, InErr, OutDone3, InDone, Env3>
}): Channel.Channel<
...
export const succeed = <A>(
  value: A
): Channel.Channel<never, unknown, never, unknown, A, unknown> =>
  sync(() => value)
