...
/** @internal */
export const sequential: ExecutionStrategy.ExecutionStrategy = {
  _tag: OP_SEQUENTIAL
}

/** @internal */
export const parallel: ExecutionStrategy.ExecutionStrategy = {
  _tag: OP_PARALLEL
}

/** @internal */
export const parallelN = (
  parallelism: number
...
/** @internal */
export const isSequential = (
  self: ExecutionStrategy.ExecutionStrategy
): self is ExecutionStrategy.Sequential => self._tag === OP_SEQUENTIAL

/** @internal */
export const isParallel = (
  self: ExecutionStrategy.ExecutionStrategy
): self is ExecutionStrategy.Parallel => self._tag === OP_PARALLEL

/** @internal */
export const isParallelN = (
  self: ExecutionStrategy.ExecutionStrategy
): self is ExecutionStrategy.ParallelN => self._tag === OP_PARALLEL_N
