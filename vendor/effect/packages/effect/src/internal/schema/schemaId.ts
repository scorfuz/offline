...
/** @internal */
export const GreaterThanOrEqualToSchemaId: Schema.GreaterThanOrEqualToSchemaId =
  Symbol.for(
...
/** @internal */
export const LessThanOrEqualToSchemaId: Schema.LessThanOrEqualToSchemaId =
  Symbol.for(
...
/** @internal */
export const GreaterThanBigintSchemaId: Schema.GreaterThanBigIntSchemaId =
  Symbol.for(
    "effect/SchemaId/GreaterThanBigint"
  ) as Schema.GreaterThanBigIntSchemaId

/** @internal */
export const GreaterThanOrEqualToBigIntSchemaId: Schema.GreaterThanOrEqualToBigIntSchemaId =
  Symbol.for(
...
/** @internal */
export const LessThanOrEqualToBigIntSchemaId: Schema.LessThanOrEqualToBigIntSchemaId =
  Symbol.for(
