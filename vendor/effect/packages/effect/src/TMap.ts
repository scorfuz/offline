...
export const find: {
  ...
  ): (self: TMap<K, V>) => STM.STM<Option.Option<A>>
  <K, V, A>(
    self: TMap<K, V>,
    pf: (key: K, value: V) => Option.Option<A>
...
export const forEach: {
  ...
  ): (self: TMap<K, V>) => STM.STM<void, E, R>
  <K, V, X, E, R>(
    self: TMap<K, V>,
    f: (key: K, value: V) => STM.STM<X, E, R>
  ): STM.STM<void, E, R>
 ...
 * @category getters
 */
export const isEmpty: <K, V>(self: TMap<K, V>) => STM.STM<boolean> =
  internal.isEmpty
...
) => STM.STM<TMap<K, V>> = internal.make
...
export const takeSome: {
  <K, V, A>(
    pf: (key: K, value: V) => Option.Option<A>
  ): (self: TMap<K, V>) => STM.STM<[A, ...Array<A>]>
  <K, V, A>(
    self: TMap<K, V>,
    pf: (key: K, value: V) => Option.Option<A>
  ): STM.STM<[A, ...Array<A>]>
 ...
 */
export const toChunk: <K, V>(self: TMap<K, V>) => STM.STM<Chunk.Chunk<[K, V]>> =
  internal.toChunk
...
export const toHashMap: <K, V>(
  self: TMap<K, V>
) => STM.STM<HashMap.HashMap<K, V>> = internal.toHashMap
 ...
 * @category destructors
 */
export const toArray: <K, V>(self: TMap<K, V>) => STM.STM<Array<[K, V]>> =
  internal.toArray
...
export const transformValuesSTM: {
  ...
  ): <K>(self: TMap<K, V>) => STM.STM<void, E, R>
  <K, V, R, E>(
    self: TMap<K, V>,
    f: (value: V) => STM.STM<V, E, R>
  ): STM.STM<void, E, R>
 ...
 * @category elements
 */
export const values: <K, V>(self: TMap<K, V>) => STM.STM<Array<V>> =
  internal.values
