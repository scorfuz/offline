 ...
 * @internal
 */
export const unsafeMakeNormalized = (
  value: bigint,
  scale: number
): BigDecimal => {
 ...
 * @since 2.0.0
 */
export const Equivalence: equivalence.Equivalence<BigDecimal> =
...
export const unsafeFromString = (s: string): BigDecimal =>
  Option.getOrThrowWith(
    fromString(s),
    () => new Error("Invalid numerical string")
  )
