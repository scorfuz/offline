 ...
 * @since 3.8.0
 */
export interface FiberRefUnify<
...
) => FiberRef<HashSet.HashSet<A>> = core.fiberRefUnsafeMakeHashSet
...
export const unsafeMakeContext: <A>(
  initial: Context.Context<A>
) => FiberRef<Context.Context<A>> = core.fiberRefUnsafeMakeContext

/**
 * @since 2.0.0
 * @category constructors
 */
export const unsafeMakeSupervisor: (
  initial: Supervisor.Supervisor<any>
) => FiberRef<Supervisor.Supervisor<any>> =
...
export const getWith: {
  ...
  ): (self: FiberRef<A>) => Effect.Effect<B, E, R>
  <A, B, E, R>(
    self: FiberRef<A>,
    f: (a: A) => Effect.Effect<B, E, R>
  ): Effect.Effect<B, E, R>
...
const _delete: <A>(self: FiberRef<A>) => Effect.Effect<void> =
  core.fiberRefDelete
 ...
 * @category utils
 */
export const reset: <A>(self: FiberRef<A>) => Effect.Effect<void> =
  core.fiberRefReset
...
export const updateSome: {
  ...
  ): (self: FiberRef<A>) => Effect.Effect<void>
 ...
 * @category fiberRefs
 */
export const currentConcurrency: FiberRef<number | "unbounded"> =
 ...
 * @category fiberRefs
 */
export const currentRequestBatchingEnabled: FiberRef<boolean> =
 ...
 * @category fiberRefs
 */
export const currentRequestCache: FiberRef<Request.Cache> =
  query.currentCache as any

/**
 * @since 2.0.0
 * @category fiberRefs
 */
export const currentRequestCacheEnabled: FiberRef<boolean> =
 ...
 * @category fiberRefs
 */
export const currentContext: FiberRef<Context.Context<never>> =
  core.currentContext
 ...
 * @category fiberRefs
 */
export const currentSchedulingPriority: FiberRef<number> =
  core.currentSchedulingPriority

/**
 * @since 2.0.0
 * @category fiberRefs
 */
export const currentMaxOpsBeforeYield: FiberRef<number> =
  core.currentMaxOpsBeforeYield

/**
 * @since 2.0.0
 * @category fiberRefs
 */
export const unhandledErrorLogLevel: FiberRef<
 ...
 * @category fiberRefs
 */
export const versionMismatchErrorLogLevel: FiberRef<
  Option.Option<LogLevel.LogLevel>
 ...
 * @category fiberRefs
 */
export const currentLogAnnotations: FiberRef<HashMap.HashMap<string, unknown>> =
...
export const currentLoggers: FiberRef<
  HashSet.HashSet<Logger.Logger<unknown, any>>
 ...
 * @category fiberRefs
 */
export const currentMinimumLogLevel: FiberRef<LogLevel.LogLevel> =
 ...
 * @category fiberRefs
 */
export const currentLogSpan: FiberRef<List.List<LogSpan.LogSpan>> =
  core.currentLogSpan
 ...
 * @category fiberRefs
 */
export const currentRuntimeFlags: FiberRef<RuntimeFlags.RuntimeFlags> =
  fiberRuntime.currentRuntimeFlags

/**
 * @since 2.0.0
 * @category fiberRefs
 */
export const currentScheduler: FiberRef<Scheduler.Scheduler> =
 ...
 * @category fiberRefs
 */
export const currentSupervisor: FiberRef<Supervisor.Supervisor<any>> =
 ...
 * @category fiberRefs
 */
export const currentMetricLabels: FiberRef<
 ...
 * @category fiberRefs
 */
export const currentTracerTimingEnabled: FiberRef<boolean> =
 ...
 * @category fiberRefs
 */
export const currentTracerSpanLinks: FiberRef<Chunk.Chunk<Tracer.SpanLink>> =
 ...
 * @category fiberRefs
 */
export const interruptedCause: FiberRef<Cause.Cause<never>> =
