 ...
 * @category symbols
 */
export const FrequencyKeyTypeTypeId: unique symbol =
  internal.FrequencyKeyTypeTypeId
 ...
 * @category symbols
 */
export const HistogramKeyTypeTypeId: unique symbol =
  internal.HistogramKeyTypeTypeId
 ...
 * @category modelz
 */
export interface MetricKeyType<in In, out Out>
...
export declare namespace MetricKeyType {
   ...
   * @category models
   */
  export type Counter<A extends number | bigint> = MetricKeyType<
    A,
    MetricState.MetricState.Counter<A>
  > & {
   ...
   * @category models
   */
  export type Frequency = MetricKeyType<
    string,
   ...
   * @category models
   */
  export type Gauge<A extends number | bigint> = MetricKeyType<
    A,
    MetricState.MetricState.Gauge<A>
  > & {
   ...
   * @category models
   */
  export type Histogram = MetricKeyType<
    number,
   ...
   * @category models
   */
  export type Summary = MetricKeyType<
...
>() => MetricKeyType.Counter<A> = internal.counter
 ...
 * @category constructors
 */
export const gauge: <A extends number | bigint>() => MetricKeyType.Gauge<A> =
  internal.gauge
...
) => MetricKeyType.Histogram = internal.histogram
...
export const isMetricKeyType: (
  u: unknown
) => u is MetricKeyType<unknown, unknown> = internal.isMetricKeyType
...
export const isCounterKey: (
  u: unknown
) => u is MetricKeyType.Counter<number | bigint> = internal.isCounterKey
...
export const isGaugeKey: (
  u: unknown
) => u is MetricKeyType.Gauge<number | bigint> = internal.isGaugeKey
