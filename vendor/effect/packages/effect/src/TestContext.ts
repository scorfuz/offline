 ...
 * @since 2.0.0
 */
export const LiveContext: Layer.Layer<DefaultServices.DefaultServices> =
  layer.syncContext(() => defaultServices.liveServices)

/**
 * @since 2.0.0
 */
export const TestContext: Layer.Layer<TestServices.TestServices> =
  layer.provideMerge(live, LiveContext)
