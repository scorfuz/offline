 ...
 * @since 2.0.0
 */
export const TestAnnotationMapTypeId: unique symbol = Symbol.for(
...
export const isTestAnnotationMap = (u: unknown): u is TestAnnotationMap =>
  hasProperty(u, TestAnnotationMapTypeId)

/**
 * @since 2.0.0
 */
export const empty: (_: void) => TestAnnotationMap = () =>
  new TestAnnotationMapImpl(HashMap.empty())
