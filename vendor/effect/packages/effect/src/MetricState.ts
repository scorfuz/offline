 ...
 * @category models
 */
export interface MetricState<in A>
  extends MetricState.Variance<A>, Equal.Equal, Pipeable {}
...
export declare namespace MetricState {
  ...
  export interface Counter<
    in out A extends number | bigint
   ...
   * @category models
   */
  export interface Gauge<in out A extends number | bigint> extends MetricState<
...
) => MetricState.Frequency = internal.frequency
...
export const isMetricState: (
  u: unknown
) => u is MetricState.Counter<number | bigint> = internal.isMetricState
...
export const isCounterState: (
  u: unknown
) => u is MetricState.Counter<number | bigint> = internal.isCounterState
...
export const isGaugeState: (
  u: unknown
) => u is MetricState.Gauge<number | bigint> = internal.isGaugeState
...
export const isHistogramState: (u: unknown) => u is MetricState.Histogram =
  internal.isHistogramState

/**
 * @since 2.0.0
 * @category refinements
 */
export const isSummaryState: (u: unknown) => u is MetricState.Summary =
  internal.isSummaryState
