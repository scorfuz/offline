 ...
 * @category models
 */
export interface Pool<in out A, out E = never>
  extends Pool.Variance<A, E>, Effect.Effect<A, E, Scope.Scope>, Pipeable {
  /**
 ...
 * @since 3.9.0
 */
export interface PoolUnify<
  A extends { [Unify.typeSymbol]?: any }
> extends Effect.EffectUnify<A> {
  Pool?: () => Extract<A[Unify.typeSymbol], Pool<any, any>> extends
    | Pool<infer A0, infer _E0>
    | infer _
    ? A0 extends any
