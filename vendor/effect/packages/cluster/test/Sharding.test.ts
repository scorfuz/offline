...
describe.concurrent("Sharding", () => {
  ...
  it.scoped("MailboxFull for volatile messages", () =>
    Effect.gen(function* () {
      ...
      yield* client
        .NeverVolatile()
        .pipe(Effect.fork, Effect.replicateEffect(10))
      yield* TestClock.adjust(1)
    ...
    Effect.gen(function* () {
      ...
      yield* Effect.gen(function* () {
        ...
        const fibers = yield* client
          .NeverFork()
          .pipe(Effect.fork, Effect.replicateEffect(11))
        yield* TestClock.adjust(1)
  ...
  it.scoped("interrupt for future request works while mailbox is full", () =>
    Effect.gen(function* () {
      ...
      const fibers = yield* client
        .NeverFork()
        .pipe(Effect.fork, Effect.replicateEffect(12))
      yield* TestClock.adjust(1)
