      ...
      Effect.gen(function* () {
        const encoded = {
          ...
          repliesForUnfiltered: () =>
            Effect.die("unexpected repliesForUnfiltered call"),
...
export class PrimaryKeyTest extends Schema.TaggedRequest<PrimaryKeyTest>()(
  "PrimaryKeyTest",
  {
    success: Schema.Void,
...
export class StreamTest extends Schema.TaggedRequest<StreamTest>()(
  "StreamTest",
  {
