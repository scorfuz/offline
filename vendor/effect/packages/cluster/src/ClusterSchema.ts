 ...
 * @category Annotations
 */
export class Uninterruptible extends Context.Reference<Uninterruptible>()(
 ...
 * @category Annotations
 */
export class ShardGroup extends Context.Reference<ShardGroup>()(
 ...
 * @category Annotations
 */
export class ClientTracingEnabled extends Context.Reference<ClientTracingEnabled>()(
