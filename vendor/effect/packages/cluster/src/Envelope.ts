...
export declare namespace Envelope {
  ...
  export type Encoded =
    | Request.Encoded
    | typeof AckChunk.Encoded
    | typeof Interrupt.Encoded
 ...
 * @category models
 */
export class Interrupt extends Schema.TaggedClass<Interrupt>(
 ...
 */
export const EnvelopeFromSelf: Schema.Schema<Envelope.Any, Envelope.Any> =
 ...
 * @category serialization / deserialization
 */
export const RequestFromSelf: Schema.Schema<Request.Any, Request.Any> =
  Schema.declare(
...
> = Schema.Union(
  ...
  AckChunk,
  Interrupt
) satisfies Schema.Schema<Envelope.PartialEncoded, Envelope.Encoded>
...
export const primaryKey = <R extends Rpc.Any>(
  ...
  if (
    ...
    !Predicate.hasProperty(envelope.payload, PrimaryKey.symbol)
  ) {
    return null
  }
